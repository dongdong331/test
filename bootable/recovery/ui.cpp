...
static constexpr const char* BRIGHTNESS_FILE = "/sys/class/backlight/sprd_backlight/brightness";
static constexpr const char* MAX_BRIGHTNESS_FILE = "/sys/class/backlight/sprd_backlight/max_brightness";
