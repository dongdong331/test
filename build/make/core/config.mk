...
ifdef PRODUCT_DEFAULT_DEV_CERTIFICATE
  ...
  # set PRODUCT_DEFAULT_DEV_CERTIFICATE  for android_app module certidicate (framework-res.apk android.bp)
  ifeq ($(strip $(TARGET_BUILD_VARIANT)),user)
        PRODUCT_DEFAULT_DEV_CERTIFICATE := build/target/product/security/release/releasekey
  else
