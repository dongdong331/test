...
STATIC_WARNING_MSG = ('\033[1m%(makefile)s: \033[35mwarning:\033[0m\033[1m '
    '%(module)s (%(type)s)should not static_link to %(dep_name)s (%(dep_type)s)'
    '\033[0m')
    ...
    for dep in args.deps:
        ...
        for dep_type in dep_types:
            ...
            if dep_type in args.warn:
                ...
                # sprd workaround, static link allowed for vendor to platform
                if "STATIC_LIBRARIES" in dep:
                    msg = STATIC_WARNING_MSG
                else:
                    msg = ERROR_MSG
                    failed = True
                print_msg(msg, args, dep_name, dep_type)
