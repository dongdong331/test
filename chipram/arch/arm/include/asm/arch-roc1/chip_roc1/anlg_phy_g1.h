...
#define BIT_ANLG_PHY_G1_DBG_SEL_ANALOG_MIPI_MPHY_1T1R_MPHY_CB_CFGCLK_FREQ    BIT(16)
#define BIT_ANLG_PHY_G1_DBG_SEL_ANALOG_MIPI_MPHY_1T1R_MPHY_REFCLKON          BIT(15)
#define BIT_ANLG_PHY_G1_DBG_SEL_ANALOG_MIPI_MPHY_1T1R_MPHY_TX_MAIN_RESET_0   BIT(14)
#define BIT_ANLG_PHY_G1_DBG_SEL_ANALOG_MIPI_MPHY_1T1R_MPHY_TX_RESET_0        BIT(13)
#define BIT_ANLG_PHY_G1_DBG_SEL_ANALOG_MIPI_MPHY_1T1R_MPHY_TX_LINERESET_0    BIT(12)
#define BIT_ANLG_PHY_G1_DBG_SEL_ANALOG_MIPI_MPHY_1T1R_MPHY_RX_MAIN_RESET_0   BIT(11)
#define BIT_ANLG_PHY_G1_DBG_SEL_ANALOG_MIPI_MPHY_1T1R_MPHY_RX_RESET_0        BIT(10)
#define BIT_ANLG_PHY_G1_DBG_SEL_ANALOG_MIPI_MPHY_1T1R_MPHY_CB_RESET          BIT(9)
#define BIT_ANLG_PHY_G1_DBG_SEL_ANALOG_MIPI_MPHY_1T1R_MPHY_CB_ATTRRESET      BIT(8)
#define BIT_ANLG_PHY_G1_DBG_SEL_ANALOG_MIPI_MPHY_1T1R_MPHY_CB_TRIMBG         BIT(7)
#define BIT_ANLG_PHY_G1_DBG_SEL_ANALOG_MIPI_MPHY_1T1R_MPHY_CB_TRIMTXTERM     BIT(6)
#define BIT_ANLG_PHY_G1_DBG_SEL_ANALOG_MIPI_MPHY_1T1R_MPHY_CB_TRIMRXTERM     BIT(5)
#define BIT_ANLG_PHY_G1_DBG_SEL_ANALOG_MIPI_MPHY_1T1R_MPHY_PS_PD_L           BIT(4)
#define BIT_ANLG_PHY_G1_DBG_SEL_ANALOG_MIPI_MPHY_1T1R_MPHY_PS_PD_S           BIT(3)
#define BIT_ANLG_PHY_G1_DBG_SEL_ANALOG_MIPI_MPHY_1T1R_MPHY_ISO_SW_EN         BIT(2)
#define BIT_ANLG_PHY_G1_DBG_SEL_ANALOG_MIPI_MPHY_1T1R_MPHY_ANA_POWERDOWN     BIT(1)
#define BIT_ANLG_PHY_G1_DBG_SEL_ANALOG_MIPI_MPHY_1T1R_MPHY_RESERVEDI         BIT(0)
