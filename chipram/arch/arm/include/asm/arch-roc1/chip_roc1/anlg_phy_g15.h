...
#define REG_ANLG_PHY_G15_ANALOG_THM1_0_THM1_CTL           ( CTL_BASE_ANLG_PHY_G15 + 0x0000 )
#define REG_ANLG_PHY_G15_ANALOG_THM1_0_THM1_RESERVED_CTL  ( CTL_BASE_ANLG_PHY_G15 + 0x0004 )
#define REG_ANLG_PHY_G15_ANALOG_THM1_0_WRAP_GLUE_CTRL     ( CTL_BASE_ANLG_PHY_G15 + 0x0008 )
