...
#define BIT_ANLG_PHY_G4_ANALOG_MPLL1_DBG_SEL_ANALOG_MPLL1_MPLL1_ICP            BIT(2)
#define BIT_ANLG_PHY_G4_ANALOG_MPLL1_DBG_SEL_ANALOG_MPLL1_MPLL1_N              BIT(1)
#define BIT_ANLG_PHY_G4_ANALOG_MPLL1_DBG_SEL_ANALOG_MPLL1_MPLL1_POSTDIV        BIT(0)
