...
extern void JumpToTarget(unsigned long addr);
			...
			|| defined (CONFIG_SOC_SHARKLJ1) || defined (CONFIG_SOC_SHARKLE) || defined (CONFIG_SOC_SHARKL3) || defined(CONFIG_SOC_ROC1) || defined(CONFIG_SOC_SHARKL5) || defined(CONFIG_SOC_SHARKL5PRO) || defined (CONFIG_SOC_ORCA)
...
#if defined (CONFIG_WHALE) ||defined (CONFIG_WHALE2) || defined (CONFIG_X86)|| defined (CONFIG_SOC_SHARKLJ1) || defined (CONFIG_SOC_SHARKLE) || defined (CONFIG_SOC_SHARKL3) || defined(CONFIG_SOC_ROC1) || defined (CONFIG_SOC_SHARKL5) || defined(CONFIG_SOC_SHARKL5PRO) || defined (CONFIG_SOC_ORCA)
...
#if defined (CONFIG_WHALE) ||defined (CONFIG_WHALE2)|| defined (CONFIG_SOC_SHARKLJ1)|| defined (CONFIG_ARCH_SCX35L2) || defined (CONFIG_SOC_PIKE2) || defined (CONFIG_SOC_SHARKLE) || defined (CONFIG_SOC_IWHALE2) || defined (CONFIG_SOC_SHARKL3) || defined(CONFIG_SOC_ROC1)|| defined(CONFIG_SOC_ISHARKL2) || defined (CONFIG_SOC_SHARKL5) || defined(CONFIG_SOC_SHARKL5PRO) || defined (CONFIG_SOC_ORCA)
