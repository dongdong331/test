...
# after setting these options, include this file as include "device/sprd/sharkl5/common/security_feature.mk"
#
...
TARGET_SML_CONFIG := sharkl5@sharkl5
...
ifneq ($(BOARD_FEATUREPHONE_CONFIG),)
CFG_TRUSTY_DEFAULT_PROJECT := sharkl5-feature
else
CFG_TRUSTY_DEFAULT_PROJECT ?= sharkl5
endif
