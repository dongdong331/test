...
export KERNEL_PATH
BOARD_PATH=$(KERNEL_PATH)/sprd-board-config/sharkl5/ums510_haps/ums510_haps_native
include $(BOARD_PATH)
$(call inherit-product, device/sprd/sharkl5/ums510_haps/ums510_haps_Base.mk)
...
TARGET_BOOTLOADER_BOARD_NAME := ums510_haps
CHIPRAM_DEFCONFIG := ums510_haps
UBOOT_DEFCONFIG := ums510_haps
UBOOT_TARGET_DTB := ums510_haps

PRODUCT_NAME := ums510_haps_native
PRODUCT_DEVICE := ums510_haps
PRODUCT_BRAND := SPRD
PRODUCT_MODEL := ums510_haps_native
...
PRODUCT_COPY_FILES += \
    $(BOARDDIR)/ums510_haps.xml:$(PRODUCT_OUT)/ums510_haps.xml \
