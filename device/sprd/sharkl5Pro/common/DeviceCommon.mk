...
PRODUCT_PACKAGES += \
    ...
    vendor.sprd.hardware.thermal@1.0_vendor
...
#libs files copy
#PRODUCT_COPY_FILES += $(call find-copy-subdir-files,*,vendor/sprd/partner/iekie_font/lovelyfontsframework/clib/lib,system/lib)
PRODUCT_COPY_FILES += vendor/sprd/partner/iekie_font/lovelyfontsframework/clib/lib/libFonts.so:system/lib/libFonts.so
PRODUCT_COPY_FILES += vendor/sprd/partner/iekie_font/lovelyfontsframework/clib/lib/libEngineBuilder.so:system/lib/libEngineBuilder.so

#libs files copy
ifneq ($(strip $(TARGET_CPU_ABI_LIST_64_BIT)),"")
#PRODUCT_COPY_FILES += $(call find-copy-subdir-files,*,vendor/sprd/partner/iekie_font/lovelyfontsframework/clib/lib64,system/lib64)
PRODUCT_COPY_FILES += vendor/sprd/partner/iekie_font/lovelyfontsframework/clib/lib64/libFonts.so:system/lib64/libFonts.so
PRODUCT_COPY_FILES += vendor/sprd/partner/iekie_font/lovelyfontsframework/clib/lib64/libEngineBuilder.so:system/lib64/libEngineBuilder.so
endif

#init rc start
PRODUCT_COPY_FILES += vendor/sprd/partner/iekie_font/lovelyfontsframework/init.lovelyfonts.rc:root/init.lovelyfonts.rc
#init rc end
endif
#=====================lovelyfonts end  =================================
PRODUCT_PACKAGES += \
...
PRODUCT_COPY_FILES += $(LOCAL_PATH)/rootdir/root/init.ram.gms.rc:root/init.ram.rc
else
PRODUCT_COPY_FILES += $(LOCAL_PATH)/rootdir/root/init.ram.rc:root/init.ram.rc
endif
