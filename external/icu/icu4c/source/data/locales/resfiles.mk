...
GENRB_SOURCE = af.txt af_NA.txt af_ZA.txt agq.txt\
 ...
 de_LU.txt dje.txt dje_NE.txt doi.txt doi_IN.txt dsb.txt dsb_DE.txt\
 ...
 lv.txt lv_LV.txt mai.txt mai_IN.txt mas.txt mas_KE.txt mas_TZ.txt\
 mer.txt mer_KE.txt mfe.txt mfe_MU.txt mg.txt\
 mg_MG.txt mgh.txt mgh_MZ.txt mgo.txt mgo_CM.txt\
 mk.txt mk_MK.txt ml.txt ml_IN.txt mn.txt mni.txt mni_IN.txt\
 ...
 sa.txt sa_IN.txt sah.txt sah_RU.txt saq.txt saq_KE.txt sat.txt sat_IN.txt sbp.txt\
 sbp_TZ.txt sd.txt sd_IN.txt se.txt se_FI.txt se_NO.txt se_SE.txt\
