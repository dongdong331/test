...
REGION_SOURCE = af.txt agq.txt ak.txt am.txt\
 ...
 de.txt de_AT.txt de_CH.txt dje.txt doi.txt dsb.txt\
 ...
 ru_UA.txt rw.txt rwk.txt sa.txt sah.txt saq.txt sat.txt\
 sbp.txt sd.txt se.txt se_FI.txt seh.txt ses.txt\
