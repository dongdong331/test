...
# softap for 5G need to support ACS function
ifeq ($(SOFTAP_SUPPORT_ACS), YES)
CONFIG_ACS=y
endif
...
LOCAL_SHARED_LIBRARIES += vendor.sprd.hardware.wifi.hostapd@1.0
