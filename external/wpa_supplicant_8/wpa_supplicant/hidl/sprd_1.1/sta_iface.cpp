...
namespace {
using vendor::sprd::hardware::wifi::supplicant::V1_1::ISupplicantStaIface;
using android::hardware::wifi::supplicant::V1_0::SupplicantStatus;
using android::hardware::wifi::supplicant::V1_0::SupplicantStatusCode;
using vendor::sprd::hardware::wifi::supplicant::V1_1::implementation::HidlManager;
    ...
    struct wpa_supplicant *wpa_s, const char *cmd)
{
	...
	if (wpa_drv_driver_cmd(
		wpa_s, (u8 *)cmd_vec.data(), driver_cmd_reply_buf,
...
Return<void> StaIface::registerCallback_sprd_1_1(
    const sp<ISupplicantStaIfaceCallbackEx>
    & callback, registerCallback_sprd_1_1_cb _hidl_cb) {
	return validateAndCall(
	    this, SupplicantStatusCode::FAILURE_IFACE_INVALID,
	    &StaIface::registerCallbackInternal_sprd_1_1, _hidl_cb, callback);
}

SupplicantStatus StaIface::registerCallbackInternal_sprd_1_1(
...
StaIface::getMacAddressInternal()
{
	...
	int ret = wpa_drv_driver_cmd(
	    wpa_s, (u8 *)cmd.data(), driver_cmd_reply_buf,
	    sizeof(driver_cmd_reply_buf));
...
Return<void> StaIface::setParamToSupplicant(const hidl_string& key,
    const hidl_string& value, setParamToSupplicant_cb _hidl_cb) {
    return validateAndCall(
