...
#include <vendor/sprd/hardware/wifi/supplicant/1.1/ISupplicantStaIface.h>
...
public:
	...
	Return<void> registerCallback_1_1(
	    const sp<android::hardware::wifi::supplicant::V1_1::ISupplicantStaIfaceCallback>
	    & callback, registerCallback_cb _hidl_cb) override;
	...
	Return<void> setParamToSupplicant(
	    const hidl_string& key, const hidl_string& value, setParamToSupplicant_cb _hidl_cb) override;
	Return<void> registerCallback_sprd_1_1(
	    const sp<ISupplicantStaIfaceCallbackEx>
	    & callback, registerCallback_sprd_1_1_cb _hidl_cb) override;
...
private:
	...
	SupplicantStatus registerCallbackInternal_sprd_1_1(
