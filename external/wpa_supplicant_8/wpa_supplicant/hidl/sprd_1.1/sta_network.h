...
#include <vendor/sprd/hardware/wifi/supplicant/1.1/ISupplicantStaNetwork.h>
...
public:
	...
	Return<void> registerCallback_sprd_1_1(
	    const sp<ISupplicantStaNetworkCallbackEx>
...
private:
	...
	std::pair<SupplicantStatus, std::string>
	getNetworkParamInternal(const std::string& key);
