...
const char *CameraParameters2::getSprd3DNR() const
{
     return get(CameraParameters::KEY_3DNR);
}
#endif

int CameraParameters2::getSprdAppMode() const
{
    return getInt(CameraParameters::KEY_APP_MODE);
}
