...
const char CameraParameters::KEY_3DNR[] = "sprd-3dnr-enabled";
#endif

const char CameraParameters::KEY_IS_TAKEPICTURE_WITH_FLASH[] = "is-takepicture-with-flash";

const char CameraParameters::KEY_APP_MODE[] = "sprd-appmode-id";
