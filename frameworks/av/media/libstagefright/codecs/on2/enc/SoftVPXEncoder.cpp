...
static int GetCPUCoreCount() {
    ...
    if ((property_get("ro.media.cpuvp8enc.limit", value, "false") != 0) && !strcmp(value, "true")) {
       cpuCoreCount = sysconf(_SC_NPROCESSORS_ONLN)/2;
    } else {
    ...
    ALOGI("The number of cpuCoreCount is %d",cpuCoreCount);
    return cpuCoreCount;
}
