...
protected:
        ...
        void checkOutputForStrategy(routing_strategy strategy, bool doNotMute = false);

        // Same as checkOutputForStrategy() but for a all strategies in order of priority
        void checkOutputForAllStrategies(bool doNotMute = false);

        // manages A2DP output suspend/restore according to phone state and BT SCO usage
        void checkA2dpSuspend(bool doDelay = false);
