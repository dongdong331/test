        ...
        mLastTemplateId(-1)
{
    ...
    property_get("persist.sys.abc.slp", value, "-1");
    ALOGV("%s:persist.sys.abc.slp value %s ",__FUNCTION__, value);
    if (strcmp(value, "0") != 0) {
       property_set("persist.sys.abc.slp", "0");
       ALOGV("%s: set persist.sys.abc.slp 0 ",__FUNCTION__);
       property_get("persist.sys.abc.slp", value, "-1");
       if (strcmp(value, "0") == 0) {
...
Camera3Device::~Camera3Device()
{
    ...
    ALOGV("%s:persist.sys.abc.slp value %s ",__FUNCTION__,value);
    if (strcmp(value, "1") != 0) {
        property_set("persist.sys.abc.slp", "1");
        ALOGV("%s: set persist.sys.abc.slp 1 ",__FUNCTION__);
        property_get("persist.sys.abc.slp", value, "-1");
        if (strcmp(value, "1") == 0) {
            sp<IServiceManager> sm = defaultServiceManager();
            sp<IBinder> binder = sm->checkService(String16("power"));
