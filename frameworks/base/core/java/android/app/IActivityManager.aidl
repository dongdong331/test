...
interface IActivityManager {
   ...
   // Add for ProtectArea feature
    void setProcessProtectArea(String appName, int minAdj, int maxAdj, int protectLevel);
    void setProcessProtectStatusByPid(int pid, int status);
    void setProcessProtectStatusByProcName(String appName, int status);

    // SPRD: Add for kill stop front app feature
    void startHomePre();
    void killStopFrontApp(int func);
}
