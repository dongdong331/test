...
public class Instrumentation {
    ...
    public void callActivityOnCreate(Activity activity, Bundle icicle) {
        ...
        Trace.traceBegin(Trace.TRACE_TAG_ACTIVITY_MANAGER, "performCreate with 2 args");
    ...
    public void callActivityOnCreate(Activity activity, Bundle icicle,
        ...
        prePerformCreate(activity);
        // add systrace tag for bug 661753
        Trace.traceBegin(Trace.TRACE_TAG_ACTIVITY_MANAGER, "performCreate with 3 args");
...
//      }
        // add systrace tag for bug 661753
        Trace.traceBegin(Trace.TRACE_TAG_ACTIVITY_MANAGER, "performDestroy");
    ...
    public void callActivityOnStart(Activity activity) {
        // add systrace tag for bug 661753
        Trace.traceBegin(Trace.TRACE_TAG_ACTIVITY_MANAGER, "activity.onStart");
        activity.onStart();
        // add systrace tag for bug 661753
        Trace.traceEnd(Trace.TRACE_TAG_ACTIVITY_MANAGER);
    }
    ...
    public void callActivityOnRestart(Activity activity) {
        // add systrace tag for bug 661753
        Trace.traceBegin(Trace.TRACE_TAG_ACTIVITY_MANAGER, "activity.onRestart");
        activity.onRestart();
        // add systrace tag for bug 661753
        Trace.traceEnd(Trace.TRACE_TAG_ACTIVITY_MANAGER);
    }
    ...
    public void callActivityOnStop(Activity activity) {
        // add systrace tag for bug 661753
        Trace.traceBegin(Trace.TRACE_TAG_ACTIVITY_MANAGER, "activity.onStop");
        activity.onStop();
        // add systrace tag for bug 661753
        Trace.traceEnd(Trace.TRACE_TAG_ACTIVITY_MANAGER);
    }
    ...
    public void callActivityOnPause(Activity activity) {
        // add systrace tag for bug 661753
        Trace.traceBegin(Trace.TRACE_TAG_ACTIVITY_MANAGER, "activity.performPause");
