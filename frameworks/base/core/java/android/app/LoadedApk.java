...
public final class LoadedApk {
    ...
    private void createOrUpdateClassLoaderLocked(List<String> addedPaths) {
        ...
        if (!mIncludeCode) {
            if (mClassLoader == null) {
                ...
                CheckTime.checkTime(startTime, "exclude code application classloader create");
        ...
        if (mClassLoader == null) {
            ...
            CheckTime.checkTime(startTime, "application classloader create", 500);
            mAppComponentFactory = createAppFactory(mApplicationInfo, mClassLoader);
    ...
    static final class ReceiverDispatcher {
        ...
        static final class InnerReceiver extends IIntentReceiver.Stub
                implements BroadcastTimeoutListener {
            ...
            public void performReceive(Intent intent, int resultCode, String data,
                ...
                if (CheckTime.checkTime(startTime, "performReceive intent = " + intent)) {
                    LoadedApk.ReceiverDispatcher dispatcher = mDispatcher.get();
                    if (dispatcher != null && dispatcher.mLocation != null) {
                        Slog.i("CheckTime", "Receiver " + this + " registered at",
                                dispatcher.mLocation);
                    }
                }
            }
            ...
            public void onBroadcastTimeout(Intent intent) {
                LoadedApk.ReceiverDispatcher dispatcher = mDispatcher.get();
                if (dispatcher != null && dispatcher.mLocation != null) {
                    Slog.w(ActivityThread.TAG, "Receiver dispatching timeout " + this
                                    + "for intent " + intent + ", registered at",
                            dispatcher.mLocation);
                } else {
                    Slog.v(ActivityThread.TAG, "Receiver dispathing timeout for intent "
                            + intent);
                }
            }
        }
