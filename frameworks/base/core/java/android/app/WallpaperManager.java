...
public class WallpaperManager {
    ...
    private static boolean DEBUG = SystemProperties.getBoolean("persist.sys.wallpaper.debug", false);
    ...
    public int setStream(InputStream bitmapData, Rect visibleCropHint, boolean allowBackup)
            throws IOException {
        /**SPRD: Bug899692 set default wallpaper as home screen, lock wallpaper change
         * @{
         */
