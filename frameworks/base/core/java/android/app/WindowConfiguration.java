...
public class WindowConfiguration implements Parcelable, Comparable<WindowConfiguration> {
    ...
    private boolean mTrackActivityTypeChange;
    ...
    public void setActivityType(@ActivityType int activityType) {
        ...
        if (mTrackActivityTypeChange) {
            android.util.Slog.d("WindowConfiguration", "setActivityType: " + this
                    + " activityType=" + activityTypeToString(activityType), new Throwable());
        }
    ...
    /** @hide */
    public void setTrackActivityTypeChange(boolean tracking) {
        mTrackActivityTypeChange = tracking;
    }
