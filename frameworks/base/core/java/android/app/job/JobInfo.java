...
public class JobInfo implements Parcelable {
    ...
    private final boolean isRescheduleEnable;
    ...
    /**
     * return whether or not the job can be rescheduled.
     * @hide
     */
    public boolean isRescheduleEnable() {
        return isRescheduleEnable;
    }

    private static boolean kindofEqualsBundle(BaseBundle a, BaseBundle b) {
        return (a == b) || (a != null && a.kindofEquals(b))
                || (a != null && b != null && a.maybeIsEmpty() && b.maybeIsEmpty());
    }
    ...
    private JobInfo(Parcel in) {
        ...
        priority = in.readInt();
        flags = in.readInt();
        isRescheduleEnable = in.readInt() == 1;
    }
    ...
    private JobInfo(JobInfo.Builder b) {
        ...
        flags = b.mFlags;
        isRescheduleEnable = b.mRescheduleEnable;
    }
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        out.writeInt(isRescheduleEnable ? 1 : 0);
    }
    ...
    public static final class Builder {
        ...
        /**
         * set whether the job can be rescheduled.
         * @hide
         */
        public Builder setRescheduleEnable(boolean rescheduleEnable) {
            mRescheduleEnable = rescheduleEnable;
            return this;
        }
