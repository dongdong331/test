            ...
            switch (code) {
                case QUERY_TRANSACTION:
                {
                    ...
                    if (SystemProperties.get("service.project.sec").equals("1")) {
                       String proviedname [] = {"sms","mms","mms-sms","call_log","contacts;com.android.contacts","contacts","com.android.contacts","icc","media",null} ;
                       ...
                       for (int i = 0 ; proviedname[i]  != null ; i++)
                       {
                           if (proviedauthority.equals(proviedname[i]))
                           {
                             ...
                             //Log.i("jason add ", "proviedname[i]=" + proviedname[i] + ", allow=" + allow);
                             if(allow < 0)
                             {
                                queryArgs = ContentResolver.createSqlQueryBundle("1==0",null,null);
                             }
                             break ;
                           }
                        }
