...
public class Camera {
    ...
    /**
     * Check camera id, if the id is greater than the return value of {@link android.hardware.Camera#getNumberOfCameras},
    ...
    private int cameraInitNormal(int cameraId) {
        ...
        */
        if (cameraId >= getNumberOfCameras()
                && !"com.android.camera2".equals(ActivityThread.currentOpPackageName())
                && !"com.android.settings".equals(ActivityThread.currentOpPackageName())
                && !"com.android.systemui".equals(ActivityThread.currentOpPackageName())) {
            return -EACCES;
        } else {
            return cameraInitVersion(cameraId, CAMERA_HAL_API_VERSION_NORMAL_CONNECT);
        }
    ...
    public class Parameters {
        ...
        public void setFocusMode(String value) {
            /*
             * SPRD: Fix bug 526233 if the focus is not adjustable, return here, or all parameter
             * settings will not be excuted in hal layer.
             */
        ...
        /**
         * Retrieve the value of photo contrast from Camera-HAL.
         *
         * @return The value of contrast.
         */
        ...
        /**
         * Retrieve the list of supported photo contrast from Camera-HAL.
         *
         * @return The list of contrast.
         */
        ...
        /**
         * Sets slowmotion multiple.
         *
         * @param value slowmotion.
         */
        ...
        /**
         * Gets the supported multiples of slowmotion.
         *
         * @return a list of supported slowmotion multiples.
         */
        ...
        /**
         * Set the brightness value to Camera-HAL.
         *
        ...
        /**
         * Retrieve the value of brightness from Camera-HAL.
         *
        ...
        /**
         * Retrieve the list of supported brightness from Camera-HAL.
         *
         * @return The list of supported brightness.
         */
         ...
         *
         * @param value a string value of iso.
         */
        ...
        /**
         * Sets the value of metering-mode.
         *
         * @param value The value of metering-mode.
         */
        ...
        /**
         * Gets the value of metering-mode.
         *
         * @return The value of metering-mode.
         */
         ...
         *
         * @return a list of supported metering modes.
         */
         ...
         *
         * @param value a string value of saturation.
         */
         ...
         *
         * @return a list of supported saturations.
         */
        ...
        /**
         * Sets the value of EOIS.
         *
         * @param value EOIS value.
         */
        ...
        /**
         * Retrieve the value of EIS/OIS.
         *
         * @return true if Camera-Hal has the EIS/OIS capacity.
         */
        ...
        /**
         * Returns true if the smile face detected feature is supported.
         * @return  true if the Camera Hal supports smiley face photography.
         *
         */
        ...
        /**
         * Returns true if the automatic anti flicker is supported.
         * @return  true if the Camera Hal supports automatic anti flicker.
         *
         */
        ...
        private static final String KEY_NEED_AF_BEFORE_CAPTURE = "is-takepicture-with-flash";

        public String getNeedAFBeforeCapture() {
            return get(KEY_NEED_AF_BEFORE_CAPTURE);
        }

        private static final String KEY_FLASH_LEVELS = "available-flash-level";
        public int getSupportedFlashLevels(){
            String str = get(KEY_FLASH_LEVELS);
            Log.i(TAG,"getsupportedflash levels="+str);
            if (str == null) {
                return 0;
            }
    ...
    // SPRD
    protected SensorSelfShotListenerApi1 mSensorSelfShotListenerApi1;

    @Deprecated
    public interface SensorSelfShotListenerApi1 {
        /**
         * Retrieve callback data of covered value of sub camera from camera-hal.
         *
         * @param faces Results of face detection, app only receive the value of faces[10].score,
         * in blur mode if the value changed from other value to 2 or 6, framework will notify app, app will show different toast.
         * In other mode, app will take picture when received the value of 2 or 6.
         * @param camera  The CameraAgent.CameraProxy which the callback is from.
         *
         * @see #setSensorSelfShotListenerApi1
         */
        void onSensorSelfShotApi1(Camera.Face[] faces, Camera camera);
    }

    /**
     * Registers a listener to make sure the result of cover in sub camera can be notified to app timely
     *
     * @param listener the listener to notify
     * @see #startPreview()
     */
    public final void setSensorSelfShotListenerApi1(SensorSelfShotListenerApi1 listener) {
        mSensorSelfShotListenerApi1 = listener;
    }
}
