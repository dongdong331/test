...
public interface BiometricFingerprintConstants {
    ...
    //add for dup finger constant by sprd begin
    /**
     * The finger image has been enrolled.
     * The user should be asked to change another finger to enroll.
     * @hide
     */
    public static final int FINGERPRINT_ACQUIRED_VENDOR_DUPLICATE_FINGER = FINGERPRINT_ACQUIRED_VENDOR_BASE + 5;

    /**
     * The area image of finger has been enrolled.
     * The user should be asked to move the finger to enroll.
     * @hide
     */
    public static final int FINGERPRINT_ACQUIRED_VENDOR_DUPLICATE_AREA = FINGERPRINT_ACQUIRED_VENDOR_BASE + 6;
    //add for dup finger constant by sprd end
}
