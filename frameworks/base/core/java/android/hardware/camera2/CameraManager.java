...
public final class CameraManager {
    ...
    public CameraCharacteristics getCameraCharacteristics(@NonNull String cameraId)
        ...
        synchronized (mLock) {
            if(!Arrays.asList(getCameraIdList()).contains(cameraId) && !isPrivatePackage()) {
            ...
            try {
                if(SystemProperties.get("service.project.sec").equals("1")){
                    ...
                    if ( permission > 0){
                        ...
                        throw new SecurityException("openCameraDeviceUserAsync reject");
                    }
                }
                if (supportsCamera2ApiLocked(cameraId)) {
    ...
    // SPRD
    private static boolean isPrivatePackage() {
        for (String str : privateList) {
            if (str.equals(ActivityThread.currentOpPackageName()))
                return true;
        }
        return false;
    }
    ...
    // SPRD
    private static final String[] privateList = {
            "com.android.camera2",
            "com.sprd.validationtools",
            "com.android.gallery3d",
            "com.android.settings",
            "com.android.systemui",
            "com.bellus3d.android.facecameraapp",
            "com.ts.cd.camera",
            "com.sprd.autoslt"
    };
