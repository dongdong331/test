...
public abstract class CameraMetadata<TKey> {
    ...
    public static final int STATISTICS_REFOCUS_MODE_OFF = 0;
    public static final int STATISTICS_REFOCUS_MODE_ON = 1;
    public static final int STATISTICS_STILL_IMAGE_REFOCUS_MODE_ON = 2;
}
