...
public final class CaptureRequest extends CameraMetadata<CaptureRequest.Key<?>>
    ...
    public static final Key<long[]> ANDROID_SPRD_FROM_FACEIDSERVICE_PHYADDR =
            new Key<long[]>("com.addParameters.sprdPhyAddrFromFaceID", long[].class);
    ...
    public static final Key<Integer> ANDROID_SPRD_DEVICE_ORIENTATION = new Key<Integer>(
            "com.addParameters.sprd3DeviceOrientation", int.class);
    ...
    public static final Key<Integer> ANDROID_SPRD_NORMAL_HDR_ENABLED = new Key<Integer>(
            "com.addParameters.sprdHdrPlusEnabled", int.class);
    ...
    public static final Key<Integer> ANDROID_SPRD_BURSTMODE_ENABLED = new Key<Integer>(
            "com.addParameters.sprdBurstModeEnabled", int.class);

    public static final Key<Integer> CONTROL_SPRD_BLUR_CIRCLESIZE = new Key<Integer>(
            "com.addParameters.sprd3BlurCircleSize", int.class);

    /*
     * SPRD: Fix bug 597206 that add new feature 3d photo
     * 0 -- Just main camera preview is enabled
     * 1 -- Just slave camera preview is enabled
     */
    public static final Key<Integer> ANDROID_SPRD_3D_PREVIEW_MODE = new Key<Integer>(
            "com.addParameters.sprdMultiCam3PreviewId", int.class);

    // SPRD:Add for Feature:refocus
    public static final Key<Integer> STATISTICS_REFOCUS_MODE = new Key<Integer>(
            "com.addParameters.refocusMode", int.class);

    // SPRD: Fix bug 591216 that add new feature 3d range finding, only support API2 currently
    public static final Key<int[]> ANDROID_SPRD_3D_RANGE_FIND_POINTS =
            new Key<int[]>("com.addParameters.sprd3DRangeFinderPoints", int[].class);

    public static final Key<Integer> CONTROL_SPRD_BLUR_F_NUMBER = new Key<Integer>(
            "com.addParameters.sprd3BlurFNumber", int.class);

    public static final Key<Integer> CONTROL_AVAILABLE_SPRD_SENSOR_SELF_SHOT = new Key<Integer>(
            "com.addParameters.sprd3AvailableSensorSelfShot", int.class);

    public static final Key<Integer> CONTROL_SPRD_BLUR_COVERED = new Key<Integer>(
            "com.addParameters.sprd3BlurCovered", int.class);

    public static final Key<Integer> CONTROL_SPRD_3DNR_ENABLED = new Key<Integer>(
            "com.addParameters.sprd3dnrEnabled", int.class);

    public static final Key<Integer> CONTROL_SPRD_FILTER_TYPE = new Key<Integer>(
            "com.addParameters.sprdfiltertype", int.class);

    public static final Key<Integer> CONTROL_SPRD_FAST_THUMB = new Key<Integer>(
            "com.addParameters.sprdfastthumb", int.class);

    public static final Key<Integer> CONTROL_SPRD_ADJUST_FLASH_LEVEL = new Key<Integer>(
            "com.addParameters.adjustSprdFlashLevel", int.class);

    // SPRD:Add for Feature:3DCalibration
    public static final Key<Integer> ANDROID_SPRD_3DCALIBRATION_ENABLED = new Key<Integer>(
            "com.addParameters.srpd3dCalibrationEnable",int.class);

    public static final Key<int[]> ANDROID_SPRD_3DCALIBRATION_CAPTURE_SIZE = new Key<int[]>(
            "com.addParameters.srpd3dCalibrationSize", int[].class);
    // SPRD:Add for Feature:3DCalibration end

    public static final Key<Integer> CONTROL_SPRD_APP_MODE_ID = new Key<Integer>(
            "com.addParameters.sprdAppmodeId", int.class);

    public static final Key<Integer> ANDROID_SPRD_AUTO_HDR_ENABLED = new Key<Integer>(
            "com.addParameters.sprdAutoHdrEnabled",int.class);

    /**
     *@hide
     **/
    public static final Key<Integer> ANDROID_SPRD_AI_SCENE_ENABLED = new Key<Integer>(
            "com.addParameters.sprdAISceneEnabled", int.class);

    /**
     *@hide
     **/
    public static final Key<Integer> ANDROID_SPRD_AUTO_3DNR_ENABLED = new Key<Integer>(
            "com.addParameters.sprd3auto3dnrEnabled", int.class);

    /**
     *@hide
     **/
    public static final Key<Integer> ANDROID_SPRD_3DNR_CAPTURE_ENABLED = new Key<Integer>(
            "com.addParameters.sprd3auto3dnrCaptureEnabled", int.class);
}
