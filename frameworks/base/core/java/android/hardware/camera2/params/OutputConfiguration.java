...
public final class OutputConfiguration implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(mIsSprd ? 1 : 0);
        dest.writeInt(mIsEIS ? 1 : 0);
    }
     ...
     * @hide
     */
    public void enableSprd(){
        mIsSprd = true;
    }

    // SPRD
    private boolean mIsEIS = false;
     ...
     * @hide
     */
    public void enableEIS(boolean eis){
        mIsEIS = eis;
    }
}
