...
public abstract class DisplayManagerInternal {
    ...
    // NOTE:  PQ Feature BEG-->
    public abstract void updateBatteryLevel(int level);
    public abstract void setSunLightProtectOn(boolean on);
    public abstract void setSunLightProtectTemporayDisabled(boolean disabled);
    // <-- NOTE: PQ Feature END
