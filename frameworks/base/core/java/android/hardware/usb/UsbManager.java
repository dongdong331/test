...
public class UsbManager {
   ...
   /**
     ...
     * Used in extras for the {ACTION_USB_STATE} broadcast in UsbManager
     *
     * {@hide}
     */
    ...
    public static final long FUNCTION_CDROM = 1 << 7;
    public static final long FUNCTION_MASS_STORAGE = 1 << 8;
    ...
    private static final long SETTABLE_FUNCTIONS = FUNCTION_MTP | FUNCTION_PTP | FUNCTION_RNDIS
            | FUNCTION_MIDI | FUNCTION_CDROM | FUNCTION_MASS_STORAGE;
    ...
    static {
        ...
        FUNCTION_NAME_TO_CODE.put(UsbManager.USB_FUNCTION_CDROM, FUNCTION_CDROM);
        FUNCTION_NAME_TO_CODE.put(UsbManager.USB_FUNCTION_MASS_STORAGE, FUNCTION_MASS_STORAGE);
    }
    ...
    public static String usbFunctionsToString(long functions) {
        ...
        if ((functions & FUNCTION_CDROM) != 0) {
            joiner.add(UsbManager.USB_FUNCTION_CDROM);
        }
        if ((functions & FUNCTION_MASS_STORAGE) != 0) {
            joiner.add(UsbManager.USB_FUNCTION_MASS_STORAGE);
        }
