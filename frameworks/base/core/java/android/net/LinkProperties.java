...
public final class LinkProperties implements Parcelable {
    ...
    /**
     * Sets the Maximum Transmission Unit size of IPv6 to use on this link.
     * Values less than 1280 or greater than 10000 will be ignored.
     *
     * @param ipv6Mtu The IPv6 MTU to use for this link.
     * @hide
     */
    ...
    /**
     * Gets the IPv6 MTU size set for this link.
     *
     * @return The IPv6 mtu value set for this link.
     * @hide
     */
    ...
    public String toString() {
        ...
        String ipv6Mtu = " IPV6 MTU: " + mIPv6Mtu;
        ...
        return "{" + ifaceName + linkAddresses + routes + dns + usePrivateDns
            + privateDnsServerName + domainName + mtu + ipv6Mtu + tcpBuffSizes + proxy
            + stacked + "}";
    }
    ...
    public boolean isIdenticalMtu(LinkProperties target) {
        return getMtu() == target.getMtu() && getIPv6Mtu() == target.getIPv6Mtu();
    }
