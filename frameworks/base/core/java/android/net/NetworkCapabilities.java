...
public final class NetworkCapabilities implements Parcelable {
    ...
    /** SPRD: Bug#632476
    * Indicates that this network is open wifi network, used in NetworkMonitor::isCaptivePortal()
    * to dinstinguish open and not open wifi network. Open Network may need Captive Portal.
    */
    /**
     * @hide
     */
    public static final int NET_CAPABILITY_OPEN = 23;

    private static final int MIN_NET_CAPABILITY = NET_CAPABILITY_MMS;
    private static final int MAX_NET_CAPABILITY = NET_CAPABILITY_OPEN;
    ...
    public static String capabilityNameOf(@NetCapability int capability) {
        switch (capability) {
            ...
            case NET_CAPABILITY_OPEN:           return "OPEN";
