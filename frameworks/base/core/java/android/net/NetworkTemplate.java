...
public class NetworkTemplate implements Parcelable {
    ...
    public NetworkTemplate(int matchRule, String subscriberId, String[] matchSubscriberIds,
        ...
        Log.d(TAG, "Construction NetworkTemplate: mMatchRule = " + mMatchRule
                    + ", mSubscriberId = " + mSubscriberId
                    + ", mMatchSubscriberIds = " + Arrays.toString(mMatchSubscriberIds)
    ...
    public String toString() {
        ...
        if (mSubscriberId != null) {
            builder.append(", real_subscriberId=").append(mSubscriberId);
        }
        if (mSubscriberId != null) {
        ...
        if (mMatchSubscriberIds != null) {
            builder.append(", real_matchSubscriberIds=").append(
                    Arrays.toString(mMatchSubscriberIds));
        }
        if (mMatchSubscriberIds != null) {
