...
public final class PowerManager {
   ...
   /**
    ...
    /**
     * Intent that is broadcast when lock screen and start to clean up apps
     * This broadcast is only sent to registered receivers.
     *
     * @hide
     */
    public static final String ACTION_POWER_CONTROLLER_KILL_APP
            = "android.os.action.POWER_CONTROLLER_KILL_APP";
    ...
    /**
     * open sun light protect
     * @hide
     */
    public void setSunLightProtectOn(boolean on) {
        try {
            mService.setSunLightProtectOn(on);
        } catch (Exception e) {
        }
    }

    /**
     * disable sun light protect function
     * @hide
     */
    public void setSunLightProtectTemporayDisabled(boolean disabled) {
        try {
            mService.setSunLightProtectTemporayDisabled(disabled);
        } catch (Exception e) {
        }
    }
    // <-- NOTE: PQ Feature END
