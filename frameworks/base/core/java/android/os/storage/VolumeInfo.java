...
public class VolumeInfo implements Parcelable {
    ...
    /* @SPRD: add for UMS */
    public static final int STATE_SHARED = IVold.VOLUME_STATE_SHARED;
    ...
    public static final int MOUNT_FLAG_PRI_EMU = IVold.MOUNT_FLAG_PRI_EMU;
