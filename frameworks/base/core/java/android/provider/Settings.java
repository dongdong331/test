...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        static {
            ...
            MOVED_TO_GLOBAL.add(Settings.Global.SOFTAP_SUPPORT_CHANNELS);
        }
        ...
        static {
            ...
            CLONE_FROM_PARENT_ON_VALUE.put(RINGTONE + "0", Secure.SYNC_PARENT_SOUNDS);
            CLONE_FROM_PARENT_ON_VALUE.put(RINGTONE + "1", Secure.SYNC_PARENT_SOUNDS);
    ...
    public static final class Secure extends NameValueTable {
        ...
        // SPRD:Bug 886448 add for assistant touch @{
        /**
        * @hide
        */
        ...
        * @hide
        */
        public static final String ASSISTANT_OPENBEFORE_ON = "assistant_openbefroe_on";
        /**
         * @hide
         */
    ...
    public static final class Global extends NameValueTable {
       ...
       public static final String BLUETOOTH_INTEROPERABILITY_LIST = "bluetooth_interoperability_list";
        ...
        /**
        * SOFTAP_CHANNEL_UPDATE_FLAG
        * @hide
        */
        public static final String SOFTAP_CHANNEL_UPDATE_FLAG = "softap_channel_update_flag";
        /**
       ...
       /**
        * SoftAp Support channnels.
        * @hide
        */
       public static final String SOFTAP_SUPPORT_CHANNELS =
               "hostapd_support_channels";
