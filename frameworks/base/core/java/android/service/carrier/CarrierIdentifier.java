...
public class CarrierIdentifier implements Parcelable {
    ...
    //SPRD:add for mvno match type PNN
    private @Nullable String mPnn;
    //SPRD:add tag for network prefer config
    private @Nullable String mIsNetworkPreferred;
    ...
    public CarrierIdentifier(String mcc, String mnc, @Nullable String spn, @Nullable String imsi, @Nullable String gid1,
                             @Nullable String gid2, @Nullable String pnn, @Nullable String isNetworkPreferred) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(mMcc, that.mMcc)
                ...
                && Objects.equals(mIsNetworkPreferred,that.mIsNetworkPreferred);
    }
    ...
    public String toString() {
      return "CarrierIdentifier{"
          ...
          + ",gid2=" + mGid2
          + ",mPnn=" + mPnn
          + ",mIsNetworkPreferred=" + mIsNetworkPreferred
          + "}";
    }
