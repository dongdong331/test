...
public final class DisplayCutout {
    ...
    /**
     * Creates the bounding path according to @android:string/config_mainBuiltInDisplayCutout
     * and the density we want in SuperResolution
     * @hide
     */
    public static DisplayCutout fromResources(Resources res, int displayWidth, int displayHeight, int density) {
        return fromSpec(res.getString(R.string.config_mainBuiltInDisplayCutout),
                displayWidth, displayHeight, density / (float) DENSITY_DEFAULT);
    }
