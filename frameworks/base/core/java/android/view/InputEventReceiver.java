...
public abstract class InputEventReceiver {
     ...
     * @hide
     */
    private static final String PROPERTY_PROFILE_DISPATCHINPUT =
                                                    "persist.sys.dispatch_input_reciver";
    ...
    public final void finishInputEvent(InputEvent event, boolean handled) {
        ...
        if (sDebugDispatchInput) {
            Log.d(TAG, "finishInputEvent handled is: " + handled
                    + " (True if the event was handled), event: " + event);
        }
    }
    ...
    private void dispatchInputEvent(int seq, InputEvent event, int displayId) {
        ...
        if (sDebugDispatchInput) {
            Log.d(TAG, "dispatchInputEvent event: " + event);
        }
    }
