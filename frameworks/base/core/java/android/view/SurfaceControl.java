...
public class SurfaceControl implements Parcelable {
    ...
    public static class Transaction implements Closeable {
        ...
        public Transaction setPosition(SurfaceControl sc, float x, float y) {
            sc.checkNotReleased();
            /* SPRD: 914282  y positon too big, result to SurfaceFlinger crash. @{  */
            if((int)y > Integer.MAX_VALUE/2 || (int)y < Integer.MIN_VALUE/2) {
                Log.e(TAG,"setPosition  x: " + x + " y: " + y + ", the position is  excessive,  so drop it, and set 0. Below is just Trace:");
