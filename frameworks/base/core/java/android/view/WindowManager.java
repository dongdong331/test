...
public interface WindowManager extends ViewManager {
    ...
    /**
     * SPRD: Message for taking screenshot of selected region and long screenshot.
     * @hide
     */
    final int TAKE_LONG_SCREENSHOT_SELECTED_REGION = 3;
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams implements Parcelable {
        ...
        /**
         * Flag to indicate that this window should be not run snapshot starting window
         * @hide
         */
        public static final int PRIVATE_FLAG_SNAPSHOT_NOT_RUN = 0x01000000;
