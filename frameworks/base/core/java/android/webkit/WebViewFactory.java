...
public final class WebViewFactory {
    ...
    private static final String CHROMIUM_WEBVIEW_NATIVE_FACTORY =
    ...
    public static Class<WebViewFactoryProvider> getWebViewProviderClass(ClassLoader clazzLoader)
	    ...
	    String gms = android.os.SystemProperties.get("ro.com.google.gmsversion");
        Log.i(LOGTAG, "SystemProperties GMSVERSION = " + gms);
        if (gms.isEmpty()) {
            // Not GMS.
            Log.i(LOGTAG, "Get WebViewChromiumFactoryProvider");
	
            return (Class<WebViewFactoryProvider>) Class.forName(CHROMIUM_WEBVIEW_NATIVE_FACTORY,
                true, clazzLoader);
        } else {
            Log.i(LOGTAG, "Get WebViewChromiumFactoryProviderForO");
