...
class DatePickerCalendarDelegate extends DatePicker.AbstractDatePickerDelegate {
    ...
    public DatePickerCalendarDelegate(DatePicker delegator, Context context, AttributeSet attrs,
        ...
        /*sprd fix bug943659 cannot scroll and select yead in settings*/
        mYearPickerView.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent ev) {
                ViewParent mViewParent = mYearPickerView.getParent();
                if (mViewParent != null) {
                    switch (ev.getAction()) {
