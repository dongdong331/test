    ...
    void fillGap(boolean down) {
        ...
        if (down) {
            ...
            final int startOffset = count > 0 ? getChildAt(count - 1).getBottom() + mDividerHeight :
                    paddingTop;
            /*SPRD: 898036 monkey IndexOutOfBoundsException @{ */
            try {
                ...
                if(ActivityManager.isUserAMonkey()){
                    ...
                    Log.i(TAG, "fillGap mFirstPosition:"+mFirstPosition+"count:"+count+", mItemCount:"+mItemCount);
                    throw e;
                }
            }
            /* @} */
        ...
        try {
            ...
            if (mItemCount == 0) {
                ...
                for (int i = 0; i < mAdapter.getCount(); i++) {
                    android.util.Log.d("ListView", "adapter count "
                            + i + " is: " + mAdapter.getItem(i));
                }
                IllegalStateException e = new IllegalStateException(
                        ...
                        + ", mItemCount = " + mItemCount + ", but adapter's count = "
                        + mAdapter.getCount());
                if (ActivityManager.isUserAMonkey()) {
