...
public final class Magnifier {
    ...
    public void show(@FloatRange(from = 0) float xPosInView,
        ...
        obtainSurfaces();
        android.util.Log.d("zhaoyang", "Magnifier, show, after obtainSurface, mParentSurface=" + mParentSurface 
            + ", mParentSurface.mSurface=" + mParentSurface.mSurface);
    ...
    private void obtainSurfaces() {
        ...
        if (mView.getViewRootImpl() != null) {
            ...
            android.util.Log.d("zhaoyang", "Magnifier, obtainSurface, mainWindowSurface=" + mainWindowSurface 
                + ", mainWindowSurface.isValid()=" + mainWindowSurface.isValid());
        ...
        if (mView instanceof SurfaceView) {
            ...
            android.util.Log.d("zhaoyang", "Magnifier, obtainSurface, surfaceViewSurface=" + surfaceViewSurface 
                + ",surfaceViewSurface.isValid()=" + surfaceViewSurface.isValid());
        ...
        android.util.Log.d("zhaoyang", "Magnifier, obtainSurface, validMainWindowSurface=" + validMainWindowSurface 
            + ", validSurfaceViewSurface=" + validSurfaceViewSurface);
