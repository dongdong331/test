...
public final class ColorDisplayController {
    ...
    private static final boolean mEnhanceState = SystemProperties.getBoolean(
    ...
    public int getMinimumColorTemperature() {
        if (mEnhanceState) {
            return mContext.getResources().getInteger(
                    R.integer.config_nightDisplayColorTemperatureMin_sprd);
        } else {
            return mContext.getResources().getInteger(
    ...
    public int getMaximumColorTemperature() {
        if (mEnhanceState) {
            return mContext.getResources().getInteger(
                    R.integer.config_nightDisplayColorTemperatureMax_sprd);
        } else {
            return mContext.getResources().getInteger(
    ...
    public int getDefaultColorTemperature() {
        if (mEnhanceState) {
            return mContext.getResources().getInteger(
                    R.integer.config_nightDisplayColorTemperatureDefault_sprd);
        } else {
            return mContext.getResources().getInteger(
