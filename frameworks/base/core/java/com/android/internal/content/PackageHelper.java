...
public class PackageHelper {
    ...
    public static boolean fitsOnExternal(Context context, SessionParams params) {
        ...
        */
        final File target = EnvironmentEx.getExternalStoragePath();
        return ((params.sizeBytes > 0) && (Environment.MEDIA_MOUNTED.equals(EnvironmentEx.getExternalStoragePathState()))
                && (params.sizeBytes <= storage.getStorageBytesUntilLow(target)));
        /* @} */
    }
    ...
    public static int resolveInstallLocation(Context context, SessionParams params)
        ...
        if ((params.installFlags & PackageManager.INSTALL_INSTANT_APP) != 0) {
            ...
            Log.e(TAG, "INSTALL_ADOPTABLE_VOLUME");
        ...
        if (prefer == RECOMMEND_INSTALL_ADOPTABLE) {
            ...
            Log.d(TAG, "fitsOnAdoptbale = " + fitsOnAdoptbale);
        }
