...
import android.os.HprofFactory;
    ...
    private static class LoggingHandler implements Thread.UncaughtExceptionHandler {
        ...
        public void uncaughtException(Thread t, Throwable e) {
            ...
            if (mApplicationObject == null && (Process.SYSTEM_UID == Process.myUid())) {
                ...
                HprofFactory.getInstance().dumpHProfile("system_process", e);
                ...
                /* SPRD: Dump hprofile when OOM @{ */
                if (processName != null) {
                    HprofFactory.getInstance().dumpHProfile(processName, e);
                } else {
                    HprofFactory.getInstance().dumpHProfile("process_name_null", e);
                }
                /* @} */
            }
        }
