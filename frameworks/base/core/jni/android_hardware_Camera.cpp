...
static jint android_hardware_Camera_getNumberOfCameras(JNIEnv *env, jobject thiz)
{
    ...
    if (fp) {
        ...
        if (strncmp(acBuf, "com.android.camera2", 19) == 0
                ...
                || strncmp(acBuf, "com.android.gallery3d", 21) == 0
                || strncmp(acBuf, "com.sprd.autoslt", 16) == 0) {
    ...
    number_of_cameras = number_of_cameras <= 2 ? number_of_cameras : 2;
    ALOGI("number_of_cameras:%d", number_of_cameras);
