...
public class BitmapFactoryEx {
    ...
    /** returns Bitmap from a native function. */
    public static Bitmap decodeDrmStream(DrmManagerClientEx client, DecryptHandle handle,
    ...
    private static native Bitmap nativeDecodeDrmStream(DrmManagerClientEx client,
            DecryptHandle handle, BitmapFactory.Options opts, boolean applyScale, float scale);
}
