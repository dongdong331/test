...
public class SoterUtil {
    ...
    // hunter.ding@spreadtrum.com, add to check exported key size
    private static final int MAX_EXPORTED_KEY_SIZE = 2048;
    ...
    private static JSONObject retriveJsonFromExportedData(byte[] origin) {
        ...
        // hunter.ding@spreadtrum.com, avoid Force Close
        // 2048 is empirical value, most of key's size is less than it
        if (rawLength > MAX_EXPORTED_KEY_SIZE) {
            return null;
        }
