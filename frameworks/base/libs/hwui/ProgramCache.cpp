...
#ifndef HWUI_PROGRAM_USE_HIGHP
#define HWUI_PROGRAM_USE_HIGHP true
#endif
...
#ifdef HWUI_PROGRAM_USE_HIGHP
        "uniform highp vec2 textureDimension;\n";
#else
...
#ifdef HWUI_PROGRAM_USE_HIGHP
const char* gFS_Header = "precision highp float;\n\n";
#else
...
const char* gFS_Main_FragColor_HasRoundRectClip =
        ...
        "    highp float linearDist = clamp(roundRectRadius - (length(dist) * roundRectRadius), "
#else
