...
#define PROPERTY_TEXTURE_CACHE_SIZE "ro.vendor.hwui.texture_cache_size"
#define DEFAULT_TEXTURE_CACHE_SIZE 24.0f

#define DEFAULT_TARGET_HWUI_PLATFORM 0
 ...
 * or Vulkan.
 */
#define PROPERTY_RENDERER "ro.vendor.hwui.renderer"

#define PROPERTY_PLATFORM "ro.vendor.hwui.platform"
