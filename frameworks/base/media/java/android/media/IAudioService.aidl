...
interface IAudioService {
    ...
    boolean getSafeMediaVolumeEnabled(String callingPackage);
    ...
    void setForceUseSpeaker(int usage, boolean on, IBinder cb, String callingPkg);

    void setDeviceConnectionStateForFM(int device, int state,
