...
public class MediaFile {
    ...
    protected static void addFileType(String extension, int fileType, String mimeType,
    ...
    static {
        ...
        MediaFileExUtils.addFileType();
    }

    public static boolean isAudioFileType(int fileType) {
        return ((fileType >= FIRST_AUDIO_FILE_TYPE &&
                fileType <= LAST_AUDIO_FILE_TYPE) ||
                (fileType >= MediaFileExUtils.SPRD_FIRST_AUDIO_FILE_TYPE2 &&
                fileType <= MediaFileExUtils.SPRD_LAST_AUDIO_FILE_TYPE2) ||
                (fileType >= FIRST_MIDI_FILE_TYPE &&
                fileType <= LAST_MIDI_FILE_TYPE)||
                (fileType >= MediaFileExUtils.SPRD_FIRST_MIDI_FILE_TYPE &&
                fileType <= MediaFileExUtils.SPRD_LAST_MIDI_FILE_TYPE));
    }
    ...
    public static boolean isVideoFileType(int fileType) {
        return (fileType >= FIRST_VIDEO_FILE_TYPE &&
            ...
            || (fileType >= MediaFileExUtils.SPRD_FIRST_VIDEO_FILE_TYPE2 &&
                fileType <= MediaFileExUtils.SPRD_LAST_VIDEO_FILE_TYPE2);
    }
