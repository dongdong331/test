                                  ...
                                  , AudioRouting
{
    ...
    private static final int KEY_PARAMETER_DRM_NEEDCONSUME = 1500;
    ...
    public void setDataSource(@NonNull Context context, @NonNull Uri uri,
        ...
        if (ContentResolver.SCHEME_FILE.equals(scheme)) {
            ...
            if (Settings.System.DEFAULT_RINGTONE_URI.equals(uri)
                        && actualUri == null && cacheUri != null) {
                cacheUri = Uri.parse(cacheUri.toString() + "sprd_ringtone");
            }
    ...
    /**
     * Add control interface to consume drm rights
     * {@hide}
     */
    public void consumeDrmRights() {
        Parcel pattributes = Parcel.obtain();
        setParameter(KEY_PARAMETER_DRM_NEEDCONSUME,pattributes);
        pattributes.recycle();
    }
