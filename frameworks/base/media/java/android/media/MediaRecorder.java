...
public class MediaRecorder implements AudioRouting
{
    ...
    public void setCaptureRate(double fps) {
     ...
     /**
     * Set parameter to indicate whether to use 64bit file offset in MPEG4Writer. If use64BitFlag is true,
     * this condition can make sure the duration of videorecord(>= 720p) more than one hour.
     * @hide
     * @param use64BitFlag If use64BitFlag is true, use 64bit file offset, otherwise use 32bit file offset.
     */
    public void setParam64BitFileOffset(boolean use64BitFlag)
    {
     ...
     /**
     * Set frame rate to achieve slow motion effect
     * @hide
     * @param fps frame rate
     */
    public void setSlowMotionRate(double fps) {
        setParameter("slow-motion-enable=1");
        setParameter("slow-motion-fps=" + fps);
    }
    ...
    * {@hide}
    */
    protected native void setParameter(String nameValuePair);
