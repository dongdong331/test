...
public class MtpStorage {
    ...
    private static final String TAG = MtpStorage.class.getSimpleName();
    ...
    public MtpStorage(StorageVolume volume, int storageId) {
        if(sDebug)Log.d(TAG,"MtpStorage storageId:" + storageId);
        mStorageId = storageId;
        mPath = volume.getInternalPath();
        if(sDebug)Log.d(TAG,"MtpStorage mPath:"+mPath);
