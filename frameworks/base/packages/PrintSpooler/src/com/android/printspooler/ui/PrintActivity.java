...
public class PrintActivity extends Activity implements RemotePrintDocument.UpdateResultCallbacks,
    ...
    private final class PrintersObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            /* UNSIOC: bug 989720 Avoid NPE when history printer is not loaded completely @{*/
            if (printerHolder == null) {
                Log.d(LOG_TAG, "mHistoricalPrintersLoaded : " +  mDestinationSpinnerAdapter.mHistoricalPrintersLoaded);
                return;
            }
            /*@}*/
            ...
            if (!mIsTransformationStarted) {
                ...
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected void onPostExecute(String error) {
                        //BUG 903620 throws IllegalStateException
                        try {
                            if (mIsServiceBinded) {
                                mContext.unbindService(DocumentTransformer.this);
                            }
                        } catch (IllegalArgumentException e) {
                            Log.d(LOG_TAG,"throws error"+e.toString());
                        }
