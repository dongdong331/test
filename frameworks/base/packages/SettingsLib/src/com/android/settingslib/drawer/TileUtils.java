...
public class TileUtils {
    ...
    public static List<DashboardCategory> getCategories(Context context,
        ...
        int size = tiles.size();
        final boolean supportGoogleAudio = isSupportGoogleAudio();
    ...
    public static boolean isSupportGoogleAudio() {
        return SystemProperties.getBoolean("ro.config.google.sound",false);
    }
