...
public class DreamBackend {
    ...
    public List<DreamInfo> getDreamInfos() {
        ...
        /* Bug 903521 , check whether it has checked any item. @{ */
    ...
    public CharSequence getActiveDreamName() {
        ...
        if (cn != null) {
            ...
            try {
                ...
                //BUG if not installed google clock,suit to unisoc clock
                ...
                } catch (PackageManager.NameNotFoundException ec) {
                    return null;
                }
            }
        }
    ...
    public void launchSettings(DreamInfo dreamInfo) {
        ...
        if (dreamInfo == null || dreamInfo.settingsComponentName == null)
            return;
        //BUG:905174 Calling startActivity from outside of an Activity
        Intent intent = new Intent();
        if (!(mContext instanceof Activity)) {
            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        }
        mContext.startActivity(intent.setComponent(dreamInfo.settingsComponentName));
    }
