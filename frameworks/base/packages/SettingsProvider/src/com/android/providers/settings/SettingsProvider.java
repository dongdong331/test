...
public class SettingsProvider extends ContentProvider {
    ...
    public ParcelFileDescriptor openFile(Uri uri, String mode) throws FileNotFoundException {
        ...
        /* SPRD: Bug912406 testExternalStorageReadDefaultUris fail for multy sim id*/
        else if (Settings.System.getUriFor(Settings.System.RINGTONE_CACHE+"0").equals(uri)) {
            cacheRingtoneSetting = Settings.System.RINGTONE_CACHE+"0";
            cacheName = Settings.System.RINGTONE_CACHE;
        } else if(Settings.System.getUriFor(Settings.System.RINGTONE_CACHE+"1").equals(uri)) {
            cacheRingtoneSetting = Settings.System.RINGTONE_CACHE+"1";
            cacheName = Settings.System.RINGTONE_CACHE;
        }
        /* @} */
    ...
    final class SettingsRegistry {
        ...
        private void migrateLegacySettingsForUserLocked(DatabaseHelper dbHelper,
            ...
            ensureSecureSettingAndroidIdSetLocked(secureSettings);
            // Workround for bug1043350
            ensurePovisionFlagSetForParserError(secureSettings);
            ...
            if (userId == UserHandle.USER_SYSTEM) {
                ...
                // Workround for bug1043350
                ensurePovisionFlagSetForParserError(globalSettings);
                globalSettings.persistSyncLocked();
            }
            /* Workround for bug1043350 start */
            File errorFile = new File(SettingsState.ERROR_FILE_PATH);
            if (errorFile.exists()) {
                Slog.v(LOG_TAG, SettingsState.ERROR_FILE_PATH + " exist");
                try {
                    errorFile.delete();
                    Slog.v(LOG_TAG, SettingsState.ERROR_FILE_PATH + " delete success");
                } catch (Exception e) {
                    Slog.v(LOG_TAG, SettingsState.ERROR_FILE_PATH + " delete failed");
                }
            }
            /* Workround for bug1043350 end */
        ...
        /**
         * Recover core data after settings_secure.xml or settings_global.xml is deleted
         * @param settingsState
         * Workround for bug1043350
         */
        private void ensurePovisionFlagSetForParserError(SettingsState settingsState) {
            File errorFile = new File(SettingsState.ERROR_FILE_PATH);
            Slog.v(LOG_TAG, "error file exist = " + errorFile.exists());
            if (!errorFile.exists() || settingsState == null) {
                Slog.v(LOG_TAG, "No error, return!");
                return;
            }
            Slog.v(LOG_TAG, "mKey = " + settingsState.mKey);
            if (isGlobalSettingsKey(settingsState.mKey)) {
                settingsState.insertSettingLocked(Settings.Global.DEVICE_PROVISIONED,
                        "1", null, true, SettingsState.SYSTEM_PACKAGE_NAME);
            } else if (isSecureSettingsKey(settingsState.mKey)) {
                settingsState.insertSettingLocked(Settings.Secure.USER_SETUP_COMPLETE,
                        "1", null, true, SettingsState.SYSTEM_PACKAGE_NAME);
            }
        }
