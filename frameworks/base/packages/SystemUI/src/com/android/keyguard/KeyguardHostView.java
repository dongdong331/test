...
public class KeyguardHostView extends FrameLayout implements SecurityCallback {
    ...
    private static final int MSG_CANCEL_LOCK = 1;
    /* @} */
    ...
    protected void onFinishInflate() {
        ...
        mBroadcastReceiver = new BroadcastReceiver(){
            ...
            public void onReceive(Context context, Intent intent) {
                if (intent.getAction().equals(UNLOCK_FOR_CALL_REJECT_REQUIRED)) {
                    mHandler.sendEmptyMessage(MSG_CANCEL_LOCK);
                }
            }
        };
        IntentFilter filter = new IntentFilter();
        filter.addAction(UNLOCK_FOR_CALL_REJECT_REQUIRED);
    ...
    Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == MSG_CANCEL_LOCK) {
                userActivity();
                dismiss(false, KeyguardUpdateMonitor.getCurrentUser());
            }
        }
    };
    /* @} */
