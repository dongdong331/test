...
public class KeyguardPasswordView extends KeyguardAbsKeyInputView
    ...
    protected int getPromptReasonStringRes(int reason) {
        switch (reason) {
            ...
            case PROMPT_REASON_AFTER_FACE_LOCKOUT:
                return R.string.kg_prompt_reason_after_face_lockout_password;
            case PROMPT_REASON_AFTER_FACE_CAMERA_ERROR:
                return R.string.kg_prompt_reason_after_face_camera_error_password;
    ...
    public void beforeTextChanged(CharSequence s, int start, int count, int after) {
        /* UNSOC: fix for bug 929200 @{ */
        ContentResolver resolver = getContext().getContentResolver();
        TextKeyListener.getInstance().updatePasswordVisiable(resolver, System.getIntForUser(resolver, System.TEXT_SHOW_PASSWORD, 1, ActivityManager.getCurrentUser()) > 0);
        /* @} */
        if (mCallback != null) {
            mCallback.userActivity();
        }
