    ...
    public void showPromptReason(int reason) {
        switch (reason) {
            ...
            case PROMPT_REASON_AFTER_FACE_LOCKOUT:
                mSecurityMessageDisplay.setMessage(R.string.kg_prompt_reason_after_face_lockout_pattern);
                break;
            case PROMPT_REASON_AFTER_FACE_CAMERA_ERROR:
                mSecurityMessageDisplay.setMessage(R.string.kg_prompt_reason_after_face_camera_error_pattern);
                break;
