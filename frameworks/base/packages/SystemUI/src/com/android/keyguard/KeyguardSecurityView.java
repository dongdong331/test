...
public interface KeyguardSecurityView {
    ...
    /**
     * Some auth is required because too many wrong faceid to a lockout.
     */
    int PROMPT_REASON_AFTER_FACE_LOCKOUT = 6;

    /**
     * Some auth is required because face camera not available.
     */
    int PROMPT_REASON_AFTER_FACE_CAMERA_ERROR = 7;
