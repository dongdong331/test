...
public class KeyguardUpdateMonitorCallback {
    ...
    /**
     * UNISOC : Called when the modem assert.
     */
    ...
    /**
     * Unisoc: Called when need to unlock simlock by NV
     */
    public void onShowSimLockByNv() { }

    /**
     * Unisoc: Called when need to unlock simlock by Sim
     */
    public void onShowSimLockBySim() { }

    /**
     * Called when a face couldn't be authenticated.
     */
    public void onFaceLockAuthFailed() { }

    /**
     * Called when a face is recognized.
     * @param userId the user id for which the face was authenticated
     */
    public void onFaceLockAuthenticated() { }

    /**
     * Called when face provides help string (e.g. "Try again")
     * @param msgId
     * @param helpString
     */
    public void onFaceLockHelp(int msgId, String helpString) { }

    /**
     * Called when face provides an semi-permanent error message
     * (e.g. "Hardware not available").
     * @param msgId one of the error messages listed in {@link FaceManager}
     * @param errString
     */
    public void onFaceLockError(int msgId, String errString) { }

    /**
     * Called when a face couldn't be authenticated while in face lockout mode.
     */
