...
public class PasswordTextView extends View {
    ...
    public PasswordTextView(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        mDrawPaint.setTypeface(Typeface.create(
                ...
                0));
        //UNISOC: fix for bug 924142
        mShowPassword = Settings.System.getIntForUser(mContext.getContentResolver(),
                Settings.System.TEXT_SHOW_PASSWORD, 1, ActivityManager.getCurrentUser()) == 1;
    ...
    public void append(char c) {
        /* UNISOC: add for bug915575 @{ */
        if (mLimit && mText.length() >= LIMIT_LENGTH) {
            return;
        }
        /* @} */
