...
public class BatteryMeterView extends LinearLayout implements
    ...
    /* Bug 886407 add charge animation of batteryView*/
    private BatteryMeterDrawable mSprdDrawable;
    /*@}*/
    ...
    /*Bug 886407 add charge animation of batteryView*/
    private boolean mBatteryAnimation = true;
    /*@}*/
        ...
        mUserTracker = new CurrentUserTracker(mContext) {
            ...
            public void onUserSwitched(int newUserId) {
                ...
                getContext().getContentResolver().registerContentObserver(
                        ...
                        newUserId);
                /*Bug 895141 Percent can't update when change user*/
                updateShowPercent();
            }
        };
    ...
    public void onAttachedToWindow() {
        ...
        if(mSprdDrawable != null){
            mSprdDrawable.setBatteryController(mBatteryController);
            mSprdDrawable.startListening();
        }
        /*@}*/
    }
