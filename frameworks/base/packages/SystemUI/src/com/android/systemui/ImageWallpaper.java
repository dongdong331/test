...
public class ImageWallpaper extends WallpaperService {
    ...
    private static final boolean DEBUG = SystemProperties.getBoolean("persist.sys.wallpaper.debug", false);
    private static final String PROPERTY_KERNEL_QEMU = "ro.kernel.qemu";
    private static final String PROPERTY_OPENGL_EMULATOR = "qemu.gles";
    ...
    public void onCreate() {
        ...
        if(SystemProperties.getInt(PROPERTY_OPENGL_EMULATOR,1) == 0){
            Log.i(TAG, "Disable OPENGL render in Wallpaper");
        }
    }
    ...
    class DrawableEngine extends Engine {
        ...
        void drawFrame() {
            ...
            try {
                ...
                int newDensityDpi = displayInfo.logicalDensityDpi;

                Log.d(TAG,"logicalDensityDpi = "+displayInfo.logicalDensityDpi);
                // Sometimes a wallpaper is not large enough to cover the screen in one dimension.
                // Call updateSurfaceSize -- it will only actually do the update if the dimensions
                // should change
                if ((newRotation != mLastRotation) || (newDensityDpi != mLastDensityDpi)){
                ...
                Log.d(TAG, "mLastSurfaceWidth = "+mLastSurfaceWidth+"; mLastSurfaceHeight = "+mLastSurfaceHeight);
                boolean surfaceDimensionsChanged = dw != mLastSurfaceWidth
                        || dh != mLastSurfaceHeight;

                boolean redrawNeeded = surfaceDimensionsChanged || newRotation != mLastRotation
                        || mSurfaceRedrawNeeded || newDensityDpi != mLastDensityDpi;
                ...
                try {
                    ...
                    if (mBackground != null) {
                        ...
                        Log.i(TAG, "Redrawing in rect: " + dest + " with surface size: "
                                + mLastRequestedWidth + "x" + mLastRequestedHeight + ", canvasWidth = " + c.getWidth() + ", canvasHeight = " + c.getHeight());
