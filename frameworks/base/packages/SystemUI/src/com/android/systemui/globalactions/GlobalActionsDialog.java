...
class GlobalActionsDialog implements DialogInterface.OnDismissListener,
    ...
    private AirplaneModeAction mAirplaneModeOn;
        ...
        for (int i = 0; i < defaultActions.length; i++) {
            ...
            if (GLOBAL_ACTION_KEY_POWER.equals(actionKey)) {
                ...
                if (StatusBar.SUPPORT_SUPER_POWER_SAVE){
                   ...
                   if(getPowerSaveModeInternal() != PowerManagerEx.MODE_ULTRASAVING){
    ...
    /* UNISOC: 907946 Create an action button with airplane mode type ToggleAction @{ */
    private class AirplaneModeAction extends ToggleAction{
        ...
        public View create(Context context, View convertView, ViewGroup parent, LayoutInflater inflater) {
            mView = inflater.inflate(com.android.systemui.R.layout.global_actions_item, parent, false);
        ...
        private void setEnable(boolean isEnable, boolean isCreatedCall){
            if (mView != null && mView.isEnabled() != isEnable || isCreatedCall){
                mView.setEnabled(isEnable);
                int childCount = ((LinearLayout) mView).getChildCount();
                for (int i=0; i<childCount; i++){
                    ((LinearLayout) mView).getChildAt(i).setEnabled(isEnable);
                }
            }
        }
    ...
    private static final class ActionsDialog extends Dialog implements DialogInterface,
        ...
        public ActionsDialog(Context context, OnClickListener clickListener, MyAdapter adapter,
            ...
            if(SystemProperties.get("ro.build.product", "null").contains("sp7731e")){
