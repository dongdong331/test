...
public class GlobalActionsImpl implements GlobalActions, CommandQueue.Callbacks {
    ...
    public void showShutdownUi(boolean isReboot, String reason) {
        ...
        boolean darkText = Dependency.get(SysuiColorExtractor.class).getColors(
                onKeyguard ? WallpaperManager.FLAG_LOCK : WallpaperManager.FLAG_SYSTEM).supportsDarkText();
        Context context = new ContextThemeWrapper(mContext,
                darkText ? com.android.systemui.R.style.Theme_SystemUI_Light : com.android.systemui.R.style.Theme_SystemUI);
        final int textColor = Utils.getColorAttr(context, com.android.systemui.R.attr.wallpaperTextColor);
        int color = Utils.getColorAttr(context, com.android.systemui.R.attr.wallpaperTextColor);
