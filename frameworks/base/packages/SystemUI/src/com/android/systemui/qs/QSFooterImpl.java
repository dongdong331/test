...
//                .addFloat(mMobileGroup, "alpha", 0, 1)
    ...
    private void updateVisibilities() {
        /*SPRD bug 885650:Super power feature*/
        boolean isSuperPower = false;

        if(StatusBar.SUPPORT_SUPER_POWER_SAVE){
            isSuperPower = (getPowerSaveModeInternal() == PowerManagerEx.MODE_ULTRASAVING);
        }
        /*@}*/
        mSettingsContainer.setVisibility(mQsDisabled ? View.GONE : View.VISIBLE);
        mSettingsContainer.findViewById(R.id.tuner_icon).setVisibility(
                TunerService.isTunerEnabled(mContext) && !isSuperPower ? View.VISIBLE : View.INVISIBLE);
        final boolean isDemo = UserManager.isDeviceInDemoMode(mContext);
        mMultiUserSwitch.setVisibility(showUserSwitcher(isDemo) && !isSuperPower ? View.VISIBLE : View.INVISIBLE);
        mEdit.setVisibility(isDemo || !mExpanded || isSuperPower ? View.INVISIBLE : View.VISIBLE);
        mSettingsButton.setVisibility(isDemo || !mExpanded ? View.INVISIBLE : View.VISIBLE);
        mSettingsContainer.findViewById(R.id.settings_button_container).setVisibility(isSuperPower ? View.INVISIBLE : View.VISIBLE);
        //UNISOC: fix for bug 941951
    ...
    /*private void handleUpdateState() {
        ...
        if (mInfo.visible) {
            ...
            mMobileSignal.setImageResource(mInfo.mobileSignalIconId);
    ...
    @Override
    public void setPowerSaveMode(int mode) {
        mMode = mode;
        Log.d("QSFooterxxrrsuper", "setPowerSaveMode mode="+mode);
        updateVisibilities();
    }
    /*@}*/
}
