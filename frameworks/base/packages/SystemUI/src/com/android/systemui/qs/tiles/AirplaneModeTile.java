...
public class AirplaneModeTile extends QSTileImpl<BooleanState> {
    ...
    public void handleClick() {
        ...
        /* UNISOC : Modify for bug 938099 @{ */
        if (TelephonyManager.from(mContext).getCallState() != TelephonyManager.CALL_STATE_IDLE) {
            Log.d(TAG, "collapsePanels during calling");
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        state.icon = mIcon;
        Log.d(TAG,"airplane handleUpdateState airplaneMode="+airplaneMode);
        if (state.slash == null) {
