...
public class NightDisplayTile extends QSTileImpl<BooleanState>
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        final Drawable mEnable = mContext.getDrawable(R.drawable.ic_qs_nightmode_enabled);
        final Drawable mDisable = mContext.getDrawable(R.drawable.ic_qs_nightmode_disabled);
