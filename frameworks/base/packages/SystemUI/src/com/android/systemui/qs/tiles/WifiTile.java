...
public class WifiTile extends QSTileImpl<SignalState> {
    ...
    protected void handleClick() {
        ...
        Log.d(TAG,"handleClick wifi state="+mState.value);
    ...
    protected void handleUpdateState(SignalState state, Object arg) {
        ...
        if (mExpectDisabled) {
            if (cb.enabled) {
                Log.d(TAG,"handleUpdateState ignore updates");
        ...
        Log.d(TAG,"handleUpdateState wifiConnected="+wifiConnected+"state.icon="+state.icon);
