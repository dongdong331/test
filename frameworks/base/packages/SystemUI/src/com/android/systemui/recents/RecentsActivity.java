...
import com.android.systemui.recents.events.ui.UpdateMemoryInfoEvent;
...
public class RecentsActivity extends Activity implements ViewTreeObserver.OnPreDrawListener,
    ...
    /* SPRD: new feature of quick cleaning. @{ */
    ...
    public void updateMemoryInfo() {
        ActivityManager.MemoryInfo info = Recents.getSystemServices().getMemoryInfo();
        long avail = info.availMem;
        String availStr = Formatter.formatFileSize(this, avail);
        String totalStr = getRamSizeFromProperty();
        mMemoryAvailText.setText(getString(R.string.recents_memory_avail, availStr));
    ...
    public String getRamSizeFromProperty() {
        ...
        if ("unconfig".equals(size)) {
            ...
            return Formatter.formatShortFileSize(this, covertUnitsToSI(ramSize));
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /* SPRD: new feature of quick cleaning. @{ */
        ImageButton clearButton = (ImageButton) findViewById(R.id.recents_memory_trash_can);
        mMemoryAvailText = (TextView) findViewById(R.id.recents_memory_avail);
        mMemoryTotalText = (TextView) findViewById(R.id.recents_memory_total);
    ...
    protected void onStart() {
        ...
        updateMemoryInfo();// SPRD: new feature of quick cleaning.
    }
    ...
    public final void onBusEvent(DeleteTaskDataEvent event) {
        ...
        /* SPRD: new feature of lock recent apps. @{ */
        if(Recents.ENABLE_TASK_LOCK && !event.task.isTaskLocked){
    ...
    /* SPRD: new feature of quick cleaning. @{ */
    public final void onBusEvent(UpdateMemoryInfoEvent event) {
        if (event.dismissAll) {
            final long availBefore = event.avail;
            final long availAfter = Recents.getSystemServices().getMemoryInfo().availMem;
            final long size = availAfter > availBefore ?  (availAfter - availBefore) : 0;
            String release = Formatter.formatFileSize(this, size);
            String avail = Formatter.formatFileSize(this, availAfter);
            Toast toast;
            if (size == 0) {
                toast = Toast.makeText(this,
                    this.getString(R.string.recents_nothing_to_clear), Toast.LENGTH_SHORT);
            } else {
                toast = Toast.makeText(this,
                    this.getString(R.string.recents_clean_finished_toast, release.toUpperCase(), avail.toUpperCase()), Toast.LENGTH_SHORT);
            }
