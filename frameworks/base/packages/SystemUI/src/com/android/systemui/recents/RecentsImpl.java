...
public class RecentsImpl implements ActivityOptions.OnAnimationFinishedListener {
    ...
    private final static int WAITING_FOR_TRANSITION_START_TIMEOUT = 2000;
    private Runnable mOnWaitingForTransitionStartTimeout = new Runnable() {
        @Override
        public void run() {
    ...
    public void toggleRecents(int growTarget) {
        ...
        if (mWaitingForTransitionStart) {
            ...
            mHandler.removeCallbacks(mOnWaitingForTransitionStartTimeout);
            mHandler.postDelayed(mOnWaitingForTransitionStartTimeout, WAITING_FOR_TRANSITION_START_TIMEOUT);
            return;
        }
