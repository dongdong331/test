...
public class TaskStackView extends FrameLayout implements TaskStack.TaskStackCallbacks,
   ...
   public void updateLayoutAlgorithm(boolean boundScrollToNewMinMax,
    ...
    public final void onBusEvent(final DismissAllTaskViewsEvent event) {
        ...
        event.addPostAnimationCallback(new Runnable() {
            ...
            public void run() {
                ...
                ActivityManager.MemoryInfo info = Recents.getSystemServices().getMemoryInfo();// SPRD: new feature of quick cleaning.
                // Remove all tasks and delete the task data for all tasks
                mStack.removeAllTasks(true /* notifyStackChanges */);
                for (int i = tasks.size() - 1; i >= 0; i--) {
                    EventBus.getDefault().send(new DeleteTaskDataEvent(tasks.get(i)));
                }
                Recents.getSystemServices().sendUpdateMemoryInfo(true  /* dismissAll */, info.availMem);// SPRD: new feature of quick cleaning.
    ...
    public final void onBusEvent(TaskViewDismissedEvent event) {
        ...
        Recents.getSystemServices().sendUpdateMemoryInfo(false  /* dismissAll */, 0l);// SPRD: new feature of quick cleaning.
