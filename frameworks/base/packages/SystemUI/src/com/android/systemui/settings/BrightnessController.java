...
public class BrightnessController implements ToggleSlider.Listener {
    ...
    private final Runnable mStartListeningRunnable = new Runnable() {
        ...
        public void run() {
            ...
            //mHandler.sendEmptyMessage(MSG_ATTACH_LISTENER);//UNISOC: Modify for bug957617
        }
    };
    ...
    private final Runnable mStopListeningRunnable = new Runnable() {
        ...
        public void run() {
            ...
            //mHandler.sendEmptyMessage(MSG_DETACH_LISTENER);//UNISOC: Modify for bug957617
        }
    };
    ...
    public void registerCallbacks() {
        ...
        mControl.setOnChangedListener(BrightnessController.this);//UNISOC: Modify for bug957617
    ...
    public void unregisterCallbacks() {
        ...
        mControl.setOnChangedListener(null);//UNISOC: Modify for bug957617
