...
public class NeutralGoodDrawable extends LayerDrawable {
    ...
    public static NeutralGoodDrawable create(Context context, int resId) {
        ...
        /* UNISOC: Modify for bug972332 {@ */
        return create(context, light, dark, resId);
        /* @} */
    }
     ...
     */
    /* UNISOC: Modify for bug972332 {@ */
    public static NeutralGoodDrawable create(Context context, Context light, Context dark, int resId) {
    ...
    /* UNISOC: Modify for bug972332 {@ */
    protected NeutralGoodDrawable(Context context, Drawable []drawables) {
        super(drawables);
