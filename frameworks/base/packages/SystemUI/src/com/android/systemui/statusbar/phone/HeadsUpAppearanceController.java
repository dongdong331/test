...
public class HeadsUpAppearanceController implements OnHeadsUpChangedListener,
    ...
    private boolean mCheckBarModefromHeadsup = false;
    ...
    private void updateTopEntry() {
        ...
        mStatusBar = mHeadsUpStatusBarView.getStatusBar();
    ...
    private void setShown(boolean isShown) {
        if (mShown != isShown) {
            ...
            mCheckBarModefromHeadsup = false;
        }
    }
    ...
    public boolean isCheckBarModefromHeadsUp() {
         return mCheckBarModefromHeadsup;
    }
    /**
