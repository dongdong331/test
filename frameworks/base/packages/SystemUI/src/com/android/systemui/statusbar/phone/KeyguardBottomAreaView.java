...
public class KeyguardBottomAreaView extends FrameLayout implements View.OnClickListener,
    ...
    //UNISOC: fix for 941564
    private static final boolean DISABLE_KEYGUARD_ICON_INFLATER = true;
    ...
    private void inflateCameraPreview() {
        ...
        //UNISOC: fix for 941564
        if(DISABLE_KEYGUARD_ICON_INFLATER) {
            mCameraPreview = new View(mContext);
            mCameraPreview.setBackground(mContext.getResources().getDrawable(R.drawable.cover));
        } else {
    ...
    private void updateLeftPreview() {
        //UNISOC: fix for 941564
        if(DISABLE_KEYGUARD_ICON_INFLATER) return;
