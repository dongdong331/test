...
public class KeyguardBouncer {
    ...
    public int getTop() {
        ...
        //UNSOC: fix for bug 906582
        if (mKeyguardView.getCurrentSecurityMode() == SecurityMode.Pattern) {
            View pattern = mKeyguardView.findViewById(R.id.lockPatternView);
            top += pattern.getTop();
        }
        return top;
    }
    ...
    public boolean needsFullscreenBouncer() {
        ...
        if (mKeyguardView != null) {
            ...
            return mode == SecurityMode.SimPin || mode == SecurityMode.SimPuk
                    ...
                    || mode == SecurityMode.SimLock
                    /* For SubsidyLock feature @{ */
                    || mode == SecurityMode.SubsidyLock_Lock
                    || mode == SecurityMode.SubsidyLock_EnterCode
                    || mode == SecurityMode.SubsidyLock_Init;
                    /* @} */
        }
        return false;
    }
