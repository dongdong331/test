...
public class NavigationBarFragment extends Fragment implements Callbacks {
    ...
    private final OverviewProxyListener mOverviewProxyListener = new OverviewProxyListener() {
        ...
        public void onBackButtonAlphaChanged(float alpha, boolean animate) {
	     ...
	     final boolean useAltBack =
            ...
            boolean disableBack = ((mNavigationBarView.mDisabledFlags & View.STATUS_BAR_DISABLE_BACK) != 0) && !useAltBack; 
            Log.d(TAG, "onBackButtonAlphaChanged disableBack = "+disableBack+" useAltBack"+useAltBack);	    
    ...
    boolean onHomeLongClick(View v) {
        ...
        /* UNISOC: Modify for bug970184 {@ */
        if (mStatusBar.SUPPORT_SUPER_POWER_SAVE && getPowerSaveMode() == PowerManagerEx.MODE_ULTRASAVING) {
    ...
    private void onRecentsClick(View v) {
        ...
        int mode = getPowerSaveMode();
        if(mStatusBar.SUPPORT_SUPER_POWER_SAVE && mode == PowerManagerEx.MODE_ULTRASAVING){
    ...
    public int getPowerSaveMode(){
        IPowerManagerEx mPowerManagerEx = IPowerManagerEx.Stub.asInterface(ServiceManager.getService("power_ex"));
        if (mPowerManagerEx == null) return -1;
        try {
