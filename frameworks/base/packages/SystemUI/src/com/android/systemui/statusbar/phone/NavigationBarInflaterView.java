...
public class NavigationBarInflaterView extends FrameLayout
    ...
    // define navigation settings value
    public static final int NAVIGATION_RIGHT = 0x00;
    ...
    public void setIsSupportDynavBar(boolean isSupport){
        mSupportDynamicBar = isSupport;
    }
    private String readLNavigationLayoutSettings() {
        String navLayoutSetting;
        int lastNavBarMode = Settings.System.getInt(
                mContext.getContentResolver(), "navigationbar_config", 0);
    ...
    private final ContentObserver mNavigationSettingsObserver = new ContentObserver(
            new Handler()) {
        @Override
        public void onChange(boolean selfChange) {
            ...
            inflateLayout(getDefaultLayout());
            if (getParent() instanceof NavigationBarView) {
                ((NavigationBarView) getParent()).updataNavigationBar();
            }
        }
    };
    ...
    protected void inflateLayout(String newLayout) {
        android.util.Log.d(TAG, "mCurrentLayout: " + mCurrentLayout
                + "; newLayout: " + newLayout);
