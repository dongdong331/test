...
public class NotificationIconAreaController implements DarkReceiver {
    ...
    private void updateTintForIcon(StatusBarIconView v) {
	 ...
	 /*Unisoc bug 906697:Notification icon display as a white icon{@*/
        ...
        boolean colorize = CHECK_SDK_VERSION ? !isPreL || NotificationUtils.isGrayscale(v, mNotificationColorUtil)
                : NotificationUtils.isGrayscale(v, mNotificationColorUtil);
        /*@}*/
