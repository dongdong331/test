...
public class NotificationPanelView extends PanelView implements
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (KeyguardSubsidyLockController.getInstance(mContext).isSubsidyLock()) {
            Log.d(TAG, "subsidyLock handle onTouchEvent");
            return false;
        }
        /* @} */
    ...
    private void setKeyguardBottomAreaVisibility(int statusBarState,
        ...
        if (goingToFullShade) {
            ...
            mKeyguardBottomArea.setVisibility(!isSuperPower ? View.VISIBLE : View.GONE);
    ...
    protected void onTrackingStarted() {
        ...
        PerformanceManagerInternal.getDefault().scheduleBoostRRForApp(true);
    ...
    protected void onTrackingStopped(boolean expand) {
        ...
        PerformanceManagerInternal.getDefault().scheduleBoostRRForApp(false);
    }
    ...
    public void setPowerSaveMode(int mode) {
        mMode = mode;
        Log.d(TAG, "setPowerSaveMode 11 mode=" + mode);
        isSuperPower = mMode == PowerManagerEx.MODE_ULTRASAVING;
    }
    /* @} */
