...
public abstract class PanelView extends FrameLayout {
    ...
    //UNISOC: fix for bug 978911
    private static final int INITIAL_OPENING_PEEK_DURATION = 0;
    ...
    public void expand(final boolean animate) {
        if (!isFullyCollapsed() && !isCollapsing()) {
            // UNISOC: fix for bug 961065 Expanded but current not visible, update if need
            if(mStatusBar.getBarState() == StatusBarState.KEYGUARD
...
/* SPRD bug 885650  Keyguard super power */
    public abstract void setPowerSaveMode(int mode);
    /* @} */
