...
public class ScrimController implements ViewTreeObserver.OnPreDrawListener, OnColorsChangedListener,
    ...
    private void updateScrimColor(View scrim, float alpha, int tint) {
        ...
        if (scrim instanceof ScrimView) {
            ...
            Trace.traceCounter(Trace.TRACE_TAG_APP,
                    ...
                    Color.alpha(tint));
            /*SPRD bug 964053 /976302/966474/967921:Super power feature*/
            if ((StatusBar.SUPPORT_SUPER_POWER_SAVE) && (mStatusBar.getCurPowerSaveMode() == PowerManagerEx.MODE_ULTRASAVING)) {
                scrimView.setTint(Color.BLACK);
                scrimView.setViewAlpha(0);
            } else {
    ...
    public void onColorsChanged(ColorExtractor colorExtractor, int which) {
        Log.d(TAG,"onColorsChanged which=" + which);
        ...
        Log.d(TAG,"onColorsChanged end mLockColors=" + mLockColors + "mSystemColors=" + mSystemColors);
    }
   ...
   public void updateScrimsAlpha(int alpha){
        if (mScrimInFront != null) {
           mScrimInFront.setViewAlpha(alpha);
        }
