...
import com.android.keyguard.KeyguardSubsidyLockController;
public class StatusBar extends SystemUI implements DemoMode,
    ...
    public static final boolean DEBUG_CAMERA_LIFT = true;
    ...
    private static final int MSG_NOTIFY_SYSTEM_GC = 1004;
    ...
    private static final boolean IS_LOWRAM_DEVICE = ActivityManager.isLowRamDeviceStatic();
    ...
    private boolean hasLockWallpaper = false;
    private boolean assitOpenBeforeUltraSaveMode;
    private QSFooter mFooter;
    private int curMode = PowerManagerEx.MODE_SMART;
    /*@}*/
    ...
    public void start() {
        ...
        if(SUPPORT_SUPER_POWER_SAVE){
            ...
            int mode = getPowerSaveModeInternal();
            mPowerSaveMode = mode;
            curMode = mode;
        }
        /*@}*/
        ...
        /* UNISOC: fix for notify gc @{ */
        if(IS_LOWRAM_DEVICE) {
            //wait for 5 minutes to notify gc
            mHandler.sendEmptyMessageDelayed(MSG_NOTIFY_SYSTEM_GC, 5 * 60 * 1000);
        }
        /* @} */
    }
    ...
    protected void makeStatusBarView() {
        ...
        /*SPRD bug 885650:Super power feature*/
        if(SUPPORT_SUPER_POWER_SAVE && mNotificationPanel != null){
            int mode = mBatteryController.getPowerSaveModeInternal();
            if(mFooter != null){
            ...
            if (mNavigationBar != null){
                mNavigationBar.setPowerSaveMode(mode);
            }
            /* @} */
        }
        /*@}*/
    ...
    public void clearAllNotifications() {
        ...
        /* UNISOC: fix for bug 963482 @{ */
        if ((StatusBar.SUPPORT_SUPER_POWER_SAVE) && (getPowerSaveModeInternal() == PowerManagerEx.MODE_ULTRASAVING)) {
    ...
    protected void updateFooter() {
        ...
        boolean showFooterView = (showDismissView ||
                ...
                /* UNISOC bug 908469 disable FooterView when in MODE_ULTRASAVING */
                && !(SUPPORT_SUPER_POWER_SAVE && mPowerSaveMode == PowerManagerEx.MODE_ULTRASAVING)
                /* @} */
    ...
    public void updateMediaMetaData(boolean metaDataChanged, boolean allowEnterAnimation) {
        ...
        if (ENABLE_LOCKSCREEN_WALLPAPER && artworkDrawable == null) {
            Bitmap lockWallpaper = mLockscreenWallpaper.getBitmap();
             ...
             /*SPRD bug 885650:Super power feature*/
            if (lockWallpaper == null && curMode == PowerManagerEx.MODE_ULTRASAVING) {
                hasLockWallpaper = true;
                lockWallpaper = BitmapFactory.decodeResource(mContext.getResources(), com.android.internal.R.drawable.default_wallpaper);
            }
            /* @} */
        ...
        if ((hasArtwork || DEBUG_MEDIA_FAKE_ARTWORK) && !mDozing
            ...
            if (mBackdrop.getVisibility() != View.VISIBLE) {
                ...
                //UNISOC: fix for bug 975478
                mColorExtractor.setMediaBackdropVisible(mediaMetadata != null);
            ...
            if (mBackdrop.getVisibility() != View.GONE) {
                /* SPRD bug 723104  Keyguard super power @{ */
        ...
        /* SPRD bug 885650  Keyguard super power @{ */
        if (SUPPORT_SUPER_POWER_SAVE && curMode == PowerManagerEx.MODE_ULTRASAVING) {
            mBackdropBack.setImageDrawable(new ColorDrawable(0x000000));
            mBackdrop.setVisibility(View.INVISIBLE);
        }
        /* @} */
        Trace.endSection();
    ...
    public boolean shouldPeek(Entry entry, StatusBarNotification sbn) {
        ...
        /* UNISOC:bug 919475 @{ */
        boolean simPinSecure = KeyguardUpdateMonitor.getInstance(mContext).isSimPinOrPuk();
        Log.d(TAG, "shouldPeek simPinSecure =" + simPinSecure);
        if(simPinSecure){
            return false;
        }
        /* @} */
    ...
    public int getCurPowerSaveMode() {
        return curMode;
    }
    ...
    public void setPanelExpanded(boolean isExpanded) {
        ...
        /* SPRD: Bug 886422 new feature of dynamic navigationbar @{ */
        if(getNavigationBarView() != null){
            getNavigationBarView().setPanelExpanded(isExpanded);
        }
        /*@}*/
    }
    ...
    public void animateCollapsePanelsForPowerSave() {
        Log.d(TAG,"animateCollapsePanelsForPowerSave mState =" + mState);
        if (mState == StatusBarState.KEYGUARD) {
    ...
    private final Runnable mAnimateCollapsePanelsForPowerSave = this::animateCollapsePanelsForPowerSave;
    ...
    public void postAnimateCollapsePanelsForPowerSave() {
        mHandler.post(mAnimateCollapsePanelsForPowerSave);
    }
    ...
    public void animateCollapsePanels(int flags, boolean force, boolean delayed,
        ...
        if (mStatusBarWindow != null && mNotificationPanel.canPanelBeCollapsed()) {
            ...
            /* UNISOC: Modify for bug959804 {@ */
            if ((flags & CommandQueue.FLAG_HOME_KEY) != 0) {
                mStatusBarView.collapsePanel(false /* animate */, delayed, speedUpFactor);
            } else {
    ...
    public void animateCollapseKeyguardQuickSettings() {
        if (((mState == StatusBarState.KEYGUARD) || (mState == StatusBarState.SHADE_LOCKED)) && (mStatusBarView != null)) {
            mStatusBarView.collapsePanel(true, false /* delayed */, 1.0f /* speedUpFactor */);
        }
    }
    ...
    public boolean interceptTouchEvent(MotionEvent event) {
        ...
        if (KeyguardSubsidyLockController.getInstance(mContext).isSubsidyLock()) {
            Log.d(TAG, "subsidyLock state, return true");
            return true;
        } else {
            Log.d(TAG, "not subsidyLock state, return false");
            return false;
        }
    }
    ...
    void checkBarModes() {
        ...
        if ((mHeadsUpAppearanceController != null) && (mHeadsUpAppearanceController.isCheckBarModefromHeadsUp())){
           // do not change navigation bar mode when checkbarmodes is called by headsup notification
        }else{
    ...
    void checkBarMode(int mode, int windowState, BarTransitions transitions) {
        ...
        if ((mHeadsUpAppearanceController != null) && (mHeadsUpAppearanceController.isShown())){
             Log.d(TAG,"Statusbar checkBarMode mHeadsUp is shown ");
             mode = MODE_OPAQUE;
        }
        if((mHeadsUpAppearanceController != null) && (mHeadsUpAppearanceController.isCheckBarModefromHeadsUp())){
             mLightBarController.refreshStatusbarforHeadsup(mode);
        }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_CLOSE_SYSTEM_DIALOGS.equals(action)) {
                ...
                if (mLockscreenUserManager.isCurrentProfile(getSendingUserId())) {
                    /* UNISOC: Modify for bug959804 {@ */
                    int flags = CommandQueue.FLAG_EXCLUDE_NONE | CommandQueue.FLAG_HOME_KEY;
                    /* @} */
            ...
            /*SPRD bug 885650:Super power feature*/
            else if (SUPPORT_SUPER_POWER_SAVE && action.equals(PowerManagerEx.ACTION_POWEREX_SAVE_MODE_CHANGED)) {
                curMode = intent.getIntExtra(PowerManagerEx.EXTRA_POWEREX_SAVE_MODE, PowerManagerEx.MODE_POWERSAVING);
                int preMode = intent.getIntExtra(PowerManagerEx.EXTRA_POWEREX_SAVE_PREMODE, PowerManagerEx.MODE_POWERSAVING);
                Log.d(TAG, "action="+action+",curMode="+curMode+",preMode="+preMode);
                mPowerSaveMode = curMode;
                mPrePowerSaveMode = preMode;
                if(mFooter != null){
                    mFooter.setPowerSaveMode(curMode);
                }
                /* UNISOC: Modify for bug974161 {@ */
                if (mNavigationBar != null){
                    mNavigationBar.setPowerSaveMode(curMode);
                }
                /* @} */
                if(mQSPanel != null){
                    mQSPanel.setPowerSaveMode(curMode);
                }
                if (mNotificationPanel != null) {
                    mNotificationPanel.setPowerSaveMode(curMode);
                }
                if(mBatteryController != null){
                    mBatteryController.updatePowerSaveMode(preMode);
                }
                if(mDataSaverController != null && curMode == PowerManagerEx.MODE_ULTRASAVING
                ...
                final Uri uri =  Settings.Secure.getUriFor(QSTileHost.TILES_SETTING);
                Dependency.get(TunerService.class).reloadSettingForsuperPower(uri);
                if(curMode == PowerManagerEx.MODE_ULTRASAVING){
                    clearAllNotifications();
                    closeTouchAssit();
                    /*SPRD bug 964053 /976302/966474:Super power feature*/
                    if ((mState == StatusBarState.KEYGUARD) || (mState == StatusBarState.SHADE_LOCKED)) {
                        /* to prevent flash when wallpaper is light because ScrimContoller's onColorchanged is delayed sometimes */
                        mScrimController.updateScrimsAlpha(0);
                        if(!ENABLE_LOCKSCREEN_WALLPAPER) {
                           mStatusBarWindowManager.setKeyguardShowing(true);
                        }
                        updateTheme();
                        updateMediaMetaData(false, false);
                    }
                    /* @} */
                } else if (mPrePowerSaveMode == PowerManagerEx.MODE_ULTRASAVING) {
                    assitOpenBeforeUltraSaveMode = Settings.Secure.getInt(mContext.getContentResolver(), Settings.Secure.ASSISTANT_OPENBEFORE_ON, 0) == 1;
                    Log.d(TAG, "assitOpenBeforeUltraSaveMode="+assitOpenBeforeUltraSaveMode);
                    if (assitOpenBeforeUltraSaveMode) {
                        startTouchAssit();
                    }
                    /*SPRD bug 959953:Super power feature*/
                    if ((mState == StatusBarState.KEYGUARD) || (mState == StatusBarState.SHADE_LOCKED)) {
                        updateTheme();
                        updateMediaMetaData(false, false);
                    }
            ...
            //fix for bug 974160
            } else if (mDataSaverController != null && Intent.ACTION_USER_SWITCHED.equals(action)
                       && mDataSaverController.isDataSaverEnabled()) {
                mDataSaverController.setDataSaverEnabled(false);
            }
            /*@}*/
    ...
    /*SPRD bug 885650:Super power feature*/
    private void closeTouchAssit() {
        String action = "com.android.systemui.FLOATKEY_ACTION_STOP";
        boolean isAssitOpen = Settings.Secure.getInt(mContext.getContentResolver(), Settings.Secure.ASSISTANT_ON, 0) == 1;
        if (!isAssitOpen) return;
        assitOpenBeforeUltraSaveMode = true;
        Settings.Secure.putInt(mContext.getContentResolver(), Settings.Secure.ASSISTANT_OPENBEFORE_ON, 1) ;
        Log.d(TAG, "touchAssistOpen:" + isAssitOpen + " stop it!");
    ...
    private void startTouchAssit() {
        String action = "com.android.systemui.FLOATKEY_ACTION_START";
        Log.d(TAG, "start touchAssist");
        mContext.sendBroadcastAsUser(new Intent(action), UserHandle.ALL);
        Settings.Secure.putInt(mContext.getContentResolver(), Settings.Secure.ASSISTANT_ON, 1);
        Settings.Secure.putInt(mContext.getContentResolver(), Settings.Secure.ASSISTANT_OPENBEFORE_ON, 0) ;
        assitOpenBeforeUltraSaveMode = false;
    }
    /*@}*/
    ...
    protected void setLockscreenUser(int newUserId) {
        if (ENABLE_LOCKSCREEN_WALLPAPER && mLockscreenWallpaper != null) {
    ...
    public void animateKeyguardUnoccluding() {
        ...
        // UNISOC: fix by bug 894257
        boolean simPinSecure = KeyguardUpdateMonitor.getInstance(mContext).isSimPinSecure();
        boolean subsidyLockSecure = KeyguardSubsidyLockController.getInstance(mContext).isSubsidyLock();
        Log.d(TAG, "StatusBar,simPinSecure =" + simPinSecure);
        Log.d(TAG, "StatusBar,subsidyLockSecure =" + subsidyLockSecure);
        if(simPinSecure || subsidyLockSecure) {
            return;
        }
        animateExpandNotificationsPanel();
    }
    ...
    protected void updateTheme() {
            ...
            mUiOffloadThread.submit(() -> {
                try {
                    ...
                    mOverlayManager.setEnabled("com.android.systemui.theme.dark",
                            useDarkTheme, UserHandle.USER_SYSTEM);
                    /* @} */
                } catch (RemoteException e) {
        ...
        boolean lockDarkText = mColorExtractor.getColors(WallpaperManager.FLAG_LOCK, true
                /* ignoreVisibility */).supportsDarkText();
        if ((StatusBar.SUPPORT_SUPER_POWER_SAVE) && (getPowerSaveModeInternal() == PowerManagerEx.MODE_ULTRASAVING)) {
            Log.d(TAG,"updateTheme set lockDarkText to false");
            lockDarkText = false;
        }
    ...
    public void onCameraLaunchGestureDetected(int source) {
        ...
        if (!mStatusBarKeyguardViewManager.isShowing()) {
            ...
            if (isScreenTurningOnOrOn()) {
                ...
                KeyguardUpdateMonitor.getInstance(mContext).onCameraGestureTriggered();
    ...
    private void notifySystemGC() {
        AsyncTask.execute(new Runnable() {
            @Override
            public void run() {
                if (!isScreenStayOn()) return;
                if (getProcessMemInfo() > 45 * 1000) {
                    if(mHandler != null) {
                        mHandler.post(new Runnable() {
                            @Override
                            public void run() {
                                Log.d(TAG, "notifySystemGC");
                                System.gc();
    ...
    private boolean isScreenStayOn() {
        return Settings.Global.getInt(mContext.getContentResolver(),
                Settings.Global.STAY_ON_WHILE_PLUGGED_IN, 0) != 0;
    }

    private int getProcessMemInfo() {
        ActivityManager activityManager = (ActivityManager) mContext.getSystemService(Context.ACTIVITY_SERVICE);
        List<ActivityManager.RunningAppProcessInfo> appProcessList = activityManager
            .getRunningAppProcesses();

        if (appProcessList == null) return 0;
        for (ActivityManager.RunningAppProcessInfo appProcessInfo : appProcessList) {
            if(appProcessInfo == null) return 0;
    ...
    /*SPRD bug 885650:Super power feature*/
    private int mPowerSaveMode = -1;
    private int mPrePowerSaveMode = -1;
    ...
    public void loadAllowedAppListInUltraSavingMode(){
        try {
            mAppList.clear();
            mAppList = mPowerManagerEx.getAllowedAppListInUltraSavingMode();
            Log.d(TAG, "loadAllowedAppListInUltraSavingMode size="+mAppList.size());
            for(String app : mAppList){
                Log.d(TAG, "\nloadAllowedAppListInUltraSavingMode app="+app);
            }
        } catch (Exception e) {
    ...
    public boolean filterNotificationInSuperPowerMode(StatusBarNotification notification){
        Log.d(TAG, "filterNotificationInSuperPowerMode mPowerSaveMode="+mPowerSaveMode);
        if(notification == null || mPowerSaveMode != PowerManagerEx.MODE_ULTRASAVING){
            return false;
        }
        String packName = notification.getPackageName();
        Log.d(TAG, "filterNotificationInSuperPowerMode packName="+packName);
        if(packName != null && packName.equals("android")){
            Log.d(TAG, "ignore android process!");
            return false;
        }
        try {
            loadAllowedAppListInUltraSavingMode();
            if(mAppList != null){
                boolean contains = mAppList.contains(packName);
                Log.d(TAG, "filterNotificationInSuperPowerMode contains="+contains);
                return contains;
            }
        } catch (Exception e) {
            // TODO: handle exception
