...
public interface NetworkController extends CallbackController<SignalCallback>, DemoMode {
    ...
    public interface SignalCallback {
        ...
        // UNISOC: Bug 697836 add interface for volte icon
        default void setMobileVolteIndicators(boolean show, int subId, int resId) {}
        // UNISOC: add feature statusbar signal cluster view.
        default void setMobileDataConnectedIndicators(boolean show, int subId){}

        default void setMobileVoWifiIndicators(IconState icon){}

        default void setMobileHdVoiceIndicators(IconState icon){}
    }
