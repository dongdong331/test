...
public class VolumeDialogImpl implements VolumeDialog {
    ...
    public void initSettingsH() {
        ...
        mSettingsIcon.setOnClickListener(v -> {
            ...
            /* SPRD fix for bug 894945 @{ */
            if(!SystemProperties.getBoolean("ro.config.google.sound", false)) {
                intent = new Intent("com.sprd.action.AUDIO_PROFILE");
            }
            /* @} */
    ...
    private void updateVolumeRowH(VolumeRow row) {
        ...
        // update slider min
        if(row.stream != AudioManager.STREAM_VOICE_CALL){
        ...
        final int iconRes =
                ...
                : ss.routedToBluetooth ?
                        (ss.muted ? R.drawable.ic_volume_media_bt_mute
                                :(ss.level == 0)? R.drawable.ic_volume_media_bt_mute:R.drawable.ic_volume_media_bt)
