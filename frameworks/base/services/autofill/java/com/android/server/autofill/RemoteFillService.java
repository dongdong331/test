...
final class RemoteFillService implements DeathRecipient {
    ...
    protected final Object mAutoFillServiceLock = new Object();
    protected final Object mPendingRequestLock = new Object();
    ...
    private void handleBinderDied() {
        if (checkIfDestroyed()) return;
        try {
        synchronized (mAutoFillServiceLock) {
          ...
          Slog.e(LOG_TAG, "handleBinderDied has NoSuchElementException: " + e);
        }
        mServiceDied = true;
