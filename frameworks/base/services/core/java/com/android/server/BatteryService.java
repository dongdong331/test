...
public final class BatteryService extends SystemService {
    ...
    private static final boolean DEBUG = false || getDeBugBatteryLog();
    ...
    // add for bug#1021541
    private int mRealBatteryLevel;
    private int mSetBatteryLevel;
    ...
    private void shutdownIfOverTempLocked() {
        ...
        if (mHealthInfo.batteryTemperature > mShutdownBatteryTemperature) {
             /*SPRD : add power debug log start*/
            Slog.d(TAG, "Battery over-temperature shutdown, batteryTemperature : "
                ...
                try {
                    ...
                    switch (key) {
                        ...
                        case "level":
                            ...
                            // add for bug#1021541
                            mSetBatteryLevel = mHealthInfo.batteryLevel;
                            break;
                        case "counter":
