...
class BluetoothManagerService extends IBluetoothManager.Stub {
    ...
    public boolean isBleSupport(){
        ...
        if (pm != null && pm.hasSystemFeature(PackageManager.FEATURE_BLUETOOTH_LE)) {
           Slog.d(TAG, "BLE feature is supported");
           return true;
        }
        return false;
    }
    ...
    private void continueFromBleOnState() {
        ...
        try {
            ...
            if (isBluetoothPersistedStateOnBluetooth() || !isBleAppPresent()) {
                ...
                persistBluetoothSetting(BLUETOOTH_ON_BLUETOOTH);
                // UNISOC: bug 969957
                // mEnable  could  be reset by disable() when BLE_TURNING_ON. Reenable it.
                mEnable = true;
            }
        } catch (RemoteException e) {
    ...
    private void sendBrEdrDownCallback() {
        ...
        // mBluetoothGatt may be null, when BLE APP enableBLE illegally.
        if (isBleAppPresent() && mBluetoothGatt != null) {
            ...
            switch (msg.what) {
                ...
                case MESSAGE_ENABLE:
                    ...
                    if (mBluetooth == null) {
                        ...
                        //
                        if (waitForOnOff(false, true)) {
                            Message restartMsg =
                                    mHandler.obtainMessage(MESSAGE_RESTART_BLUETOOTH_SERVICE);
                            mHandler.sendMessageDelayed(restartMsg, 2 * SERVICE_RESTART_TIME_MS);
                            Slog.d(TAG, "sendMessageDelayed: MESSAGE_RESTART_BLUETOOTH_SERVICE");
                        }
                    }
                    break;
