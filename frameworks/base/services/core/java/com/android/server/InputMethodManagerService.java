...
import com.android.internal.view.AbsInputMethodManager;
import com.android.server.statusbar.StatusBarManagerService;
import com.android.server.SprdInputMethodManagerService;
 ...
 */
public class InputMethodManagerService extends AbsInputMethodManager
    ...
    public static final class Lifecycle extends SystemService {
        ...
        public Lifecycle(Context context) {
            super(context);
            mService = new SprdInputMethodManagerService(context);
        }
    ...
    protected void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
        ...
        if (args != null && args.length > 0) {
            ...
            if (option != null && option.length() > 0 && option.charAt(0) == '-') {
                handleDebugCmd(fd, pw, option,args);
                return;
            }
        }
        /** @} **/
