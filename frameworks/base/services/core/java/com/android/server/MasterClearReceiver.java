...
public class MasterClearReceiver extends BroadcastReceiver {
    ...
    private static final String FILE_DISPLAY_CONF= "/mnt/vendor/enhance/display.conf";
    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        //bug 909356: Recovery factory settings cannot restore super resolution power saving status.
        deleteFile(FILE_DISPLAY_CONF);
