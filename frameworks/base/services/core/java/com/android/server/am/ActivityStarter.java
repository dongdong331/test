...
import static com.android.server.am.ActivityManagerDebugConfig.startActivityResultCodeToString;
...
class ActivityStarter {
    ...
    private int startActivityUnchecked(final ActivityRecord r, ActivityRecord sourceRecord,
        ...
        if (reusedActivity != null) {
            // SPRD: bug824245, reused activity should not be removed while process died.
            reusedActivity.inReusedState = true;
            ...
            // operations.
            ActivityRecord newIntentActivity = null;
            if ((mLaunchFlags & FLAG_ACTIVITY_CLEAR_TOP) != 0
                ...
                if (top != null) {
                    ...
                    // SPRD: bug867446, make the top activity into reused state to ensure that
                    // it can not be removed in its resuming flow.
                    newIntentActivity = top;
                    newIntentActivity.inReusedState = true;
                }
            }

            mSupervisor.sendPowerHintForLaunchStartIfNeeded(false /* forceSend */, reusedActivity);
            // UNISOC: bug 908491, reusedActivity need a tmp copy to ensure inReusedState has been
            // resetted finally.
            ActivityRecord tmpReusedActivity = reusedActivity;
            reusedActivity = setTargetStackAndMoveToFrontIfNeeded(reusedActivity);
            // reset the reused state flag
            tmpReusedActivity.inReusedState = false;
            if (newIntentActivity != null) {
                newIntentActivity.inReusedState = false;
            }
