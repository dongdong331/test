...
class AppTaskImpl extends IAppTask.Stub {
    ...
    private static final String TAG = TAG_WITH_CLASS_NAME ? "AppTaskImpl" : TAG_AM;
    ...
    public void finishAndRemoveTask() {
        ...
        synchronized (mService) {
            ...
            try {
                Slog.i(TAG, "finishAndRemoveTask is called to remove task#"
                        + mTaskId + ", callingUid:" + callingUid + ", callingPid:"
                        + callingPid);
