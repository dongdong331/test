...
public final class BatteryStatsService extends IBatteryStats.Stub
    ...
    private BatteryStatsInternal.BatteryStatsListener mBatteryStatsListener;
    ...
    private final class LocalService extends BatteryStatsInternal {
        ...
        // NOTE:  Power SmartSense Feature BEG-->
        @Override
        public void registerBatteryStatsListener(BatteryStatsInternal.BatteryStatsListener listener) {
            mBatteryStatsListener = listener;
        }
        // <-- NOTE: Power SmartSense Feature END
    }
    ...
    public void systemReady() {
        final PowerController.LocalService mPowerControllerInternal = LocalServices.getService(PowerController.LocalService.class);
        if (mPowerControllerInternal == null) return;
        mPowerControllerInternal.registerPowerModeObserver(
                new PowerController.PowerModeListener() {
            @Override
            public void onPowerModeChanged(int mode) {
                Slog.d(TAG, "onPowerModeChanged(" + mode + ")");
                synchronized (mStats) {
                    mStats.notePowerMode(mode);
                }
            }
        });
    ...
    void noteProcessStart(String name, int uid) {
        synchronized (mStats) {
            ...
            // NOTE:  Power SmartSense Feature BEG-->
            if (mBatteryStatsListener != null) {
                mBatteryStatsListener.noteProcessStart(name, uid);
            }
            // <-- NOTE: Power SmartSense Feature END
        }
    }
    ...
    // NOTE:  Power SmartSense Feature BEG-->
    /**
     * when process restart, noteProcessFinish() isn't triggered,i
     * so define this interface.
     */
    void noteProcessFinishVendor(String name, int uid) {
        synchronized (mStats) {
            if (mBatteryStatsListener != null) {
                mBatteryStatsListener.noteProcessFinish(name, uid);
            }
        }
    }
    // <-- NOTE: Power SmartSense Feature END
    ...
    public void noteStartSensor(int uid, int sensor) {
        ...
        // NOTE:  Power SmartSense Feature BEG-->
        if (mBatteryStatsListener != null)
            mBatteryStatsListener.noteStartSensor(uid, sensor);
        // <-- NOTE: Power SmartSense Feature END
    }
    ...
    public void noteStopSensor(int uid, int sensor) {
        ...
        // NOTE:  Power SmartSense Feature BEG-->
        if (mBatteryStatsListener != null)
            mBatteryStatsListener.noteStopSensor(uid, sensor);
        // <-- NOTE: Power SmartSense Feature END
    }
    ...
    public void noteVibratorOn(int uid, long durationMillis) {
        ...
        // NOTE:  Power SmartSense Feature BEG-->
        if (mBatteryStatsListener != null)
            mBatteryStatsListener.noteVibratorOn(uid, durationMillis);
        // <-- NOTE: Power SmartSense Feature END
    }
    ...
    public void noteVibratorOff(int uid) {
        ...
        // NOTE:  Power SmartSense Feature BEG-->
        if (mBatteryStatsListener != null)
            mBatteryStatsListener.noteVibratorOff(uid);
        // <-- NOTE: Power SmartSense Feature END
    }
    ...
    public void noteGpsChanged(WorkSource oldWs, WorkSource newWs) {
        ...
        // NOTE:  Power SmartSense Feature BEG-->
        if (mBatteryStatsListener != null)
            mBatteryStatsListener.noteGpsChanged(oldWs, newWs);
        // <-- NOTE: Power SmartSense Feature END
    }
    ...
    public void notePhoneOn() {
        ...
        // NOTE:  Power SmartSense Feature BEG-->
        if (mBatteryStatsListener != null)
            mBatteryStatsListener.notePhoneOn();
        // <-- NOTE: Power SmartSense Feature END
    }
    ...
    public void notePhoneOff() {
        ...
        // NOTE:  Power SmartSense Feature BEG-->
        if (mBatteryStatsListener != null)
            mBatteryStatsListener.notePhoneOff();
        // <-- NOTE: Power SmartSense Feature END
    }
    ...
    public void noteStartAudio(int uid) {
        ...
        // NOTE:  Power SmartSense Feature BEG-->
        if (mBatteryStatsListener != null)
            mBatteryStatsListener.noteStartAudio(uid);
        // <-- NOTE: Power SmartSense Feature END
    }
    ...
    public void noteStopAudio(int uid) {
        ...
        // NOTE:  Power SmartSense Feature BEG-->
        if (mBatteryStatsListener != null)
            mBatteryStatsListener.noteStopAudio(uid);
        // <-- NOTE: Power SmartSense Feature END
    }
    ...
    public void noteStartVideo(int uid) {
        ...
        // NOTE:  Power SmartSense Feature BEG-->
        if (mBatteryStatsListener != null)
            mBatteryStatsListener.noteStartVideo(uid);
        // <-- NOTE: Power SmartSense Feature END
    }
    ...
    public void noteStopVideo(int uid) {
        ...
        // NOTE:  Power SmartSense Feature BEG-->
        if (mBatteryStatsListener != null)
            mBatteryStatsListener.noteStopVideo(uid);
        // <-- NOTE: Power SmartSense Feature END
    }
    ...
    public void noteResetAudio() {
        ...
        // NOTE:  Power SmartSense Feature BEG-->
        if (mBatteryStatsListener != null)
            mBatteryStatsListener.noteResetAudio();
        // <-- NOTE: Power SmartSense Feature END
    }
    ...
    public void noteResetVideo() {
        ...
        // NOTE:  Power SmartSense Feature BEG-->
        if (mBatteryStatsListener != null)
            mBatteryStatsListener.noteResetVideo();
        // <-- NOTE: Power SmartSense Feature END
    }
    ...
    public void noteFlashlightOn(int uid) {
        ...
        // NOTE:  Power SmartSense Feature BEG-->
        if (mBatteryStatsListener != null)
            mBatteryStatsListener.noteFlashlightOn(uid);
        // <-- NOTE: Power SmartSense Feature END
    }
    ...
    public void noteFlashlightOff(int uid) {
        ...
        // NOTE:  Power SmartSense Feature BEG-->
        if (mBatteryStatsListener != null)
            mBatteryStatsListener.noteFlashlightOff(uid);
        // <-- NOTE: Power SmartSense Feature END
    }
    ...
    public void noteStartCamera(int uid) {
        ...
        // NOTE:  Power SmartSense Feature BEG-->
        if (mBatteryStatsListener != null)
            mBatteryStatsListener.noteStartCamera(uid);
        // <-- NOTE: Power SmartSense Feature END
    }
    ...
    public void noteStopCamera(int uid) {
        ...
        // NOTE:  Power SmartSense Feature BEG-->
        if (mBatteryStatsListener != null)
            mBatteryStatsListener.noteStopCamera(uid);
        // <-- NOTE: Power SmartSense Feature END
    }
    ...
    public void noteResetCamera() {
        ...
        // NOTE:  Power SmartSense Feature BEG-->
        if (mBatteryStatsListener != null)
            mBatteryStatsListener.noteResetCamera();
        // <-- NOTE: Power SmartSense Feature END
    }
    ...
    public void noteResetFlashlight() {
        ...
        // NOTE:  Power SmartSense Feature BEG-->
        if (mBatteryStatsListener != null)
            mBatteryStatsListener.noteResetFlashlight();
        // <-- NOTE: Power SmartSense Feature END
    }
