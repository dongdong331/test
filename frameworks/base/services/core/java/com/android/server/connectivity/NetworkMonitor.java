...
public class NetworkMonitor extends StateMachine {
    ...
    private static final String FALLBACK_URL_CHINA = "http://developers.google.cn/generate_204";
    ...
    private class EvaluatingState extends State {
        ...
        public void enter() {
            ...
            validationLog("enter EvaluatingState");
            ...
            switch (message.what) {
                case CMD_REEVALUATE:
                    if (message.arg1 != mReevaluateToken || mUserDoesNotWant) {
                        validationLog("EvaluatingState: receive CMD_REEVALUATE,mUserDoesNotWant = " + mUserDoesNotWant + ", just return");
                        return HANDLED;
                    }
                    ...
                    if (probeResult.isSuccessful()) {
                        ...
                        log("transit to CaptivePortalState");
    ...
    private class CaptivePortalState extends State {
        ...
        public void enter() {
            ...
            log("send EVENT_PROVISIONING_NOTIFICATION to show sign in notification");
    ...
    protected CaptivePortalProbeResult isCaptivePortal() {
        ...
        validationLog("isCaptivePortal: proxyInfo = " + proxyInfo);
    ...
    private CaptivePortalProbeResult sendDnsAndHttpProbes(ProxyInfo proxy, URL url, int probeType) {
        ...
        //use cn server for fallback
        if (result.isFailed()) {
            validationLog("default URL failed, fallback to cn URL");
            URL fallbackUrl = makeURL(FALLBACK_URL_CHINA);
            if (fallbackUrl != null) {
    ...
    protected CaptivePortalProbeResult sendHttpProbe(URL url, int probeType,
        ...
        try {
            ...
            //getInputStream can throw FileNotFoundException
            ...
            if (contentType == null) {
                ...
                if (httpResponseCode == 200 && line == null) {
                    validationLog("content is null, set response code to 204 ");
                    httpResponseCode = 204;
                } else if (httpResponseCode == 200 && line.contains("Success")) {
                    validationLog("content contains SUCESS,set response code to 204");
                    httpResponseCode = 204;
                }  else if (httpResponseCode == 200
                        && mNetworkAgentInfo.networkInfo.getType() == ConnectivityManager.TYPE_MOBILE) {
                    validationLog("mobile network, 200 is OK");
                    httpResponseCode = 204;
                }
            }
