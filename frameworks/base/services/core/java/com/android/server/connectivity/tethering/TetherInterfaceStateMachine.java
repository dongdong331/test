...
public class TetherInterfaceStateMachine extends StateMachine {
    ...
    protected static final String IPV6_SPRD_SYSPROP_KEY = "net.tethering.ipv6.sprd";
    private static MockableSystemProperties mSystemProperties;

    public static boolean isTetherIpv6SprdDesigned() {
        if (mSystemProperties == null) {
            mSystemProperties = new MockableSystemProperties();
        }
        return mSystemProperties.getBoolean(IPV6_SPRD_SYSPROP_KEY, true);
    }
    ...
    class TetheredState extends BaseServingState {
        ...
        public void enter() {
            ...
            if(mInterfaceType == ConnectivityManager.TETHERING_USB) {
                SystemProperties.set("vendor.sys.ril.internet_tethering", "1");
            }
        }
        ...
        public void exit() {
            cleanupUpstream();
            super.exit();
            // SPRD: set sys.ril.internet_tethering prop when USB internet disconnected
            if(mInterfaceType == ConnectivityManager.TETHERING_USB) {
                SystemProperties.set("vendor.sys.ril.internet_tethering", "0");
            }
        }
