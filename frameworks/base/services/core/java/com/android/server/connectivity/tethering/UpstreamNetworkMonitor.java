...
public class UpstreamNetworkMonitor {
    ...
    public void updateNetworkDisconnected(Network network) {

        Iterable<NetworkState> netStates = mNetworkMap.values();
 
        if (mNetworkMap.containsKey(network)) {
            Log.d(TAG, "succeed in removing network " + network);
    ...
    public NetworkState selectPreferredUpstreamType(Iterable<Integer> preferredTypes) {
        ...
        mLog.i("preferred upstream type: " + getNetworkTypeName(typeStatePair.type));
