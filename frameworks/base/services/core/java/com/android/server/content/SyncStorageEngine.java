...
public class SyncStorageEngine {
    ...
    private static final boolean DELETE_BAD_FILE = true;
    ...
    public static class EndPoint {
        ...
        public String toString() {
            ...
            if (DEBUG) {
                sb.append(account == null ? "ALL ACCS" : account.name).append("/");
            }
            sb.append(provider == null ? "ALL PDRS" : provider);
            sb.append(":u" + userId);
            return sb.toString();
        }
    }
    ...
    private void readStatusLocked() {
        ...
        try {
            ...
            if (DELETE_BAD_FILE) {
                ...
                throw new RuntimeException("status.bin is corrupt", ex);
            }
        }
    }
