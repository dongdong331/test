...
public final class DisplayManagerService extends SystemService {
    ...
    static final int MSG_DISPLAY_CONFIG_CHANGE = 10;  //SPRD: For SR
    ...
    private SprdColorModeController mSprdColorModeController;
    ...
    DisplayManagerService(Context context, Injector injector) {
        ...
        if (SystemProperties.getBoolean("ro.sprd.displayenhance", false)) {
            mSprdColorModeController = new SprdColorModeController(context);
        }
    }
    ...
    public void onSwitchUser(@UserIdInt int newUserId) {
        ...
        if(mSprdColorModeController != null) {
             mSprdColorModeController.switchUserConfig(newUserId);
        }
    }
    ...
    public void windowManagerAndInputReady() {
        synchronized (mSyncRoot) {
            ...
            registerLocalDisplayObserver();
        }
    }

    private void registerLocalDisplayObserver() {  //SPRD: For SR
        DisplayDevice device = mDisplayDevices.get(SurfaceControl.BUILT_IN_DISPLAY_ID_MAIN);
        if (device != null) {
            device.registerDisplayContentObserver();
        }
    }
    ...
    public void systemReady(boolean safeMode, boolean onlyCore) {
        ...
        mHandler.sendEmptyMessage(MSG_REGISTER_BRIGHTNESS_TRACKER);
         if (mSprdColorModeController != null) {
            mSprdColorModeController.systemReady();
            mSprdColorModeController.startUserConfig(mCurrentUserId);
        }
    }
    ...
    private final class DisplayManagerHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_DISPLAY_CONFIG_CHANGE:   // SPRD: for SR
                    mWindowManagerInternal.setForcedDisplaySizeDensity(
    ...
    private final class LocalService extends DisplayManagerInternal {
        ...
        public void updateBatteryLevel(int level) {
            if (mDisplayPowerController != null)
                mDisplayPowerController.updateBatteryLevel(level);
        }

        @Override
        public void setSunLightProtectOn(boolean on) {
            if (mDisplayPowerController != null)
                mDisplayPowerController.setSunLightProtectOn(on);
        }

        @Override
        public void setSunLightProtectTemporayDisabled(boolean disabled) {
            if (mDisplayPowerController != null)
                mDisplayPowerController.setSunLightProtectTemporayDisabled(disabled);
        }
        // <-- NOTE: PQ Feature END
    }
