...
public interface JobSchedulerInternal {
    ...
    /**
     * set job constraint require: job for app with 'uid' and 'jobId' need satified constraint: app already started
     * input param: required: true, require this constraint.
     *              false, do not require this constraint.
     * Note: Used in TimeController.
     *         When App is constraint for auto started, the sync job for this app will not need to
     *         set corresponding wakeup alarm which will cost more power.
     */
    boolean setJobAppStartedConstraintRequired(int uid, int jobId, boolean required);
