...
public class LightsService extends SystemService {
    ...
    private SprdLightsUtils mSprdLightsUtils;
    ...
    private final class LightImpl extends Light {
        ...
        private void setLightLocked(int color, int mode, int onMS, int offMS, int brightnessMode) {
            ...
            if (!mInitialized || color != mColor || mode != mMode || onMS != mOnMS ||
                ...
                //Note: Bug692787 BatteryLed has higher priority than NotificationLed -->BEGIN
                if (!mSprdLightsUtils.isBatteryOpenWhenNotificationCome(mId, color)) {
                //Note: Bug692787 BatteryLed has higher priority than NotificationLed --END
                    try {
    ...
    public LightsService(Context context) {
        ...
        mSprdLightsUtils = new SprdLightsUtils();
    }
