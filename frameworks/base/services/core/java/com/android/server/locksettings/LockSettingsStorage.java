...
class LockSettingsStorage {
    ...
    private static final boolean DEBUG = SystemProperties.getBoolean("persist.sys.lock.debug", false);
    ...
    private static final String LOCK_PASSWORD_FILE_FOR_KEY = "sprd.lock.";
    private static final String LOCK_PASSWORD_KEY_NAME = ".key";
    ...
    @VisibleForTesting
    String getFileNameForKey(String key, int userId) {
        return getLockCredentialFilePathForUser(userId, LOCK_PASSWORD_FILE_FOR_KEY + key + LOCK_PASSWORD_KEY_NAME);
    }
