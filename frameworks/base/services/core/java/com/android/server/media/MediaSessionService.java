    ...
    class SessionManagerImpl extends ISessionManager.Stub {
        ...
        private void dispatchAdjustVolumeLocked(String packageName, int pid, int uid,
            ...
            if (session == null || preferSuggestedStream) {
                ...
                Log.d(TAG, "dispatchAdjustVolumeLocked asSystemService= "+asSystemService+" pkg= "+
			getContext().getOpPackageName()+" uid= "+Process.SYSTEM_UID+" pid = "+pid);
                if(asSystemService){
                    session.adjustVolume(getContext().getOpPackageName(), pid, Process.SYSTEM_UID, null, asSystemService,
