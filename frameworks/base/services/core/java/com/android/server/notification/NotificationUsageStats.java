...
public class NotificationUsageStats {
    ...
    private static class SQLiteLog {
        ...
        private void writeEvent(long eventTimeMs, int eventType, NotificationRecord r) {
            ...
            // SPRD:bug 843837, catch the IllegalStateException to avoid malformed database
            // file make system restart.
            try {
                ...
                Slog.w(TAG, "writeEvent, catch IllegalStateException to avoid "
                                + "system crash ", e);
            }
        }
