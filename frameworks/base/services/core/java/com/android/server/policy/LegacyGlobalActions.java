...
class LegacyGlobalActions implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener  {
    ...
    //SPRD: fix for bug 940751
    private static final int SHOW_DIALOG_DELAY = 100;
    ...
    public void showDialog(boolean keyguardShowing, boolean isDeviceProvisioned) {
        ...
        if (mDialog != null) {
            ...
            //SPRD: fix for bug 940751
            mHandler.sendEmptyMessageDelayed(MESSAGE_SHOW, SHOW_DIALOG_DELAY);
        } else {
            handleShow();
        }
    }
    ...
    /**
     * Add for bug 971773
     * dismissDialog if Dialog is not null
     */
    public void dismissDialog() {
        if (mDialog != null && mHandler != null) {
