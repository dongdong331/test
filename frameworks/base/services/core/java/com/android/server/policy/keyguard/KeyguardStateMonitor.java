...
public class KeyguardStateMonitor extends IKeyguardStateCallback.Stub {
    ...
    private volatile boolean mSubsidySecure = false;
    ...
    public boolean isSecure(int userId) {
        return mLockPatternUtils.isSecure(userId) || mSimSecure || mSubsidySecure;
    }
    ...
    @Override // Binder interface
    public void onSubsidySecureStateChanged(boolean subsidySecure) {
        mSubsidySecure = subsidySecure;
    }
    ...
    public void dump(String prefix, PrintWriter pw) {
        ...
        pw.println(prefix + "mSubsidySecure=" + mSubsidySecure);
    }
}
