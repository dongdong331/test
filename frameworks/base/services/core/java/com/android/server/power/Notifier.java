...
final class Notifier {
    ...
    //Bug 624590 send wakelock info to AMS start
    private int OPT_ADD = 0;
    private int OPT_RELEASE = 1;
    //Bug 624590 end

    //Bug 951531 Charging tone is invalid.
    ...
    public void onWakeLockAcquired(int flags, String tag, String packageName,
        ...
        //Bug 624590 send wakelock info to AMS start
        PMSFactory.getInstance().createPowerManagerServiceUtils(mContext).updateWakeLockStatusLocked(OPT_ADD, ownerUid, flags, workSource);
        //Bug 624590 end
    ...
    public void onWakeLockChanging(int flags, String tag, String packageName,
        ...
        if (workSource != null && newWorkSource != null
            ...
            //Bug 624590 send wakelock info to AMS start
            PMSFactory.getInstance().createPowerManagerServiceUtils(mContext).updateWakeLockStatusLockedChanging(flags, workSource, newWorkSource);
            //Bug 624590 end
    ...
    public void onWakeLockReleased(int flags, String tag, String packageName,
        ...
        //Bug 624590 send wakelock info to AMS start
        PMSFactory.getInstance().createPowerManagerServiceUtils(mContext).updateWakeLockStatusLocked(OPT_RELEASE, ownerUid, flags, workSource);
        //Bug 624590 end
