...
public class BatterySaverStateMachine {
    ...
    private void doAutoBatterySaverLocked() {
        ...
        if (mIsPowered && !PowerManagerEx.isPowerControllerEnabled()) {
            ...
            if (!mBatterySaverSnoozing && isAutoBatterySaverConfigured() && !PowerManagerEx.isPowerControllerEnabled()) {
    ...
    private void enableBatterySaverLocked(boolean enable, boolean manual, int intReason,
        ...
        if (enable && mIsPowered && !PowerManagerEx.isPowerControllerEnabled()) {
