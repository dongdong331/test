...
public class SprdNatTimeUtils {
    ...
    SprdNatTimeUtils(Context context) {
        ...
        mConfigManager = (CarrierConfigManager) context.getSystemService("carrier_config");
    ...
    public int getNatOvertimeByNetClass(int networkClass, int subId) {
        ...
        switch (networkClass) {
            case TelephonyManager.NETWORK_CLASS_2_G:
                return persistableBundle.getInt(CarrierConfigManagerEx.KEY_NETWORK_NAT_OVERTIME_2G);
            case TelephonyManager.NETWORK_CLASS_3_G:
                return persistableBundle.getInt(CarrierConfigManagerEx.KEY_NETWORK_NAT_OVERTIME_3G);
            case TelephonyManager.NETWORK_CLASS_4_G:
                return persistableBundle.getInt(CarrierConfigManagerEx.KEY_NETWORK_NAT_OVERTIME_4G);
            default:
