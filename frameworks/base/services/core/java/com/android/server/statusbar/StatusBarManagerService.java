...
public class StatusBarManagerService extends IStatusBarService.Stub {
    ...
    private static final boolean SHUTDOWN_CONFIRM = true;
    /*@}*/
    ...
    public void shutdown() {
        ...
        try {
            ...
            //UNISOC bug 908642,add confirm dialog.
            mHandler.post(() ->
                    ShutdownThread.shutdown(getUiContext(),
                        PowerManager.SHUTDOWN_USER_REQUESTED, /*false*/SHUTDOWN_CONFIRM));
        } finally {
            Binder.restoreCallingIdentity(identity);
        }
    }
    ...
    public void reboot(boolean safeMode) {
        ...
        try {
            mHandler.post(() -> {
                ...
                if (safeMode) {
                    //UNISOC bug 908642,add confirm dialog.
                    ShutdownThread.rebootSafeMode(getUiContext(), /*false*/SHUTDOWN_CONFIRM);
                } else {
                    //UNISOC bug 908642,add confirm dialog.
