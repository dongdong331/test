...
class AlertWindowNotification {
    ...
    /** SPRD: when locale changed, update notification  */
    void update() {
        // We can't call into NotificationManager with WM lock held since it might call into AM.
        // So, we post a message to do it later.
        mService.mH.post(this::onUpdateNotification);
    }
    ...
    private void onCancelNotification(boolean deleteChannel) {
        ...
        mService.mContext.unregisterReceiver(mReceiver);
    }
    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(Intent.ACTION_LOCALE_CHANGED) && mPosted) {
                Slog.i("AlertWindowNotification", "language changed, package = " + mPackageName);
                update();
            }
        }
    };
