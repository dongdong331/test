...
import android.app.ActivityOptionsHelper;
...
public class AppTransition implements Dump {
    ...
    private ActivityOptionsHelper.AnimationHelper mNextAnimationHelper;//Bug 661753 add for animation
    ...
    void clear() {
        ...
        mNextAnimationHelper =
                ActivityOptionsHelper.AnimationHelper.ensureHelper(mNextAnimationHelper);
        mNextAnimationHelper.clear();
        //Bug 661753 add for animation
    }
    ...
    Animation loadAnimation(LayoutParams lp, int transit, boolean enter, int uiMode,
        ...
        DisplayInfo displayInfo = (displayContent != null) ? displayContent.getDisplayInfo() : null;
        ...
        } else if (mNextAnimationHelper != null
                && mNextAnimationHelper.shouldOverrideAnimation()
                && mNextAnimationHelper.getNextTransitionType() == mNextAppTransitionType) {
            ActivityOptionsHelper.AnimationParameters params = new ActivityOptionsHelper.AnimationParameters();
            getDefaultNextAppTransitionStartRect(mTmpRect);
            params.nextAppTransitionStartWidth = mTmpRect.width();
            params.nextAppTransitionStartHeight = mTmpRect.height();
            params.decelerateInterpolator = mDecelerateInterpolator;
            params.linearOutSlowInInterpolator = mLinearOutSlowInInterpolator;
            params.nextAppTransitionStartX = mTmpRect.left;
            params.nextAppTransitionStartY = mTmpRect.top;
            a = ActivityOptionsHelper.AnimationHelper.createOverrideAnimation(
                    mNextAnimationHelper, transit, enter, displayInfo.appWidth, displayInfo.appHeight, params);//Bug 661753 add for animation
    ...
    void overridePendingAppTransition(String packageName, int enterAnim, int exitAnim,
        ...
        if (canOverridePendingAppTransition()) {
            ...
            mNextAnimationHelper = ActivityOptionsHelper.AnimationHelper.ensureHelper(
                    ActivityOptionsHelper.getAnimationHelper());
            mNextAnimationHelper.setNextTransitionType(mNextAppTransitionType);//Bug 661753 add for animation
        }
    }
    ...
    public void dump(PrintWriter pw, String prefix) {
        ...
        if (mNextAnimationHelper != null
                && mNextAnimationHelper.shouldOverrideAnimation()
                && mNextAnimationHelper.getNextTransitionType() == mNextAppTransitionType) {
            pw.print(prefix); pw.print("mNextAnimationHelper overrideAnimationType=");
                    pw.println(mNextAnimationHelper.getOverrideAnimationType());
        }//Bug 661753 add for animation
        switch (mNextAppTransitionType) {
            case NEXT_TRANSIT_TYPE_CUSTOM:
