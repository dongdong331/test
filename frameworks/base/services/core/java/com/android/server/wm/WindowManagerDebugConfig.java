...
public class WindowManagerDebugConfig {
    ...
    static boolean TAG_WITH_CLASS_NAME = false;
    ...
    static boolean DEBUG_RECENTS_ANIMATIONS = false;
    static boolean DEBUG_REMOTE_ANIMATIONS = DEBUG_APP_TRANSITIONS || false;
