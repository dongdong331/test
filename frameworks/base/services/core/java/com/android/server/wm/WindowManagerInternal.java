...
public abstract class WindowManagerInternal {
    ...
    */
    ...
    public abstract void setLayoutNeeded(); // SPRD: add for dynamic navigationbar


    // SPRD: add for scene recognize
    /**
     *@param windowName window's name
     *@param bounds the window's visible bounds
     *
     *@return if return true, the given's window is visible, othervise, the bounds is meaningless
     */
    public abstract boolean getWindowVisibleBounds(String windowName, Rect bounds);

    /**
     *@param windowName window's name
     *@param bounds the window's visible bounds
     *@param size the size of bounds
     *
     *@return return the number of visible bounds
     */
    public abstract int getWindowVisibleBounds(String windowName, Rect[] bounds, int size);

    public abstract void setForcedDisplaySizeDensity(int width, int height, int density); // For SR
}
