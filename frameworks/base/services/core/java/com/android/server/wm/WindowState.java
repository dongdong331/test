...
class WindowState extends WindowContainer<WindowState> implements WindowManagerPolicy.WindowState {
    ...
    /**
     *When the window call setVisibility false, this window should not revice input event anymore,
     * so we should pass isActivityVisibleLw to inputflinger instead of isVisibleLw
     */
    boolean isActivityVisibleLw() {
        return (mAppToken == null || !mAppToken.hiddenRequested) && isVisible();
    }
    ...
    void removeIfPossible() {
        ...
        removeIfPossible(false /*keepVisibleDeadWindow*/, false);
    }

    private void removeIfPossible(boolean keepVisibleDeadWindow, boolean isRemove) {
        mWindowRemovalAllowed = true;
        ...
        try {
            ...
            if (mHasSurface && mToken.okToAnimate()) {
                ...
                boolean isRemoveExitAnim = mAnimatingExit && mHasSurface && mWinAnimator.getShown()
                        && isRemove;

                if (keepVisibleDeadWindow && !isRemoveExitAnim) {
                    if (DEBUG_ADD_REMOVE) Slog.v(TAG_WM,
                ...
                if (wasVisible || isRemoveExitAnim) {
                ...
                if (mWinAnimator.getShown() && mAnimatingExit
                        && (!lastWindowIsStartingWindow || isAnimating) && !mExitAnimNull) {
            ...
            try {
                ...
                synchronized(mService.mWindowMap) {
                    ...
                    if (win != null) {
                        ...
                        win.removeIfPossible(shouldKeepVisibleDeadAppWindow(), true);
    ...
    void onExitAnimationDone() {
        ...
        if(mAppToken != null && mAppToken.sendingToBottom) {
            mAppToken.sendingToBottom = false;
        }
