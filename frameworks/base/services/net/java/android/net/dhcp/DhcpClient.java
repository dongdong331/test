...
public class DhcpClient extends StateMachine {
    ...
    private DhcpClient(Context context, StateMachine controller, String iface) {
        ...
        if (HOSTNAME == "") {
            ...
            if (id != null && id.length() > 0) {
                  if (DBG) Log.d(TAG, "get ANDROID_ID as hostname");
    ...
    private String getHostname() {
        ...
        if (TextUtils.isEmpty(hostName)) {
            if (DBG) Log.d(TAG, "getHostname: net.hostname is empty");
            hostName = "";
        }
        return hostName;
    }
    ...
    private boolean initInterface() {
        ...
        mInterfaceBroadcastAddr = new PacketSocketAddress((short) ETH_P_IP,mIface.index,
                    (short)0, (byte)0, DhcpPacket.ETHER_BROADCAST);
        return true;
    }
    ...
    class DhcpState extends State {
        ...
        public void exit() {
            ...
            clearDhcpState();
            Log.d(TAG, "Stop dhcp6c_wifi service on interface " + mIfaceName);
            SystemProperties.set("ctl.stop", "dhcp6c_wifi");
        }
    ...
    class DhcpBoundState extends LoggingState {
        ...
        public void enter() {
            ...
            if (mDhcpLease.serverAddress != null && !connectUdpSock(mDhcpLease.serverAddress)) {
                ...
                Log.d(TAG, "Configured IP address " + mDhcpLease.ipAddress);
                ...
                try {
                    ...
                    fout.close();
                    Log.d(TAG, "start dhcp6c_wifi service on interface " + mIfaceName);
                    SystemProperties.set("ctl.start", "dhcp6c_wifi");
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
