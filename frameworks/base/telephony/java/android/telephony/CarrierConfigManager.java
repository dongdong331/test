...
public class CarrierConfigManager {
    ...
    */
    ...
    //UNISOC: add for BUG 1051956
    /**
     * Boolean to decide whether to enable  carrier video calling setting
     * @hide
     */
    public static final String KEY_CARRIER_VIDEO_CALLING_SETTING_ENABLED = "carrier_video_calling_setting_enabled";
    /**
   ...
   /**
    ...
    public static final String KEY_SMS_ENCODING_CHANGE_ENABLE_BOOL = "smsEncodingChangeable";

    public static final String KEY_SMS_USE_SIMPLE_CHARACTERS_ONLY_BOOL = "smsUsesSimpleCharactersOnly";

    /** {@hide} */
    public static final String KEY_VOLTE_ICON_SHOW = "show_volte_icon";
    ...
    static {
        ...
        sDefaults.putBoolean(KEY_SMS_ENCODING_CHANGE_ENABLE_BOOL, true);
        sDefaults.putBoolean(KEY_SMS_USE_SIMPLE_CHARACTERS_ONLY_BOOL, false);
        ...
        //UNISOC: add for BUG 1051956
        sDefaults.putBoolean(KEY_CARRIER_VIDEO_CALLING_SETTING_ENABLED, true);
        ...
        sDefaults.putBoolean(KEY_VOLTE_ICON_SHOW, true);
        ...
        sDefaults.putBoolean(KEY_HSPAP_SHOW_4G, false);
        sDefaults.putAll(CarrierConfigManagerEx.getDefaultConfig());
    }
