...
public abstract class DmykAbsTelephonyManager {
    ...
    public static DmykAbsTelephonyManager getDefault(Context context) {
        synchronized (DmykAbsTelephonyManager.class) {
            if (mInstance == null) {
                mInstance = new com.dmyk.android.telephony.DmykTelephonyManager(context);
            } else {
    ...
    /** switch state: switch state off*/
    public static final int SWITCH_STATE_OFF = 0;
    /** switch state: switch state unknown*/
    ...
    public static final int SWITCH_FLASH_LIGHT = 8;
    ...
    /**Broadcast action: when connectivity changed */
    ...
    public abstract int getSubId (int phoneId);
    ...
    public abstract void setVolteState(int phoneId, int volte);

    public abstract boolean isDMSet();

    public abstract int queryLteCtccSimType (int phoneId);
