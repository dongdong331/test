    ...
    public static ArrayList<String> fragmentText(String text) {
       ...
       /* int encoding = SmsConstants.ENCODING_UNKNOWN;
        ...
        TextEncodingDetails ted = (useCdmaFormatForMoSms()) ?
            ...
            com.android.internal.telephony.gsm.SmsMessage.calculateLength(text, GsmAlphabetEx.isUse7bitOnly());// use7bitOnly);
        ...
        Rlog.d(LOG_TAG, "fragmentText ted.codeUnitSize= " + ted.codeUnitSize);
        if((ted.codeUnitSize == SmsConstants.ENCODING_7BIT) && r.getBoolean(com.android.internal.R.bool.config_sms_force_7bit_encoding)) {
