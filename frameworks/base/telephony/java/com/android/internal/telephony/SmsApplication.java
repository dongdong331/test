...
public final class SmsApplication {
    ...
    private static final String MMS_FOLDER_VIEW_PACKAGE_NAME = "com.android.mmsfolderview";
    private static final String PRELOAD_PACKAGE_NAME = "com.sprd.preload";/*Bug 846425 */
    // bug 478514: Add for MmsFolderView Feature -- End
    private static final String SCHEME_SMS = "sms";
    private static final String SCHEME_SMSTO = "smsto";
    private static final String SCHEME_MMS = "mms";
    private static final String SCHEME_MMSTO = "mmsto";
    private static final boolean DEBUG_MULTIUSER = true;
    ...
    private static SmsApplicationData getApplication(Context context, boolean updateIfNeeded,
        ...
        if (applicationData != null) {
            ...
            if (updateIfNeeded) {
               ...
               // bug 478514: Add for MmsFolderView Feature -- Begin
                assignWriteSmsPermissionToSystemApp(context, packageManager, appOps,
                        MMS_FOLDER_VIEW_PACKAGE_NAME);
                // bug 478514: Add for MmsFolderView Feature -- End
                assignWriteSmsPermissionToSystemApp(context, packageManager, appOps,
                        PRELOAD_PACKAGE_NAME);/*Bug 846425 */
            }
        }
        if (DEBUG_MULTIUSER) {
    ...
    public static ComponentName getDefaultRespondViaMessageApplication(Context context,
        ...
        try {
            ...
            if (smsApplicationData != null) {
Log.w(LOG_TAG,"getDefaultRespondViaMessageApplication"+smsApplicationData.mPackageName);
Log.w(LOG_TAG,"getDefaultRespondViaMessageApplication"+smsApplicationData.mRespondViaMessageClass);
                component = new ComponentName(smsApplicationData.mPackageName,
                        smsApplicationData.mRespondViaMessageClass);
            }
Log.w(LOG_TAG,"getDefaultRespondViaMessageApplication-component"+component);
    ...
    public static boolean isDefaultSmsApplication(Context context, String packageName) {
        ...
        if ((defaultSmsPackage != null && defaultSmsPackage.equals(packageName))
                ...
                // bug 478514: Add for MmsFolderView Feature -- Begin
                || MMS_FOLDER_VIEW_PACKAGE_NAME.equals(packageName)
                // bug 478514: Add for MmsFolderView Feature -- End
                ) {
            return true;
        }
