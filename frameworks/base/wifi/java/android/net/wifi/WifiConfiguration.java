...
public class WifiConfiguration implements Parcelable {
    ...
    */
    ...
    /**
     * The WAPI PSK Key mask.
     * refer to ISupplicantStaNetwork.KeyMgmtMask and def.h
     * @hide
     */
    public static class KeyMgmtMask {
        private KeyMgmtMask() { }
        /** WAPI pre-shared key (requires {@code preSharedKey} to be specified). {@hide}*/
        public static final int WAPI_PSK = 1 << 12;
        /** WAPI certificate to be specified. {@hide} */
        public static final int WAPI_CERT = 1 << 13;
    }
    //<-- Porting WAPI feature END

    //NOTE: Bug #692695 Add sim slot selection support for eap-sim and eap-aka BEG-->
    /**
     * SPRD: add sim_num for EAP-SIM.
     * {@hide}
     */
    ...
    /** SPRD: add auto_join_network for network.
     * {@hide}
     */
    public static final String autoJoinNetwork = "auto_join_network";

    /**
     * SPRD: Add auto_join_network for Specific network.
     * @hide
     */
    public int auto_join_network;
    ...
    public static class KeyMgmt {
        ...
        /** @hide */
        public static final int PSK_SHA256 = 8;
        /** @hide */
        public static final int EAP_SHA256 = 9;
    ...
    */
    ...
    //<-- Add for SoftAp Advance Feature END
     /**
     *Softap group rekeying intervals
     * @hide
     */
    public int groupReKeyInterval = 0;
    /**
    ...
    public String configKey(boolean allowCached) {
        ...
        if (allowCached && mCachedConfigKey != null) {
            ...
            //<-- Add for wifi Advance Feature END
            } else if (wepTxKeyIndex >=0 && wepKeys[wepTxKeyIndex] != null) {
                key = SSID + "WEP";
            } else {
    ...
    public WifiConfiguration(WifiConfiguration source) {
        if (source != null) {
            ...
            macAddrAcl = source.macAddrAcl;
            //<-- Add for SoftAp Advance Feature END
            //Add for softap 5G channel BEG-->
            groupReKeyInterval = source.groupReKeyInterval;
            //<-- Add for softap 5G channel END
            wepKeys = new String[4];
            for (int i = 0; i < wepKeys.length; i++) {
            ...
            //<-- Add sim slot selection support for eap-sim and eap-aka END
            auto_join_network = source.auto_join_network;
        }
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(macAddrAcl);
        //<-- Add for SoftAp Advance Feature END
         //Add for softap 5G channel BEG-->
        dest.writeInt(groupReKeyInterval);
        //<-- Add for softap 5G channel END
        ...
        //<-- Add sim slot selection support for eap-sim and eap-aka END
        dest.writeInt(auto_join_network);
    }
        ...
        new Creator<WifiConfiguration>() {
            public WifiConfiguration createFromParcel(Parcel in) {
                ...
                //<-- Add for SoftAp Advance Feature
                 //Add for softap 5G channel BEG-->
                config.groupReKeyInterval = in.readInt();
                //<--Add for softap 5G channel END
                ...
                //<-- Add sim slot selection support for eap-sim and eap-aka END
                config.auto_join_network = in.readInt();
                return config;
            }
