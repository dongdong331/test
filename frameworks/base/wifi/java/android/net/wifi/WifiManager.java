...
public class WifiManager {
 ...
 public boolean softApBlockStation(String mac) {
     try {
         return mService.softApBlockStation(mac,mContext.getOpPackageName());
     } catch (RemoteException e) {
         return false;
     }
}
 ...
 public boolean softApUnblockStation(String mac) {
     try {
         return mService.softApUnblockStation(mac,mContext.getOpPackageName());
     } catch (RemoteException e) {
         return false;
     }
 }
 ...
 public String softApGetConnectedStations() {
     try {
         return mService.softApGetConnectedStations(mContext.getOpPackageName());
     } catch (RemoteException e) {
         return null;
     }
 }
 ...
 public String softApGetBlockedStations() {
     try {
         return mService.softApGetBlockedStations(mContext.getOpPackageName());
     } catch (RemoteException e) {
         return null;
     }
 }
 ...
 public List<String> softApGetConnectedStationsDetail() {
     try {
         return mService.softApGetConnectedStationsDetail(mContext.getOpPackageName());
     } catch (RemoteException e) {
         return null;
     }
 }
 ...
 public List<String> softApGetBlockedStationsDetail() {
     try {
         return mService.softApGetBlockedStationsDetail(mContext.getOpPackageName());
     } catch (RemoteException e) {
         return null;
     }
 }
 ...
 public boolean softApAddClientToWhiteList(String mac, String name) {
     try {
         return mService.softApAddClientToWhiteList(mac, name, mContext.getOpPackageName());
     } catch (RemoteException e) {
         return false;
     }
 }
 ...
 public boolean softApDelClientFromWhiteList(String mac, String name) {
     try {
         return mService.softApDelClientFromWhiteList(mac, name, mContext.getOpPackageName());
     } catch (RemoteException e) {
         return false;
     }
 }
 ...
 public boolean softApSetClientWhiteListEnabled(boolean enabled) {
     try {
         return mService.softApSetClientWhiteListEnabled(enabled,mContext.getOpPackageName());
     } catch (RemoteException e) {
         return false;
     }
 }
 ...
 public List<String> softApGetClientWhiteList() {
     try {
         return mService.softApGetClientWhiteList(mContext.getOpPackageName());
     } catch (RemoteException e) {
         return null;
     }
 }
 ...
 public boolean softApIsWhiteListEnabled() {
     try {
         return mService.softApIsWhiteListEnabled(mContext.getOpPackageName());
     } catch (RemoteException e) {
         return false;
     }
 }
 ...
 //NOTE: Bug #692708 Add for softap support wps connect mode and hidden ssid Feature BEG-->
 /**
 ...
 public void softApStartWps(WpsInfo config, WpsCallback listener) {
     if (config == null) throw new IllegalArgumentException("config cannot be null");
     getChannel().sendMessage(SOFTAP_START_WPS, 0, putListener(listener), config);
 }
 /**
 ...
 public void softApCancelWps(WpsCallback listener) {
     getChannel().sendMessage(SOFTAP_CANCEL_WPS, 0, putListener(listener));
 }
 /**
 ...
 public boolean softApWpsCheckPin(String wpsPin) {
     try {
         return mService.softApWpsCheckPin(wpsPin, mContext.getOpPackageName());
     } catch (RemoteException e) {
         return false;
     }
 }
 ...
 //<-- Add for softap support wps connect mode and hidden ssid Feature END
    ...
    public boolean registerWifiNetworkEventObserver(IWifiNetworkEventObserver observer) {
        try {
            return mService.registerWifiNetworkEventObserver(observer);
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    public boolean unregisterWifiNetworkEventObserver(IWifiNetworkEventObserver observer) {
        try {
            return mService.unregisterWifiNetworkEventObserver(observer);
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    /**
     * if return WifiInfo.INVALID_RSSI, that means this a invalid value, and don't use this value
     * @hide
     */
    public int getCurrentRssi() {
        try {
            return mService.getCurrentRssi();
        } catch (RemoteException e) {
    ...
    /**
     * return true if the current Wifi Network is valid for VoWifi.
     * @hide
     */
    public boolean isNetworkValidForVoWifi() {
        try {
            return mService.isNetworkValidForVoWifi();
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    /**
     * If set true, Wifi Network will notify Connected for VoWifi only when it can access internet.
     * if set false, it will notify connected for VoWifi when it connected to a AP.
     * @hide
     */
    public boolean setCheckingInternetForVoWifi(boolean enabled) {
        try {
            return mService.setCheckingInternetForVoWifi(enabled);
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    /**
     * Called to close wifi.
     * @hide
     */
    public void notifyAndCloseWifi() {
        try {
             mService.notifyAndCloseWifi();
        } catch (RemoteException e) {
        }
    }
