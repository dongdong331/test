...
private:
    ...
    //backup for defer free
    sp<ANativeWindow> mNativeWindowSR;
    sp<DisplaySurface> mDisplaySurfaceSR;
    std::unique_ptr<RE::Surface> mSurfaceSR;
    Vector<RE::Surface *> mDrawedSurfaces;
    int32_t mNewBufferPostCnt = -1;
    int mEnabledSR = 0;
#endif
