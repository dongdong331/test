...
public class ImsManager {
    ...
    public static boolean isEnhanced4gLteModeSettingEnabledByUser(Context context) {
        log("isEnhanced4gLteModeSettingEnabledByUser old interface invoke...");
    ...
    public boolean isEnhanced4gLteModeSettingEnabledByUser() {
        ...
        log("isEnhanced4gLte...  setting = " + setting + " | onByDefault = " + onByDefault);
    ...
    public static void setEnhanced4gLteModeSetting(Context context, boolean enabled) {
        log("setEnhanced4gLteModeSetting old interface invoke...");
        ImsManager mgr = ImsManager.getInstance(context,
                /*SPRD:modify for IMS
                @Orig: SubscriptionManager.getDefaultVoicePhoneId {*/
                SubscriptionManager.getPhoneId(SubscriptionManager.getDefaultDataSubscriptionId()));
    ...
    public void setEnhanced4gLteModeSetting(boolean enabled) {
        ...
        int prevSetting = SubscriptionManager.getIntegerSubscriptionProperty(
                getSubId(), SubscriptionManager.ENHANCED_4G_MODE_ENABLED,
                SUB_PROPERTY_NOT_INITIALIZED, mContext);
        log("setEnhanced4gLte...  enabled = " + enabled + " | prevSetting = " + prevSetting);
    ...
    public boolean isVolteEnabledByPlatform() {
        ...
        return mContext.getResources().getBoolean(
                ...
                && isGbaValid() && SystemProperties.getBoolean("persist.vendor.sys.volte.enable",false);//SPRD: modify by bug712261;
    }
    ...
    public boolean isVtEnabledByPlatform() {
        ...
        return mContext.getResources().getBoolean(
                ...
                isGbaValid() && SystemProperties.getBoolean("persist.sys.support.vt",false);//SPRD: modify for vt switch
    }
    ...
    public boolean isVtEnabledByUser() {
        ...
        boolean onByDefault = getBooleanCarrierConfig(CarrierConfigManager.KEY_CARRIER_VIDEO_CALLING_SETTING_ENABLED);
    ...
    public void updateImsServiceConfig(boolean force) {
        //if (!force) {  // UNISOC: Modify for bug968317
        ...
        if (!mConfigUpdated || force) {
            try {
                ...
                log("updateImsServiceConfig() : primaryCardPhoneId = " + primaryCardPhoneId + " | phoneId = " + mPhoneId);
                // SPRD 940545
                if (primaryCardPhoneId == SubscriptionManager.INVALID_SIM_SLOT_INDEX) {
                    log("updateImsServiceConfig() : primary card is invalid, so don't change IMS state");
                    return;
                }
                ...
                log("updateImsServiceConfig() : isImsUsed = " + isImsUsed);
    ...
    private boolean updateVideoCallFeatureValue() throws ImsException {
        ...
        boolean enabled = isVtEnabledByUser() && isEnhanced4gLteModeSettingEnabledByUser();//SPRD:add enhance 4G condition for bug713900
        boolean isNonTty = isNonTtyOrTtyOnVolteEnabled();
