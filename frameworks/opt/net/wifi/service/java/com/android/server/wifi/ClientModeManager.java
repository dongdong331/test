...
public class ClientModeManager implements ActiveModeManager {
    ...
    ClientModeManager(Context context, @NonNull Looper looper, WifiNative wifiNative,
            ...
            WifiStateMachine wifiStateMachine, VoWifiAssistor voWifiAssistor) {
        mContext = context;
    ...
    public void stop() {
        ...
        if (mVoWifiAssistor.isVoWifiRegistered() && !mVoWifiAssistor.isSoftApStarted()) {
