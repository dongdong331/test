...
public class WifiConfigManager {
    ...
    private void mergeWithInternalWifiConfiguration(
        ...
        if (externalConfig.eap_sim_slot != -1) {
            internalConfig.eap_sim_slot = externalConfig.eap_sim_slot;
        }
        if (externalConfig.auto_join_network != -1) {
            internalConfig.auto_join_network = externalConfig.auto_join_network;
        }
    ...
    */
     ...
     * this network.
     */
    public ScanDetailCache getOrCreateScanDetailCacheForNetwork(WifiConfiguration config) {
