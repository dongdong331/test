...
public class WifiConnectivityManager {
    ...
    private boolean handleScanResults(List<ScanDetail> scanDetails, String listenerName) {
        ...
        if (mSupportCMCC && mWifiFeaturesUtils.isAutoConnect() == false) {
        ...
        if (!WifiFeaturesUtils.FeatureProperty.SUPPORT_SPRD_WIFI_COEXIST_P2P && WifiP2pServiceImpl.mP2pConnectingOrConnected) {
