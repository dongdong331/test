...
public class WifiInjector {
    ...
    private final WifiSoftapMonitor mWifiSoftapMonitor;
    ...
    public WifiInjector(Context context) {
        ...
        mWifiSoftapMonitor = new WifiSoftapMonitor(this);
        mHostapdHal = new HostapdHal(mContext,mWifiSoftapMonitor);
        mWifiSoftapNative = new WifiSoftapNative(SystemProperties.get("wifi.interface", "wlan0"),
                mHostapdHal);
        ...
        mSupplicantStaIfaceHalEx = new SupplicantStaIfaceHalEx(mContext, mWifiMonitor);
        mWifiNative = new WifiNative(
        ...
        mWifiP2pNative = new WifiP2pNative(mSupplicantP2pIfaceHalEx, mHalDeviceManager);
        ...
        mVoWifiAssistor = new VoWifiAssistor(context, wifiStateMachineLooper,
                mWifiStateMachine.getWifiNetworkMonitor());
    }
     ...
     */
    public SoftApManager makeSoftApManager(@NonNull WifiInjector mWifiInjector,@NonNull WifiManager.SoftApCallback callback,
                                           @NonNull SoftApModeConfiguration config) {
        return mSoftApManager = new SoftApManager(mWifiInjector, mContext, mWifiStateMachineHandlerThread.getLooper(),
                mFrameworkFacade, mWifiNative, mCountryCode.getCountryCode(), callback,
                mWifiApConfigStore, config, mWifiMetrics, mVoWifiAssistor);
    }
    ...
    public WifiSoftapNative getWifiSoftapNative() {
        return mWifiSoftapNative;
    }

    public WifiSoftapMonitor getWifiSoftapMonitor() {
        return mWifiSoftapMonitor;
    }

    public SoftApManager getSoftApManager() {
        Log.d("changzb","wifiinjector getSoftApManager() ");
