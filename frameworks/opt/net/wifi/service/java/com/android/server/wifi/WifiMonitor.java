...
public class WifiMonitor {
   ...
   /* Network connection completed */
    ...
    public static final int OFFLOAD_ROAM_NOTIFY_EVENT            = BASE + 67;
    /**
    * <pre>
    ...
    */
    ...
    public static final int WAPI_AUTHENTICATION_FAILURE_EVENT    = BASE + 18;
    public static final int WAPI_CERTIFICATION_FAILURE_EVENT     = BASE + 19;
    public static final int WAPI_CERTIFICATION_LOST_EVENT        = BASE + 20;
    ...
    public void broadcastSupplicantEventEx(String iface, String eventEx) {
        ...
        if (eventEx.indexOf(OFFLOAD_ROAM_NOTIFY_STR) > 0) { //Offload roaming event
            sendMessage(iface, OFFLOAD_ROAM_NOTIFY_EVENT);
        }
        else if (eventEx.startsWith(WAPI_EVENT_PREFIX_STR)) {
