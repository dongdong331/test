...
public class WifiP2pServiceImpl extends IWifiP2pManager.Stub {
    ...
    //private final boolean mP2pWifiCoexistSupported = WifiFeaturesUtils.FeatureProperty.SUPPORT_SPRD_WIFI_COEXIST_P2P;
    ...
    public WifiP2pServiceImpl(Context context) {
        if(Build.TYPE.equals("user") == false) {
            DBG = true;
        }
        mContext = context;
                ...
                switch (message.what) {
                    ...
                    case IPC_PROVISIONING_SUCCESS:
                        ...
                        try {
                            ...
                            // SPRD: catch IllegalStateException to void system crash
                            } catch (IllegalStateException ie) {
