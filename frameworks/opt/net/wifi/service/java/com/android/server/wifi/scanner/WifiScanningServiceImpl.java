...
public class WifiScanningServiceImpl extends IWifiScanner.Stub {
    ...
    WifiScanningServiceImpl(Context context, Looper looper,
        ...
        //SPRD: Bug #474443 Porting cmcc wifi features -->
    ...
    class WifiSingleScanStateMachine extends StateMachine implements WifiNative.ScanEventHandler {
            ...
            public boolean processMessage(Message msg) {
                switch (msg.what) {
                    case CMD_SCAN_RESULTS_AVAILABLE:
                        ...
                        if (mSupportCMCC) sendSprdScanResultsAvailableBroadcast();
                        mActiveScans.clear();
                        transitionTo(mIdleState);
                        return HANDLED;
                    case CMD_FULL_SCAN_RESULTS:
        ...
        /**
         * Helper method to send the scan results broadcast for sprd cmcc feature.
         */
        private void sendSprdScanResultsAvailableBroadcast() {
            Intent intent2 = new Intent(WifiFeaturesUtils.WIFI_SCAN_RESULTS_AVAILABLE_ACTION);
            intent2.addFlags(Intent.FLAG_RECEIVER_REGISTERED_ONLY_BEFORE_BOOT);
            intent2.setPackage("com.android.settings");
            mContext.sendBroadcastAsUser(intent2, UserHandle.ALL);
            Log.d(TAG,"sendSprdScanResultsAvailableBroadcast end.");
        }
    }
