...
public class XmlUtil {
    ...
    public static class WifiConfigurationXmlUtil {
        ...
        public static final String XML_TAG_EAP_SIM_SLOT = "EapSimSlot";
        public static final String XML_TAG_AUTO_JOIN_NETWORK = "AutoJoinNetwork";
        ...
        public static void writeCommonElementsToXml(
            ...
            XmlUtil.writeNextValue(out, XML_TAG_EAP_SIM_SLOT, configuration.eap_sim_slot);
            XmlUtil.writeNextValue(out, XML_TAG_AUTO_JOIN_NETWORK, configuration.auto_join_network);
            ...
            while (!XmlUtil.isNextSectionEnd(in, outerTagDepth)) {
                ...
                switch (valueName[0]) {
                    ...
                    case XML_TAG_WAPI_USER_CERT:
                        ...
                        break;
                    case XML_TAG_EAP_SIM_SLOT:
                        configuration.eap_sim_slot= (int) value;
                        break;
                    case XML_TAG_AUTO_JOIN_NETWORK:
                        configuration.auto_join_network = (int) value;
                        break;
                    default:
                        throw new XmlPullParserException(
