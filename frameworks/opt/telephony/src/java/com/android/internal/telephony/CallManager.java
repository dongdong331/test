...
public class CallManager {
    ...
    */
    ...
    public void acceptCall(Call ringingCall) throws CallStateException {
         ...
         * @Orig:ringingPhone.acceptCall(VideoProfile.STATE_AUDIO_ONLY); {
         */
        int videoState = VideoProfile.STATE_AUDIO_ONLY;
        if (ringingCall != null && (ringingCall instanceof ImsPhoneCall)) {
            if (((ImsPhoneCall) ringingCall).getConnections().size() != 0) {
                videoState = ((ImsPhoneCall) ringingCall).getConnections().get(0).getVideoState();
                Rlog.d(LOG_TAG, "acceptCall videoState=" + videoState);
            }
        }
        ringingPhone.acceptCall(videoState);
        /* @} */
