...
public class GsmCdmaPhone extends Phone {
    ...
    public GsmCdmaPhone(Context context, CommandsInterface ci, PhoneNotifier notifier,
        ...
        mDcTracker = new DcTrackerEx(this);
        /* @} */
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals(CarrierConfigManager.ACTION_CARRIER_CONFIG_CHANGED)) {
                setCarrierConfigParameter(intent); //SPRD: add for bug1033847
            ...
            switch (mDcTracker.getState(apnType)) {
                ...
                case DISCONNECTING:
                    ...
                    if (getState() != PhoneConstants.State.IDLE
                            && !mSST.isConcurrentVoiceAndDataAllowed() && !isVolteEnabled()) {
                        ret = PhoneConstants.DataState.SUSPENDED;
                    /* UNISOC: FEATURE_SUSPEND_DATA_WHEN_IN_CALL @{ */
                    } else if (mDcTracker.isSuspended()) {
                        ret = PhoneConstants.DataState.SUSPENDED;
                    /* @} */
                    } else {
   ...
   @Override
    ...
    public void setCallWaiting(boolean enable, Message onComplete) {
        if (isPhoneTypeGsm()) {
            ...
            CarrierConfigManager carrierMgr = (CarrierConfigManager)
                    getContext().getSystemService(Context.CARRIER_CONFIG_SERVICE);
            if ((carrierMgr != null)
                    && (carrierMgr.getConfigForSubId(getSubId()) != null)) {
                serviceClass = carrierMgr.getConfigForSubId(getSubId()).getInt(
    ...
    public void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case EVENT_CARRIER_CONFIG_CHANGED:
                ...
                if (imsManager.isServiceAvailable() && getCarrierConfigParameter()) { //SPRD: add for bug1033847
