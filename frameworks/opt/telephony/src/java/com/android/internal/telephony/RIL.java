...
public class RIL extends BaseCommands implements CommandsInterface {
    ...
    public static ArrayList<CellInfo> convertHalCellInfoList(
        ...
        return convertHalCellInfoList(records, -1);
    }

    /**
     * UNISOC add phoneId to get operator name in EF files and NITZ message
     */
    public static ArrayList<CellInfo> convertHalCellInfoList(
            ArrayList<android.hardware.radio.V1_0.CellInfo> records, int phoneId) {
            ...
            switch (record.cellInfoType) {
                case CellInfoType.GSM: {
                    ...
                    writeToParcelForGsm(
                            ...
                            getOpratorNameByPlmn(cellInfoGsm.cellIdentityGsm.mcc,
                                    cellInfoGsm.cellIdentityGsm.mnc,
                                    cellInfoGsm.cellIdentityGsm.lac,
                                    phoneId),
                            EMPTY_ALPHA_SHORT,
                ...
                case CellInfoType.LTE: {
                    ...
                    writeToParcelForLte(
                            ...
                            getOpratorNameByPlmn(cellInfoLte.cellIdentityLte.mcc,
                                    cellInfoLte.cellIdentityLte.mnc,
                                    cellInfoLte.cellIdentityLte.tac,
                                    phoneId),
                            EMPTY_ALPHA_SHORT,
                ...
                case CellInfoType.WCDMA: {
                    ...
                    writeToParcelForWcdma(
                            ...
                            getOpratorNameByPlmn(cellInfoWcdma.cellIdentityWcdma.mcc,
                                    cellInfoWcdma.cellIdentityWcdma.mnc,
                                    cellInfoWcdma.cellIdentityWcdma.lac,
                                    phoneId),
                            EMPTY_ALPHA_SHORT,
    ...
    /**
     * UNISOC Add to support operator name for HalCellInfoList_1.0/1.1
     * NetworkSelectListPreference.isInvalidCellInfo will check operator name not null.
     */
    private static String getOpratorNameByPlmn(String mcc, String mnc, int lac, int phoneId) {
        String numericPlmn = mcc + mnc;
        String operatorName = TeleUtils.updateOperator(numericPlmn, "numeric_to_operator");
        if(phoneId != -1) {
            // Try to get PLMN name by EF files and NITZ message
            String highPriorityPlmn = OperatorNameHandler.getInstance().getHighPriorityOperatorName(phoneId, numericPlmn, lac, true);
            if(!TextUtils.isEmpty(highPriorityPlmn) && !highPriorityPlmn.equals(numericPlmn)) {
                operatorName = highPriorityPlmn;
            }
        }
        return TeleUtils.translateOperatorName(numericPlmn, operatorName);
    }
