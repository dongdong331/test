...
public class RadioIndication extends IRadioIndication.Stub {
    ...
    public void suppSvcNotify(int indicationType, SuppSvcNotification suppSvcNotification) {
        ...
        // UNISOC: Fix bug892203
        if (mRil.mSsnRegistrants != null) {
    ...
    private void responseCellInfos(int indicationType,
        ...
        // UNISOC: add phone id to update operator name
        ArrayList<CellInfo> infos = RIL.convertHalCellInfoList(result.networkInfos, mRil.mPhoneId);
