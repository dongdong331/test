...
class CommandParamsFactory extends Handler {
    ...
    private boolean processRefresh(CommandDetails cmdDet,
        ...
        case REFRESH_UICC_PLMN_CHANGE:
            if (textMsg.text == null || textMsg.text.length() == 0) {
                Resources r = Resources.getSystem();
                textMsg.text = r.getString(com.android.internal.R.string.stk_refresh_sim_init_message);
    ...
    private boolean processSelectItem(CommandDetails cmdDet,
        ...
        while (true) {
            ...
            if (ctlv != null) {
                ...
                /* UNISOC: Don't to add the NULL item to menu for SELECT_ITEM only @{ */
    ...
    private boolean processLaunchBrowser(CommandDetails cmdDet,
        ...
        if(confirmMsg.text == null){
            confirmMsg.text = Resources.getSystem().getString(com.android.internal.R.string.launchBrowserDefault);
        }
    ...
    private boolean processSetupCall(CommandDetails cmdDet,
        ...
        confirmMsg.text = ValueParser.retrieveAlphaId(ctlv);
        if(confirmMsg.text == null){
            confirmMsg.text = Resources.getSystem().getString(com.android.internal.R.string.SetupCallDefault);
        }
    ...
    private boolean processDtmfNotify(CommandDetails cmdDet, List<ComprehensionTlv> ctlvs)
        ...
        CatLog.d(this, "process DtmfNotify");
