...
enum {
	SPRD_COLORSPACE_BT601_CONFORMANT_RANGE = 1,
	SPRD_COLORSPACE_BT601_FULL_RANGE,
	SPRD_COLORSPACE_BT709_CONFORMANT_RANGE,
	SPRD_COLORSPACE_BT709_FULL_RANGE,
	SPRD_COLORSPACE_BT2020_CONFORMANT_RANGE,
	SPRD_COLORSPACE_BT2020_FULL_RANGE,
};
