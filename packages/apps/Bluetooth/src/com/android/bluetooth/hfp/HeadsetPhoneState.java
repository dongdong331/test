            ...
            mHeadsetService.registerReceiver(new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    if (TelephonyIntents.ACTION_SIM_STATE_CHANGED.equals(intent.getAction())) {
                        ...
                        //SPRD:Bug#964318 in case of get no defult simId,do not get sim state from action.
                        ...
                        //SPRD:Bug#818912 in case of call unregisterReceiver again when the receiver is already unregistered
                        try {
