    ...
    void handlePanDeviceStateChange(BluetoothDevice device, String iface, int state, int localRole,
        ...
        if (remoteRole == BluetoothPan.LOCAL_PANU_ROLE) {
            if (state == BluetoothProfile.STATE_CONNECTED) {
                ...
                // SPRD: set ril.bt-pan.active prop when bt pan connected
                SystemProperties.set("vendor.bluetooth.ril.bt-pan.active", "1");
                }
                ...
                // SPRD: reset ril.bt-pan.active prop when bt pan disconnected
                SystemProperties.set("vendor.bluetooth.ril.bt-pan.active", "0");
            }
