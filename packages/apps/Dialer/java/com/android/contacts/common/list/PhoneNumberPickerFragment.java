...
public class PhoneNumberPickerFragment extends ContactEntryListFragment<ContactEntryListAdapter>
  ...
  protected void onCreateView(LayoutInflater inflater, ViewGroup container) {
    ...
    /**UNISOC: modify for bug 952419 @{*/
    getListView().setOnScrollListener(new AbsListView.OnScrollListener() {
      @Override
      public void onScrollStateChanged(AbsListView view, int scrollState) {
          if (scrollState == AbsListView.OnScrollListener.SCROLL_STATE_IDLE) {
              scrolledX = getListView().getScrollX();
              scrolledY = getListView().getScrollY();
          }
      }
      @Override
  ...
  public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
    ...
    /**UNISOC: modify for bug947296 & 951872 & 952419@{*/
//    if (data != null && data.getCount() > 0) {
//        ((PinnedHeaderListView) getListView()).setSelection(0);
//    }
    getListView().scrollTo(scrolledX, scrolledY);
    /**@}*/
