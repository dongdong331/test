...
public class SelectPhoneAccountDialogFragment extends DialogFragment {
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    /** SPRD: add for bug889402 @{ */
    if(getArguments().getParcelable(ARG_LISTENER) instanceof SelectPhoneAccountListener) {
  ...
  /* SPRD: add to receive sim state to fix bug 732940 @{ */
