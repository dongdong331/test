...
public class CallLogFilterFragment extends DialogFragment {
    ...
    /* SPRD: add for bug670914 @{ */
    private static CallLogFilterFragment mDialog = null;

    /** Preferred way to show this dialog */
    public static void show(FragmentManager fragmentManager) {
        /* SPRD: add for bug670914 @{ */
        mDialog = new CallLogFilterFragment();
        try {
    ...
    public static void dismissDialog() {
        if (mDialog != null) {
            /*UNISOC: add for bug942638*/
            mDialog.dismissAllowingStateLoss();
            //SPRD: add for bug689176
            mDialog = null;
        }
    }
    /* @} */
