    ...
    return new IntentProvider() {
      ...
      public Intent getIntent(Context context) {
        if (isVoiceMailNumber) {
          return CallDetailsActivity.newInstance(context, callDetailsEntries, contact, canReportCallerId, canSupportAssistedDialing)
                  .putExtra(CallDetailsActivity.IS_VOIVE_MAIL_NUMBE, isVoiceMailNumber);
