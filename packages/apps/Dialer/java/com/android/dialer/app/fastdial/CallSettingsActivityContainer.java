...
public class CallSettingsActivityContainer extends Application {
    private static final String LOG_TAG = "CallSettingsActivityContainer";
    ...
    private static CallSettingsActivityContainer sInstance;
    ...
    private CallSettingsActivityContainer() {
    }

    public synchronized static CallSettingsActivityContainer getInstance() {
        if (sInstance == null) {
            sInstance = new CallSettingsActivityContainer();
        }
        return sInstance;
    }
