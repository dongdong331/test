...
public class DialerDatabaseHelper extends SQLiteOpenHelper {
  ...
  /* @} */
  //FEATURE_MATCH_COUNTRY_CODE_IN_DIALPAD
  ...
  public synchronized ArrayList<ContactNumber> getLooseMatches(
    ...
    if (!TextUtils.isEmpty(query)) {
        ...
        cursor = context.getContentResolver().query(uri, PhoneQuery.PROJECTION_DIALER, null,
  ...
  public ArrayList<DialMatchInfo> getLooseMatchesForDialMatchInfo(
    ...
    try {
      while ((cursor.moveToNext())) {
        ...
        final int carrierPresence = cursor.getInt(9);
        final String accountType = cursor.getString(10);
        final String accountName = cursor.getString(11);
        final String lookupUri = cursor.getString(12);
      ...
      /** UNISOC: add for bug961026 @{ */
    } catch (CursorWindowAllocationException exception) {
      Log.d(TAG,"getLooseMatchesForDialMatchInfo CursorWindowAllocationException");
      return result;
      /** }@*/
    } finally {
      cursor.close();
