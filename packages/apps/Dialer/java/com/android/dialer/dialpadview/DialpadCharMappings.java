...
public class DialpadCharMappings {
  ...
  public static SimpleArrayMap<Character, Character> getCharToKeyMap(@NonNull Context context) {
      ...
      try {
          languageCode = CompatUtils.getLocale(context).getISO3Language();
      } catch (MissingResourceException e) {
          languageCode = "bul";
          Log.d("DialpadCharMappings.getCharToKeyMap", "Couldn't find 3-letter language code.");
      }
  ...
  static String[] getKeyToCharsMap(@NonNull Context context) {
      ...
      try {
          ...
          languageCode = "bul";
          Log.d("DialpadCharMappings.getKeyToCharsMap", "Couldn't find 3-letter language code.");
      }
    return KEY_TO_CHAR_MAPS.get(languageCode);
  }
