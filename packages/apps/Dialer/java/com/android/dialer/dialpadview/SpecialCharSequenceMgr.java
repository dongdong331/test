      ...
      new ArrayList<String>() {
        {
          add("*#07#");
          add("*#87#");
          /**SPRD: bug 904869 Using Code *#43# to query the state of call waiting @{*/
          //add("*#43#");
          /** @{*/
          add("*#2727#");
          add("*#88#");
    ...
    if ((len > 1) && (len < 5) && (input.endsWith("#"))) {
      ...
      try {
        ...
        if (subscriptionAccountHandles.size() <= 1 || hasUserSelectedDefault) {
          ...
          /* UNISOC: Add for Bug984100 */
          if (isAirplaneModeOn && !(((TelephonyManager)context.getSystemService(Context.TELEPHONY_SERVICE)).isWifiCallingAvailable())) {
            Toast.makeText(context, R.string.dialog_voicemail_airplane_mode_message,
    ...
    protected void onNotNullableQueryComplete(int token, Object cookie, Cursor c) {
      try {
        ...
        if ((c != null) && (text != null) && (c.moveToPosition(sc.contactNum))) {
          ...
          /* SPRD: modify by bug887847 && bug827037 @{ */
