...
public class OldMainActivityPeer implements MainActivityPeer, FragmentUtilListener {
  ...
  public void onActivityResume() {
    ...
    try {
        forceUpdate = !CompatUtils.getLocale(mainActivity).getISO3Language().equals(savedLanguageCode);
    } catch (MissingResourceException e){
        LogUtil.w("OldMainActivityPeer.onActivityResume", "Couldn't find 3-letter language code.");
    }
  ...
  public void onSaveInstanceState(Bundle bundle) {
    ...
    try {
        languageCode = CompatUtils.getLocale(mainActivity).getISO3Language();
    } catch (MissingResourceException e) {
        languageCode = "bul";
        LogUtil.i("OldMainActivityPeer.onSaveInstanceState", "Couldn't find 3-letter language code.");
    }
    bundle.putString(
        KEY_SAVED_LANGUAGE_CODE, languageCode);
