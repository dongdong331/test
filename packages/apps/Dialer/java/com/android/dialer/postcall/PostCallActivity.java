...
public class PostCallActivity extends AppCompatActivity implements MessageFragment.Listener {
  ...
  public static final String KEY_PHONE_SUBID = "phone_subId";
  ...
  public static Intent newIntent(
    ...
    //UNISOC: add for bug916945
    intent.putExtra(KEY_PHONE_SUBID, subId);
  ...
  public void onMessageFragmentSendMessage(@NonNull String message) {
    ...
    //UNISOC: add for bug916945
    int subId = getIntent().getIntExtra(KEY_PHONE_SUBID, SubscriptionManager.INVALID_SUBSCRIPTION_ID);
