...
public class CallLogClearActivity extends ListActivity implements CallLogClearColumn {
            ...
            case R.id.delete_all:
                ...
                if (mSelectId.size() == 0) {
                    Toast.makeText(getApplicationContext(),
                            R.string.do_not_select, Toast.LENGTH_SHORT).show();
    ...
    private final class CallLogClearAdapter extends ResourceCursorAdapter {
        ...
        public void bindView(View view, Context context, Cursor c) {
            ...
            /* SPRD: add for Bug 965628 show fdn name when fdn contact dialed@{ */
            name = DialerTelcelHelper.getInstance(context)
            ...
            if (iconView != null) {
                ...
                // SPRD: modify for bug709724 bug892117
                iconView.clear();
                iconView.add(type);
            }
