...
import android.telephony.PhoneNumberUtilsEx;//UNISOC:add for bug1001337
import android.telephony.SubscriptionInfo;
import android.telephony.SubscriptionManager;//UNISOC:add for bug1001337
import android.text.TextUtils;
import com.android.dialer.common.Assert;
import com.android.dialer.common.LogUtil;
import com.android.incallui.Log;//UNISOC:add for bug1001337
import com.android.incallui.sprd.InCallUiUtils;//UNISOC:add for bug1001337
import com.google.common.base.Optional;
import java.util.Locale;
import android.app.ActivityThread;//UNISOC:add for bug1001337
...
public class TelecomCallUtil {
  ...
  public static boolean isEmergencyCall(@NonNull Call call) {
    ...
    //UNISOC:add for bug1001337
    PhoneAccountHandle accountHandle = call.getDetails().getAccountHandle();
    Context context = ActivityThread.currentApplication();
 //   LogUtil.i("TelecomCallUtil", "zhenxing-isEmergencyCall:" + PhoneNumberUtils.isEmergencyNumber(handle == null ? "" : handle.getSchemeSpecificPart()));
//    return PhoneNumberUtils.isEmergencyNumber(handle == null ? "" : handle.getSchemeSpecificPart());
    ...
    LogUtil.i("TelecomCallUtil", ",currentPhoneId="+currentPhoneId+",isEmergencyCall:" +
            PhoneNumberUtilsEx.isEmergencyNumber(currentPhoneId, handle == null ? "" : handle.getSchemeSpecificPart()));


    return PhoneNumberUtilsEx.isEmergencyNumber(currentPhoneId, handle == null ? "" : handle.getSchemeSpecificPart());
  }
