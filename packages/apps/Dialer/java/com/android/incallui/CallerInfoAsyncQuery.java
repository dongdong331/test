...
public class CallerInfoAsyncQuery {
  ...
  private static void startQueryInternal(
    ...
    if (PhoneNumberUtils.isLocalEmergencyNumber(context, info.phoneNumber)
            //unisoc914156 for emergency check for dual,UNISOC:modify for bug1005308
            || PhoneNumberUtilsEx.isEmergencyNumber(info.getSlotId(), info.phoneNumber)) {
      ...
      try {
        ...
        if (callerInfo == null) {
          ...
          if (cw.event == EVENT_EMERGENCY_NUMBER) {
            ...
            // SPRD Feature Porting: Show emergency number when dial emergency call feature.
