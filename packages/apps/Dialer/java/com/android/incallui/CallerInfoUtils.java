...
import com.android.incallui.sprd.InCallUiUtils;//UNISOC:add for bug1005308
...
public class CallerInfoUtils {
  ...
  static CallerInfo buildCallerInfo(Context context, DialerCall call) {
    ...
    //UNISOC:add for bug1005308
    if (call.getAccountHandle() != null) {
      info.setSlotId(InCallUiUtils.getSlotIdForPhoneAccountHandle(context, call.getAccountHandle()));
    }
