...
public class DialpadFragment extends BaseFragment<DialpadPresenter, DialpadUi>
  ...
  private View dialpad_end_call_space;
  ...
  public View onCreateView(
    ...
    dialpad_end_call_space = parent.findViewById(R.id.dialpad_end_key_space);
    if(isLandscape()){
      dialpad_end_call_space.setVisibility(View.GONE);
    }
    /* @} */
