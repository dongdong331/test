...
import com.android.incallui.call.CallList;//UNISOC:add for bug987800
import com.android.incallui.sprd.plugin.InComingThirdCall.InComingThirdCallHelper;//UNISOC:add for bug987800
...
public class FlingUpDownMethod extends AnswerMethod implements OnProgressChangedListener {
  ...
  private void performAccept() {
    ...
    if (InComingThirdCallHelper.getInstance(getContext()).isSupportIncomingThirdCall()
      ...
      getParent().answerAndReleaseFromMethod();
    } else {
