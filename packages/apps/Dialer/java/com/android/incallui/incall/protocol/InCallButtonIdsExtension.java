...
public class InCallButtonIdsExtension {
  ...
  public static String toString(@InCallButtonIds int id) {
    if (id == InCallButtonIds.BUTTON_AUDIO) {
      ...
      return "RECORD"; // SPRD Feature Porting: Add for call recorder feature.
    } else if (id == InCallButtonIds.BUTTON_SEND_MESSAGE) {
      return "SEND_MESSAGE"; // SPRD Feature Porting:: Add for send message feature.
    } else if (id == InCallButtonIds.BUTTON_HANGUP_ALL) {
      return "HANGUP_ALL"; // SPRD Feature Porting: Add for hangup all feature.
    } else if (id == InCallButtonIds.BUTTON_ECT) {
      return "ECT"; // SPRD Feature Porting: Add for Explicit Call Transfer.
    } else if (id == InCallButtonIds.BUTTON_INVITE) {
        return "INVITE"; // SPRD Feature Porting: Add for call invite feature.
    } else {
