...
public interface VideoCallScreenDelegate {
  ...
  void onVideoCallIsFront();//UNISOC:add for bug 903996

  void onVideoCallIsBack();//UNISOC:add for bug 903996

  boolean isRingToneOnAudioCall();//UNISOC:add for bug 960205
}
