...
public class ImsVideoCallCallback extends VideoCall.Callback {
  ...
  public void onSessionModifyRequestReceived(VideoProfile videoProfile) {
    ...
    if (wasVideoCall && !isVideoCall) {
      ...
      boolean isRxTxUpgradeToVideo = (previousVideoState == VideoProfile.STATE_TX_ENABLED || previousVideoState == VideoProfile.STATE_RX_ENABLED)
              && newVideoState == VideoProfile.STATE_BIDIRECTIONAL;
      requestedVideoState = newVideoState;
      if (!wasVideoCall || isRxTxUpgradeToVideo) {
