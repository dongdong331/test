...
public abstract class BaseActivity
    ...
    public abstract void updateSelectAllMenu(Menu menu);
    ...
    public void onRootPicked(RootInfo root) {
        ...
        if(root.isAdvanced()) {
            if(!mState.showAdvanced) {
                updateDisplayAdvancedDevices(true);
            }
            if(mState.stack.getRoot() == null) {
                Log.d(mTag, "Set showDeviceStorageOption is false");
                mState.showDeviceStorageOption = false;
            }
        }
