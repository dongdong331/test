...
public class DirectoryLoader extends AsyncTaskLoader<DirectoryResult> {
    ...
    public DirectoryLoader(
        ...
        mObserver = new LockingContentObserver(lock, this::onContentChangedCallback);
    }

    private void onContentChangedCallback() {
       if(!isStarted()) {
           Log.d(TAG, "Loader is not started, loader will not do forceLoad");
       }
       onContentChanged();
    }
    @Override
