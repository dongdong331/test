...
public final class Shared {
    ...
    public static boolean IsValidFilename(String docName) {
        assert(!docName.isEmpty());

        for(char ch : docName.toCharArray()) {
    ...
    public static boolean isExternalStorageDocument(Uri uri) {
        return Providers.AUTHORITY_STORAGE.equals(uri.getAuthority());
    }

    public static boolean isDownloadsDocument(Uri uri) {
        return Providers.AUTHORITY_DOWNLOADS.equals(uri.getAuthority());
    }
}
