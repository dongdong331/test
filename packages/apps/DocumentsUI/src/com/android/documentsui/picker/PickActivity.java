...
public class PickActivity extends BaseActivity implements ActionHandler.Addons {
    ...
    public String getDrawerTitle() {
        int titleId = getIntent().getIntExtra(DocumentsContract.EXTRA_PROMPT,-1);
        String title;
        if (titleId == -1){
            title = null;
        } else {
    ...
    public void updateSelectAllMenu(Menu menu) {
        ...
        //Log.d(TAG, "updateSelectAllMenu selectedCount="+selectedCount+"  itemCount="+itemCount+"   allowMultiple="+ mState.allowMultiple);

        if (itemCount > 0 && mState.allowMultiple) {
