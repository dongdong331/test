...
public class ProvidersCache implements ProvidersAccess {
    ...
    private Collection<RootInfo> loadRootsForAuthority(
        ...
        Log.d(TAG, "Root of " + authority + "is: " + roots);
        return roots;
    }
    ...
    private class UpdateTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            Log.d(TAG, "providers found " + providers);
            ...
            Intent rootChangeIntent = new Intent(BROADCAST_ACTION);
            if (mRootChangeUri != null) {
                rootChangeIntent.putExtra(Shared.EXTRA_ROOT, mRootChangeUri.toString());
            }
            LocalBroadcastManager.getInstance(mContext).sendBroadcast(rootChangeIntent);
            return null;
        }
