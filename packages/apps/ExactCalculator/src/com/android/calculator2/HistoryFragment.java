...
public class HistoryFragment extends Fragment implements DragLayout.DragCallback {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (isEmpty) {
            ...
            /* Bug 901476, if history fragment has no items,disable the clear option.
            Because onCreateView is executed before onActivityCreated, the toolbar and item are not NULL.*/
            MenuItem item = (MenuItem) toolbar.getMenu().findItem(R.id.menu_clear_history);
