...
public class UnreadCalendarItem extends UnreadBaseItem{
    ...
    public UnreadCalendarItem(Context context) {
        ...
        mPrefKey = UnreadActivity.UnreadSettingsFragment.PREF_KEY_UNREAD_CALENDAR;
    ...
    public ArrayList<String> loadApps(Context context) {
        ...
        for (String calList : calLists) {
            ...
            boolean isInstalled = UtilitiesExt.isAppInstalled(context, componentName.getPackageName(), android.os.Process.myUserHandle());
            if (isInstalled) {
