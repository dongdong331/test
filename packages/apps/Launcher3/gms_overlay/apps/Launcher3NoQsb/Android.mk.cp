...
LOCAL_SRC_FILES := \
    ...
    $(call all-java-files-under, $(RELATIVE_LAUNCHER_PATH)/quickstep/ext/src) \
    $(call all-java-files-under, $(RELATIVE_LAUNCHER_PATH)/ext/src) \
    $(call all-java-files-under, $(RELATIVE_LAUNCHER_PATH)/ext/config/src_features) \
...
LOCAL_RESOURCE_DIR := \
    ...
    $(LAUNCHER_PATH)/quickstep/ext/res \
    $(LAUNCHER_PATH)/ext/res \
    $(LAUNCHER_PATH)/res
...
LOCAL_SRC_FILES := \
    $(call all-java-files-under, $(RELATIVE_LAUNCHER_PATH)/src) \
    $(call all-java-files-under, $(RELATIVE_LAUNCHER_PATH)/ext/src) \
    $(call all-java-files-under, $(RELATIVE_LAUNCHER_PATH)/ext/config/go/src_features) \
