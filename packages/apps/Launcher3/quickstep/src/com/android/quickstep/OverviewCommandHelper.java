...
public class OverviewCommandHelper {
    ...
    private void initOverviewTargets() {
        ...
        if (defaultHome == null || (mMyHomeComponent != null && mMyHomeComponent.equals(defaultHome))) {
    ...
    public void onOverviewToggle() {
        ...
        if (mAM.isScreenPinningActive()) {
            if (LogUtils.DEBUG_ALL) LogUtils.i(TAG, "onOverviewToggle, screen pinning active");
            return;
        }
        LogUtils.d(TAG, "onOverviewToggle start");
            ...
            anim.addListener(new AnimationSuccessListener() {
                ...
                public void onAnimationStart(Animator animator) {
                    ...
                    if (mRecentsView != null) {
                        mRecentsView.setRunningTaskIconScaledDown(true /* isScaledDown */,
                                false /* animate */);
                    }
                }
                @Override
