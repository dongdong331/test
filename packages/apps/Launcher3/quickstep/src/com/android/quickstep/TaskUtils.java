        ...
        appAnimator.addUpdateListener(new MultiValueUpdateListener() {
...

            {
                ...
                inOutHelper.setTaskTransformCallback((t, app) -> {
                    if (!FeatureOption.SPRD_ANIM_LAUNCHTASK) t.setAlpha(app.leash, mTaskAlpha.value);
            ...
            public void onUpdate(float percent) {
                ...
                if (!skipViewChanges && 0 != mThumbnailRect.width()) {
                    ...
                    if (!FeatureOption.SPRD_ANIM_LAUNCHTASK) v.setAlpha(mViewAlpha.value);
                }
            }
        });
        return appAnimator;
