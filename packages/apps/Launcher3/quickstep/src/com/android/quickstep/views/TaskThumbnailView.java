    ...
    private void updateThumbnailMatrix() {
        ...
        if (mBitmapShader != null && mThumbnailData != null) {
            ...
            if (getMeasuredWidth() == 0) {
                ...
                thumbnailXScale = rotate
                        ? getMeasuredWidth() / thumbnailHeight
                        : getMeasuredWidth() / thumbnailWidth;
                thumbnailYScale = rotate
            ...
            if (rotate) {
                ...
                if (rotationDir == -1) {
                    ...
                    float excessHeight = thumbnailWidth * thumbnailXScale - getMeasuredHeight();
            ...
            if (measuredHeight - bitmapHeight > measuredHeight*0.05f) {
                mClipBottom = bitmapHeight;
                mMatrix.postScale(thumbnailXScale, thumbnailXScale);
                mBitmapShader.setLocalMatrix(mMatrix);
            } else if (bitmapHeight - measuredHeight > measuredHeight*0.05f) {
                mMatrix.postScale(thumbnailXScale, thumbnailXScale);
                mBitmapShader.setLocalMatrix(mMatrix);
            } else {
