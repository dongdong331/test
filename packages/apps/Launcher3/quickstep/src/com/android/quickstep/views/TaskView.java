...
import com.sprd.quickstepext.locktask.LockIconView;
...
public class TaskView extends FrameLayout implements TaskCallbacks, PageCallbacks {
    ...
    protected void onFinishInflate() {
        ...
        if(FeatureOption.SPRD_TASK_LOCK_SUPPORT) {
            mLockIconView = findViewById(R.id.lock_icon_header);
        }
    }
    ...
    public void changeLockState() {
        ...
        if(null != mLockIconView) mLockIconView.setLockState(mLocked);
    }
