...
public class Hotseat extends FrameLayout implements LogContainerProvider, Insettable {
    ...
    public int getOrderInHotseat(int x, int y) {
        return getOrderInHotseat(x, y, getGridCount());
    }

    /* Get the orientation invariant order of the item in the hotseat for persistence. */
    public int getOrderInHotseat(int x, int y, int gridCount) {
        return mHasVerticalHotseat ? (gridCount - y - 1) : x;
    }
    ...
    public int getGridCount() {
        return mHasVerticalHotseat ? mContent.getCountY() : mContent.getCountX();
    }
