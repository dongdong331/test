...
import com.sprd.ext.grid.GridConfiguration;
...
public class InvariantDeviceProfile {
    ...
    /**
     * Configured number of icons per row and column in the workspace.
     */
    ...
    public InvariantDeviceProfile(Context context) {
        ...
        if (FeatureOption.SPRD_FOLDER_ICON_MODE_SUPPORT) {
            GridFolderPageUI.initFolderRowsAndColumns(context, this);
        }

        if (FeatureOption.SPRD_DESKTOP_GRID_SUPPORT) {
            gridConfig = new GridConfiguration(context, numRows, numColumns, numHotseatIcons);
        ...
        LogUtils.d("InvariantDeviceProfile", "closestProfile name:" + closestProfile.name
                + " smallSide:" + smallSide + " largeSide:" + largeSide + " " + this);
    }
