...
public class LauncherAppState {
    ...
    private LauncherAppState(Context context) {
        ...
        mShowNotificationCount = mNotificationBadgingObserver != null
                && FeatureOption.SPRD_NOTIFICATION_BADGE_COUNT;
    ...
    public static  boolean isShowNotificationCount(Context context) {
        return LauncherAppState.getInstance(context).mShowNotificationCount;
    }
