...
public class LauncherProvider extends ContentProvider {
    ...
    static final String SL_EMPTY_DATABASE_CREATED = "SL_EMPTY_DATABASE_CREATED";
    ...
    public Bundle call(String method, final String arg, final Bundle extras) {
        ...
        switch (method) {
            case LauncherSettings.Settings.METHOD_CLEAR_EMPTY_DB_FLAG: {
                clearFlagEmptyDbCreated(getContext());
                return null;
            }
            case LauncherSettings.Settings.METHOD_WAS_EMPTY_DB_CREATED : {
                Bundle result = new Bundle();
                result.putBoolean(LauncherSettings.Settings.EXTRA_VALUE, getFlagEmptyDbCreated(getContext()));
                return result;
            }
    ...
    private static void clearFlagEmptyDbCreated(Context context) {
        Utilities.getPrefs(context).edit().remove(getEmptyDbCreatedPrefKey()).commit();
    }

    @SuppressLint("ApplySharedPref")
    private static void setFlagEmptyDbCreated(Context context, boolean flag) {
        Utilities.getPrefs(context).edit().putBoolean(getEmptyDbCreatedPrefKey(), flag).commit();
    }

    private static boolean getFlagEmptyDbCreated(Context context) {
        return Utilities.getPrefs(context).getBoolean(getEmptyDbCreatedPrefKey(), false);
    }

    private static String getEmptyDbCreatedPrefKey() {
        if (MultiModeController.isSupportDynamicChange()) {
            return MultiModeController.isSingleLayerMode() ? SL_EMPTY_DATABASE_CREATED : EMPTY_DATABASE_CREATED;
        }
    ...
    synchronized private void loadDefaultFavoritesIfNecessary() {
        if (getFlagEmptyDbCreated(getContext())) {
            ...
            setFlagEmptyDbCreated(getContext(), false);
        }
    }
    ...
    public static class DatabaseHelper extends NoLocaleSQLiteHelper implements LayoutParserCallback {
        ...
        DatabaseHelper(Context context, Handler widgetHostResetHandler) {
            this(context, widgetHostResetHandler, LauncherFiles.getLauncherDb());
        ...
        protected void onEmptyDbCreated() {
            ...
            if (MultiModeController.isDefaultMode() && mWidgetHostResetHandler != null) {
            ...
            setFlagEmptyDbCreated(mContext, true);
        }
