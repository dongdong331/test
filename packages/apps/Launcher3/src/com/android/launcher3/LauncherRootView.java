...
public class LauncherRootView extends InsettableFrameLayout {
    ...
    private boolean mInsetsfitted = false;
    ...
    protected boolean fitSystemWindows(Rect insets) {
        ...
        if (resetState) {
            // Don't stop animation when first start.
            mLauncher.getStateManager().reapplyState(mInsetsfitted /*cancelCurrentAnimation*/);
        }
        mInsetsfitted = true;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        GesturesController controller = LauncherAppMonitor.getInstanceNoCreate().getGesturesController();
        boolean ret = false;
