...
public class LauncherStateManager {
    ...
    private void goToState(LauncherState state, boolean animated, long delay,
        ...
        if (LogUtils.DEBUG_ALL) {
            LogUtils.i(TAG, "Current State:" + mState + " To State:" + state
    ...
    public void moveToRestState() {
        ...
        if (LogUtils.DEBUG_ALL) {
            LogUtils.i(TAG, "moveToRestState: " + mState + ", " + mState.disableRestore);
        }
    ...
    public void setRestState(LauncherState restState) {
        if (LogUtils.DEBUG_ALL) LogUtils.i(TAG, "setRestState: " + restState);
