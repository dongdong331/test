...
public final class Utilities {
    ...
    private static Method mOverrideOptsBundleMethod;
    ...
    public static Bundle getActivityLaunchOptions(View v, Bundle optsBundle) {
        try {
            if (mOverrideOptsBundleMethod == null) {
                Class clazz = Class.forName("android.app.ActivityOptionsHelper");
                mOverrideOptsBundleMethod = clazz.getDeclaredMethod(
                        "overrideOptsBundle", View.class, Bundle.class);
            }
            return (Bundle) mOverrideOptsBundleMethod.invoke(null, v, optsBundle);
        } catch (Exception e) {
            Log.d(TAG, "Unable to override activity launch options");
        }
        return optsBundle;
    }
