...
public class DragController implements DragDriver.EventListener, TouchController {
    ...
    public DragView startDrag(Bitmap b, int dragLayerX, int dragLayerY,
        ...
        // Error to compute the offset of mDragObject.
        final int dragRegionLeft = 0 ; // dragRegion == null ? 0 : dragRegion.left;
        final int dragRegionTop =  0 ; // dragRegion == null ? 0 : dragRegion.top;
