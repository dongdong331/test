...
public class ClippedFolderIconLayoutRule {
    ...
    //The default value to prevent launcher crash.
    protected float mAvailableSpace = 99.0f;
    private float mRadius = 1f;
    private float mIconSize = 108.0f;
    private boolean mIsRtl;
    protected float mBaselineIconScale = 1f;
    ...
    public void init(int availableSpace, float intrinsicIconSize, boolean rtl) {
        ...
        if (LogUtils.DEBUG) {
            LogUtils.d("ClippedFolderIconLayoutRule", "init: mIconSize = " + mIconSize + ", mAvailableSpace = "
                    + mAvailableSpace + ", mBaselineIconScale = " + mBaselineIconScale);
        }
    }
