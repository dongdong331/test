...
public class Folder extends AbstractFloatingView implements DragSource,
    ...
    protected void onFinishInflate() {
        ...
        if(FolderIconUtils.getInstance().isGridFolderIcon()) {
            ...
            mPageIndicatorHeight = mPageIndicator.getMeasuredHeight();

            GridFolderPageUI.updateFolderPageIndicatorColor(this);
        }
    }
    ...
    static Folder fromXml(Launcher launcher) {
        return (Folder) launcher.getLayoutInflater()
                .inflate(GridFolderPageUI.getFolderPageLayoutResId(), null);
    }
    ...
    public void animateOpen() {
        ...
        mIsOpen = true;
        GridFolderPageUI.showWorkspaceAndHotseat(mLauncher, mIsOpen);
    ...
    OnAlarmListener mReorderAlarmListener = new OnAlarmListener() {
        public void onAlarm(Alarm alarm) {
            if (mContent.realTimeReorder(mEmptyCellRank, mTargetRank)) {
    ...
    private void removeItem(ShortcutInfo item) {
    ...
    public void onDropCompleted(final View target, final DragObject d,
        ...
        } else if (d.dragItemRemoved && d.dragInfo instanceof ShortcutInfo) {
            removeItem((ShortcutInfo) d.dragInfo);
        } else {
    ...
    private void centerAboutIcon() {
        if (FolderIconUtils.getInstance().isGridFolderIcon()) {
            GridFolderPageUI.centerAboutIcon(mLauncher, this);
            return;
        }
    ...
    private int getContentAreaHeight() {
        ...
        int maxContentAreaHeight = grid.availableHeightPx
                - grid.getTotalWorkspacePadding().y - mFooterHeight - mPageIndicatorHeight;
    ...
    private int getFolderHeight(int contentAreaHeight) {
        return getPaddingTop() + getPaddingBottom() + contentAreaHeight + mFooterHeight + mPageIndicatorHeight;
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (FolderIconUtils.getInstance().isGridFolderIcon()) {
            mPageIndicator.measure(contentAreaWidthSpec,
        ...
        if (pasi != null && pasiSi == null) {
            ...
            if (mIsExternalDrag) {
                ...
                if (mCurrentDragView == null) {
                    LogUtils.d(TAG, "onDrop is not external drag, mCurrentDragView is null");
                    mCurrentDragView = mContent.createNewView(si);
                }
