...
public class FolderAnimationManager {
    ...
    public AnimatorSet getAnimator() {
        if (!FolderIconUtils.getInstance().isNativeFolderIcon()) {
            BaseFolderIconModel model = FolderIconUtils.getInstance().getCurrentIconModel();
            if (model != null) {
                return model.getAnimator(this, mLauncher, mFolder, mFolderIcon,
                              mFolderBackground, mFolderInterpolator, mIsOpening);
            }
        }
     ...
     */
    public void addPreviewItemAnimators(AnimatorSet animatorSet, final float folderScale,
        ...
        final int maxNumItems = rule.maxNumItems();
        final int numItemsInPreview = itemsInPreview.size();
        final int numItemsInFirstPagePreview = isOnFirstPage
                ? numItemsInPreview : maxNumItems;
        ...
        for (int i = 0; i < numItemsInPreview; ++i) {
            ...
            if (mFolder.getItemCount() > maxNumItems) {
    ...
    public void play(AnimatorSet as, Animator a) {
    ...
    private TimeInterpolator getPreviewItemInterpolator() {
        if (mFolder.getItemCount() > mFolderIcon.getLayoutRule().maxNumItems()) {
    ...
    public Animator getAnimator(View view, Property property, float v1, float v2) {
        return mIsOpening
                ? ObjectAnimator.ofFloat(view, property, v1, v2)
                : ObjectAnimator.ofFloat(view, property, v2, v1);
    }

    public Animator getAnimator(GradientDrawable drawable, String property, int v1, int v2) {
        return mIsOpening
