...
public class PreviewBackground {
    ...
    protected int mStrokeAlpha = MAX_BG_OPACITY;
    private int mShadowAlpha = 255;
    protected View mInvalidateDelegate;

    protected int previewSize;
    protected int basePreviewOffsetX;
    protected int basePreviewOffsetY;
    ...
    public void setup(Launcher launcher, View invalidateDelegate,
        ...
        if (LogUtils.DEBUG) {
            LogUtils.d("PreviewBackground", "setup: previewSize = " + previewSize);
        }

        basePreviewOffsetX = (availableSpaceX - previewSize) / 2;
        basePreviewOffsetY = topPadding + grid.folderIconOffsetYPx;

        // Stroke width is multiple of 1dp.
        mStrokeWidth = launcher.getResources().getDisplayMetrics().density * STROKE_WIDTH_MULTIPLIER;
    ...
    public void drawCircle(Canvas canvas,float deltaRadius) {
        float radius = getScaledRadius();
