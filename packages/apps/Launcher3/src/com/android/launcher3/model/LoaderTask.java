...
public class LoaderTask implements Runnable {
    ...
    private volatile boolean mIsWaitForUnLock;
        ...
        synchronized (mBgDataModel) {
            ...
            for (ShortcutKey key : shortcutKeyToPinnedShortcuts.keySet()) {
                ...
                if ((numTimesPinned == null || numTimesPinned.value == 0)
                        ...
                        && !MultiModeController.getsPreModeSavedShortcuts().containsKey(key)) {
            ...
            for (FolderInfo folder : mBgDataModel.folders) {
                ...
                for (ShortcutInfo info : folder.contents) {
                    ...
                    if (numItemsInPreview >= FolderIconUtils.getInstance().getMaxNumItems()) {
                        break;
                    }
                }
            }
    ...
    public void setWaitForUnLock(boolean isWaitForUnLock) {
        mIsWaitForUnLock = isWaitForUnLock;
    }

    public boolean isWaitForUnLock() {
        return mIsWaitForUnLock;
    }
}
