...
public abstract class AbstractStateChangeTouchController
    ...
    private boolean reinitCurrentAnimation(boolean reachedToState, boolean isDragTowardPositive) {
        ...
        if (newFromState == null) newFromState = mLauncher.getStateManager().getState();
        ...
        if (animComponents == ANIM_ALL) {
            if (mAtomicAnim != null) mAtomicAnim.end();
        }
    ...
    public boolean onDrag(float displacement, float velocity) {
        ...
        if(MultiModeController.isSingleLayerMode() && mToState == ALL_APPS){
            return true;
        }
    ...
    public void onDragEnd(float velocity, boolean fling) {
        ...
        if (mCurrentAnimation == null) {
            LogUtils.d(TAG, "onDragEnd, mCurrentAnimation == null");
            reinitCurrentAnimation(false, mDetector.wasInitialTouchPositive());
        }
