...
public class TraceHelper {
    ...
    private static boolean ENABLED = FeatureFlags.IS_DOGFOOD_BUILD;

    private static boolean SYSTEM_TRACE = LogUtils.DEBUG_ALL;
    ...
    public static void beginSection(String sectionName) {
        if (ENABLED) {
            ...
            if (time == null) {
                time = new MutableLong(isLoggable(sectionName, VERBOSE) || LogUtils.DEBUG_ALL ? 0 : -1);
    ...
    public static void endSection(String sectionName, String msg) {
        if (ENABLED) {
            ...
            sUpTimes.remove(sectionName);
        }
    }

    public static void setTraceHelperEnable(boolean enable) {
        ENABLED |= enable;
    }
