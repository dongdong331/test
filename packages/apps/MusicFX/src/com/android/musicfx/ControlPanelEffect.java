...
public class ControlPanelEffect {
    ...
    /* bug914199 save flat equalizer to be default @{ */
    private final static int PRESET_EQUALIZER_CURRENT_PRESET_DEFAULT = 3;
    /* @} */
    // EQ defaults
    ...
    /* SPRD: open eq ,don't Override User EQ Param @{ */
        ...
        try {
            ...
            synchronized (mEQInitLock) {
                ...
                final short[] eQPresetUserBandLevelDefault = Arrays.copyOf(
                        EQUALIZER_PRESET_USER_BAND_LEVEL_DEFAULT, mEQNumBands);
                // If no preset prefs set use flat (= PRESET_EQUALIZER_CURRENT_PRESET_DEFAULT)
