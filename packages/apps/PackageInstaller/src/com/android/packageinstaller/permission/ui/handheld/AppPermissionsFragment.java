...
public final class AppPermissionsFragment extends SettingsWithHeader
    ...
    /*SPRD: find the preference showing now bug914390 {@*/
    private Preference findPreferenceNow(CharSequence key) {
        Preference pref = getPreferenceScreen().findPreference(key);
        if(pref == null && mExtraScreen != null){
            ...
            if (grantedByDefault || (!group.doesSupportRuntimePermissions()
                ...
                new AlertDialog.Builder(getContext())
                        ...
                        .setPositiveButton(R.string.grant_dialog_button_deny_anyway,
                            ...
                            Preference preferenceNow = findPreferenceNow(groupName);//SPRD: find the preference showing now bug914390
                            ((SwitchPreference) preferenceNow).setChecked(false);
