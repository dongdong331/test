...
/** Support "Low Battery FactoryReset Prompt" start @{ */
...
public class MasterClear extends InstrumentedFragment implements OnGlobalLayoutListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // Support "Low Battery FactoryReset Prompt"
        mLowBatteryPromptSupported = getActivity().getResources().getBoolean(R.bool.config_support_lowBatteryFactoryResetPrompt);
    }
    ...
    private void loadAccountList(final UserManager um) {
        ...
        for (int profileIndex = 0; profileIndex < profilesSize; profileIndex++) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                /* bug 902539: judge the account type, if user is from the resource read, change string @{ */
