...
import com.sprd.settings.wifi.cmcc.CmccAdvancedWifiSettings;
    ...
    private void doUpdateTilesList() {
        ...
        somethingChanged = setTileEnabled(changedList, new ComponentName(packageName,
                ...
                UserHandle.MU_ENABLED && UserManager.supportsMultipleUsers()
                        && !Utils.isMonkeyRunning() && !Utils.inUtraPowerSavingMode(), isAdmin)
                || somethingChanged;
        ...
        /* SPRD Bug 886422,900194 ,add the search for dynamic navigationbar @{ */
        ...
        setTileEnabled(changedList,new ComponentName(packageName,NavigationBarSettings.class.getName()), qemuEnabled && supportDynaNaviBar
