...
public class AppInfoDashboardFragment extends DashboardFragment
    ...
    protected List<AbstractPreferenceController> createPreferenceControllers(Context context) {
         ...
         *@{
         */
        controllers.add(new DefaultCameraShortcutPreferenceController(context, packageName));
        controllers.add(new DefaultGalleryShortcutPreferenceController(context, packageName));
        controllers.add(new DefaultMusicShortcutPreferenceController(context, packageName));
        controllers.add(new DefaultEmailShortcutPreferenceController(context, packageName));
        /*@}*/
