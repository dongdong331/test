...
public final class DeviceProfilesSettings extends InstrumentedDialogFragment implements
    ...
    private void refreshProfilePreference(CheckBox profilePref,
        ...
        if (profile instanceof MapProfile) {
            ...
            int panStatus = profile.getConnectionStatus(device) ;
            Log.d(TAG, "refreshProfilePreference()  PanProfile status: " + panStatus + " , device: "+device);
            profilePref.setChecked(panStatus ==  BluetoothProfile.STATE_CONNECTED);
