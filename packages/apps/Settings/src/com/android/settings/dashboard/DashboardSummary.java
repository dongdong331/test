...
public class DashboardSummary extends InstrumentedFragment
    ...
    public void onPause() {
        ...
        //UNISOC, added for bug 912928, remove self from ConditionManager in time,
    ...
    @VisibleForTesting
    void rebuildUI() {
        //UNISOC, modified for bug 934080.
        //rebuild UI in Main thread, and load suggestion by service, if need to do it.
        //maybe take long time to wait rebuild UI  by ThreadUtils.postOnBackgroundThread,
        //which way of working is Serial.
        Log.d(TAG," rebuildUI ");
