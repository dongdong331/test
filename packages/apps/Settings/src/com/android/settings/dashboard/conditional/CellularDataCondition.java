...
public class CellularDataCondition extends Condition {
    ...
    // UNISOC: bug 718882
    private static final String TAG = "CellularDataCondition";
    ...
    private void updateButtonState() {
        ...
        if (condition != null) {
            Button button = condition.mManager.getFirstActionButton();
            if (button != null) {
                button.setEnabled(!WirelessUtils.isAirplaneModeOn(context));
            }
        }
    }
    /* @} */
