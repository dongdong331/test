...
public class BuildNumberPreferenceController extends AbstractPreferenceController implements
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        if (preference != null) {
            try {
                //SPRD, added for bug 886445
                if (mContext.getResources().getBoolean(R.bool.config_support_customizedBuildNumber)) {
                    preference.setSummary(R.string.customized_build_number);
                } else {
