    ...
    public static class PartitionTask extends AsyncTask<Void, Integer, Exception> {
        ...
        protected void onPostExecute(Exception e) {
            ...
            if (e != null) {
                ...
                String description = "";
                if (activity.mFormatPrivate) {
                    final VolumeInfo volume = activity.findFirstVolume(VolumeInfo.TYPE_PRIVATE);
                    description = storage.getBestVolumeDescription(volume);
                } else {
                    description = storage.getBestVolumeDescription(activity.mVolume);
                }

                if (description == null) {
                    description = "";
                }
                Toast.makeText(activity, activity.getString(R.string.storage_format_failure,
