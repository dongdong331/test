...
public class EnterprisePrivacyFeatureProviderImpl implements EnterprisePrivacyFeatureProvider {
    ...
    public CharSequence getDeviceOwnerDisclosure() {
        ...
        final CharSequence organizationName = mDpm.getDeviceOwnerOrganizationName();
        if (organizationName != null) {
            disclosure.append(mContext.getResources().getString(R.string.do_disclosure_with_name,
                    organizationName));
        } else {
            disclosure.append(mContext.getResources().getString(R.string.do_disclosure_generic));
        }
        disclosure.append(mContext.getResources().getString(R.string.do_disclosure_learn_more_separator));
        disclosure.append(mContext.getResources().getString(R.string.learn_more),
