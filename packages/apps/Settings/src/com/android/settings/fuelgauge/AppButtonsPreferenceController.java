...
public class AppButtonsPreferenceController extends AbstractPreferenceController implements
    ...
    public AppButtonsPreferenceController(SettingsActivity activity, Fragment fragment,
        ...
        // UNISOC: Bug894966 cannot disabled app list.
        mCannotDisabledApps = activity.getResources().getStringArray(R.array.cannot_disabled_app);
        mCannotForceStopApps = activity.getResources().getStringArray(R.array.cannot_force_stop_app);
    }
    ...
    void updateForceStopButton() {
        ...
        if (mCannotForceStopApps != null) {
            Log.d(TAG, "User can't force stop whitelist package");
