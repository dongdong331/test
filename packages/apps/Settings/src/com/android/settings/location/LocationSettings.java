...
public class LocationSettings extends DashboardFragment {
    ...
    protected int getPreferenceScreenResId() {
        ...
        if (Utils.SUPPORT_GNSS && SUPPORT_CMCC) {
            resId = R.xml.location_settings_cmcc;
        }
        return resId;
    }
    ...
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<SearchIndexableResource> getXmlResourcesToIndex(
                    ...
                    sir.xmlResId = (Utils.SUPPORT_GNSS && GpsHelper.getInstance(context).isSupportCmcc()) ? R.xml.location_settings_cmcc : R.xml.location_settings;
