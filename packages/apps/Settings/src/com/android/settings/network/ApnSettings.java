...
public class ApnSettings extends RestrictedSettingsFragment implements
    ...
    public static final String SPECIAL_CTCC_NUMERIC = "20404";
    public static final String CTCC_ICCID = "898603,898611";
    ...
    public void onCreate(Bundle icicle) {
        ...
        mMobileStateFilter = new IntentFilter(
                TelephonyIntents.ACTION_ANY_DATA_CONNECTION_STATE_CHANGED);
        mApnSettingsUtils = new ApnSettingsUtils(activity, subId);
    ...
    private void fillList() {
        ...
        Cursor cursor = getContentResolver().query(Telephony.Carriers.CONTENT_URI, new String[] {
                ...
                null, orderBy); // UNISOC: Bug 594919 set default APN
        ...
        if (cursor != null) {
            ...
            ArrayList<ApnPreference> cdmaApnList = new ArrayList<ApnPreference>();
            ArrayList<ApnPreference> cdmaMmsApnList = new ArrayList<ApnPreference>();
            ...
            while (!cursor.isAfterLast()) {
                ...
                /* UNISOC: Add for 588412 show the IMS Apn on Volte version. @{ */
                boolean isApnVisible = mApnSettingsUtils.apnSettingVisibility(mccmnc, type);
                ...
                if (isApnVisible) {
                    ...
                    if (selectable) {
                        ...
                        addApnToList(pref, mnoApnList, mvnoApnList, cdmaApnList, r, mvnoType, mvnoMatchData);
                    } else {
                        addApnToList(pref, mnoMmsApnList, mvnoMmsApnList, cdmaMmsApnList, r, mvnoType, mvnoMatchData);
                    }
                }
                cursor.moveToNext();
            }
            ...
            for (Preference preference : mnoApnList) {
                ...
                if (mSelectedKey == null && apnPref.getSelectable()) {
                    ...
                    boolean isNeedSetChecked = mApnSettingsUtils.getIsNeedSetChecked(
                                    mccmnc, apn);
                    if (isNeedSetChecked) {
                        apnPref.setChecked();
    ...
    private void addApnToList(ApnPreference pref, ArrayList<ApnPreference> mnoList,
                              ArrayList<ApnPreference> mvnoList,ArrayList<ApnPreference> cdmaList,
                              IccRecords r, String mvnoType,String mvnoMatchData) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case MENU_RESTORE:
            /* UNISOC: reminder user when restore apn @{ */
            if (getActivity() != null) {
