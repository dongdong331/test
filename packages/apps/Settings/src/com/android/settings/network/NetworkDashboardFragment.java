...
public class NetworkDashboardFragment extends DashboardFragment implements
    ...
    public void showMobilePlanMessageDialog() {
        showMobilePlanDialog(MANAGE_MOBILE_PLAN_DIALOG_ID);
    }

    private void showMobilePlanDialog (int dialogId) {
        Log.d(TAG, "onCreateDialog: dialogId = " + dialogId);
        if (mMobilePlanDialog != null && mMobilePlanDialog.isShowing()) {
            Log.d(TAG, "mMobilePlanDialog have show");
            return;
        }
        ...
        mMobilePlanDialog = alertDialogBuilder
                ...
                .create();
        mMobilePlanDialog.setCanceledOnTouchOutside(false);
        mMobilePlanDialog.show();
    }
    ...
    static class SummaryProvider implements SummaryLoader.SummaryProvider {
        ...
        public void setListening(boolean listening) {
            if (listening) {
                ...
                if (mTetherPreferenceController.isAvailable() && !Utils.WCN_DISABLED) {
