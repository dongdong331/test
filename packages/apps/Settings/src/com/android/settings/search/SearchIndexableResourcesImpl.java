...
import com.android.settings.fuelgauge.SprdBatterySaverFragment;
...
public class SearchIndexableResourcesImpl implements SearchIndexableResources {
    ...
    public SearchIndexableResourcesImpl() {
        ...
        //not add DataUsageSummaryLegacy since it has been disabled.
	  ...
	  /*SPRD add for google sound settings*/
        ...
        // Removed for bug978923, This fragment is not currently in use, 
         ...
         *@{
         */
        addIndex(SmartControlsSettings.class);
        /*@}*/
        /* SPRD 886422 ,add the search for dynamic navigationbar @{ */
        addIndex(NavigationBarSettings.class);
        /*@}*/

        //SPRD: Bug#894588 add search index of schedule power on/off
        addIndex(AlarmClock.class);

        //Add for Battery Saver
        addIndex(SprdBatterySaverFragment.class);
