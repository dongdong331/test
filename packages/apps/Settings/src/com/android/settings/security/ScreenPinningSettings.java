...
public class ScreenPinningSettings extends SettingsPreferenceFragment
    ...
    private static final String TAG = "ScreenPinningSettings";
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        String recentApp = context.getString(com.android.internal.R.string.config_recentsComponentName);
        Log.d(TAG, "recentApp:" + recentApp);
        ComponentName recentsComponent = ComponentName.unflattenFromString(recentApp);
        Log.d(TAG, "recentsComponent is null:" + (recentsComponent == null));
        if (recentsComponent != null) {
            TextView textView = (TextView) emptyView.findViewById(R.id.screen_pinning_description);
            final Intent quickStepIntent = new Intent(ACTION_QUICKSTEP)
                    .setPackage(recentsComponent.getPackageName());
            if (context.getPackageManager().resolveService(quickStepIntent,
                    PackageManager.MATCH_SYSTEM_ONLY) == null) {
                Log.d(TAG, "use systemui recentApp!");
                textView.setText(R.string.screen_pinning_description_low_memory);
            } else {
                Log.d(TAG, "use launcher recentApp!");
                textView.setText(R.string.screen_pinning_description);
            }
        }
