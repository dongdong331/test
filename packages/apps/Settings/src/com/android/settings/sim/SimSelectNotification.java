...
public class SimSelectNotification extends BroadcastReceiver {
    ...
    private static final String SET_PRIMARYCARD_ACTION = "unisoc.intent.action.USER_SET_PRIMARYCARD";

    @Override
    public void onReceive(Context context, Intent intent) {
        String action = intent.getAction();
        if (SET_PRIMARYCARD_ACTION.equals(action) && !isForeground(context, SubSettings.class.getName())) {
            ...
            setPrimaryCardIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        ...
        // UNISOC Modify,remove the clear logic,see bug795334
        ...
        // UNISOC: Remove unnecessary notification.
