...
public class AddUserWhenLockedPreferenceController extends AbstractPreferenceController
        ...
        LifecycleObserver, OnStop, OnStart {
    ...
    public void updateState(Preference preference) {
        ...
        EnforcedAdmin admin = mUserCaps.disallowAddUser() ? mUserCaps.getEnforcedAdmin() : null;
        if (admin == null && Utils.inUtraPowerSavingMode()) {
            restrictedSwitchPreference.setEnabled(false);
        } else {
            restrictedSwitchPreference.setDisabledByAdmin(admin);
        }
    }
