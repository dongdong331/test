...
public class WifiDetailPreferenceController extends AbstractPreferenceController
    ...
    @VisibleForTesting
    static final String KEY_DISCONNECT_BUTTONS_PREF = "disconnect_button";
    private LayoutPreference mDisconnectButtonsPref;
    private Button mDisconnectButton;
    private WifiFeaturesUtils WifiFeaturesUtils;
    ...
    @VisibleForTesting
        ...
        mAddonStub = SprdWifiSettingsAddon.getInstance(context);
        supportCMCC = mAddonStub.isSupportCmcc();
        WifiFeaturesUtils = WifiFeaturesUtils.getInstance(context);
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        mDisconnectButtonsPref = (LayoutPreference) screen.findPreference(KEY_DISCONNECT_BUTTONS_PREF);
        mDisconnectButton = (Button) mDisconnectButtonsPref.findViewById(R.id.disconnect_button);
        if (supportCMCC) {
    ...
    private void updateIpLayerInfo() {
        ...
        if (WifiFeaturesUtils.SUPPORT_OPERATOR_VODAFONE_UK.equals(WifiFeaturesUtils.getOperatorSupport())
                && WifiFeaturesUtils.AUTO_JOIN_VODAFONE_WIFI_SSID.equals(mAccessPoint.getSsid().toString())) {
