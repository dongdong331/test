...
public class WifiTrustedAPList extends Activity implements OnClickListener,
    ...
    //SPRD:Bug #667977 Save the state when activity being destoryed BGN -->
    private static final String WIFI_TRUST_LIST_INDEX = "wifi_trust_list_index";
    private static final String WIFI_TRUST_UPDATE = "wifi_trust_update";
    //<-- Save the state when activity being destoryed END
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mIndex = savedInstanceState.getInt(WIFI_TRUST_LIST_INDEX);
            mUpdate = savedInstanceState.getBoolean(WIFI_TRUST_UPDATE);
        }
        //<-- Save the state when activity being destoryed END
