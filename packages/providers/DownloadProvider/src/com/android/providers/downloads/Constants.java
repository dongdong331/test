...
public class Constants {
    ...
    /**Paused by owner for COLUMN_CONTROL */
    public static final int TAG_PAUSED_BY_OWNER = 3;
    ...
    public static final String ACTION_DOWNLOAD_REQUEST_WRITE_PERMISSION = "android.downloads.action.REQUEST_WRITE_PERMISSION";
