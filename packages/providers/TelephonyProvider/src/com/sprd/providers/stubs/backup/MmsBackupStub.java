...
public class MmsBackupStub {
    ...
    public SQLiteDatabase getWritableSQLiteDatabase() {
        return MmsSmsDatabaseHelper.getInstanceForCe(mContext).getWritableDatabase();
    }
    ...
    public void updateAllThreads(SQLiteDatabase db, String where, String[] whereArgs) {
        MmsSmsDatabaseHelper.getInstanceForCe(mContext).updateAllThreads(db, where, whereArgs);
    }
}
