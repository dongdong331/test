...
public class SendRequest extends MmsRequest {
    ...
    @Override
    protected byte[] doHttp(Context context, MmsNetworkManager netMgr, ApnSettings apn,boolean firstTry)
            throws MmsHttpException {
        final String requestId = getRequestId();
        final MmsHttpClient mmsHttpClient ;
        boolean isVowifiConnected= PhoneUtils.isOperatorSupport(context,mSubId) && netMgr.isVowifiSmsEnable(mSubId);
