...
public class CallAudioModeStateMachine extends StateMachine {
    ...
    private class UnfocusedState extends BaseState {
        ...
        public void enter() {
            if (mIsInitialized) {
                ...
                //UNISOC Feature Porting 937206 : MaxRingingVolume and Vibrate.
                mCallAudioManager.stopMaxRingingVolume();
            }
        }
    ...
    private class RingingFocusState extends BaseState {
        private void tryStartRinging() {
            // UNISOC: modify for bug909334
            mAudioManager.requestAudioFocusForCall(AudioManager.STREAM_RING,
                    AudioManager.AUDIOFOCUS_GAIN_TRANSIENT);
            Log.i(LOG_TAG, "acquire audio anyway");
