...
public class CallAudioRouteStateMachine extends StateMachine {
    ...
    private CallAudioState getInitialAudioState() {
        ...
        BluetoothDevice activeBluetoothDevice = mBluetoothRouteManager.getBluetoothAudioConnectedDevice();

        if ((supportedRouteMask & ROUTE_BLUETOOTH) != 0 && activeBluetoothDevice != null) {
            route = ROUTE_BLUETOOTH;
        } else if ((supportedRouteMask & ROUTE_WIRED_HEADSET) != 0) {
            route = ROUTE_WIRED_HEADSET;
        // UNISOC: add for bug923153
        } else if ((supportedRouteMask & ROUTE_BLUETOOTH) != 0) {
            route = ROUTE_BLUETOOTH;
