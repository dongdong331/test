...
public class Ringer {
    ...
    public boolean startRinging(Call foregroundCall, boolean isHfpDeviceAttached) {
        ...
        // UNISOC: add for bug909334
        boolean isRingerEnable = shouldRingForContact && isRingtonePresent;
        ...
        boolean shouldAcquireAudioFocus =
                isRingerEnable || (isHfpDeviceAttached && shouldRingForContact) || isSelfManaged;
   ...
   /* @} */
    ...
    public void stopMaxRingingVolume() {
        mRingtonePlayer.stopMaxRingingVolume();
    }
    /* @} */
}
