...
public class EmergencyDialer extends Activity implements View.OnClickListener,
    ...
    public void afterTextChanged(Editable input) {
        ...
        if (Resources.getSystem().getBoolean(com.android.internal.R.bool.config_subsidyLock) && "*#5625".equals(input.toString())){
            Log.d(LOG_TAG, "send broadcast for subsidylock to enter pin lock screen");
            mDigits.getText().clear();
            Intent subsidyIntent = new Intent("com.sprd.intent.action.ACTION_ENTERCODE");
            sendBroadcast(subsidyIntent);
            finish();
        }
        /* @} */
    ...
    protected void onResume() {
        ...
        mDTMFToneEnabled = Settings.System.getInt(getContentResolver(),
                ...
                //UNOSOC: add for Bug890647
                && getResources().getBoolean(R.bool.config_is_support_dtmf_tone);
    ...
    private void placeCall() {
        ...
        if (PhoneNumberUtils.isLocalEmergencyNumber(this, mLastNumber)
                || PhoneNumberUtilsEx.isEmergencyNumber(mLastNumber)) {
