...
public class GsmUmtsCallBarringOptions extends TimeConsumingPreferenceActivity
    ...
    private void disableAllBarring(boolean positiveResult) {
        ...
        ((GsmCdmaPhoneEx) mPhone).setFacilityLock(CommandsInterface.CB_FACILITY_BA_ALL,
    ...
    protected void onCreate(Bundle icicle) {
        ...
        boolean isButtonBAICrVisible = true;//UNISOC:add for Bug1258195
        isButtonBAICrVisible = mSubscriptionInfoHelper.getCarrierValueByKey(
                    CarrierConfigManagerEx.KEY_SHOW_CB_FACILITY_BAICR);
        ...
        /* UNISOC: add for bug709181 @{ */
        boolean showDisableAll = !mSubscriptionInfoHelper.getCarrierValueByKey(
                CarrierConfigManagerEx.KEY_HIDE_CALLBARRING_DEACTIVATE_ALL);
        if (showDisableAll) {
