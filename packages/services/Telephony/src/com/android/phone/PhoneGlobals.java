...
public class PhoneGlobals extends ContextWrapper {
    ...
    // UNISOC : modify by BUG 918016
    public static final String MODIFY_PIN2_MMI_CODE = "**05";
    //add user agent for unisoc 1137386
    ...
    /**
     * add sip user agent for 1137386
     * Returns radioInteractorCore
     */
    ...
    /**
     * add user agent for 1137386
     * send at command when "ro.config.sipua" is set
     */
    public void setSipUserAgent() {
        ...
        String cmd = "AT+SPENGMDVOLTE=22,1," + "\"" + sipUserAgent + "\"";
        int mPhoneId = PhoneFactory.getDefaultPhone() != null ? PhoneFactory.getDefaultPhone().getPhoneId() : 0;
        mRadioInteractor.sendAtCmd(cmd, null, mPhoneId);
    }
    /**
    ...
    private void handleServiceStateChanged(Intent intent) {
        ...
        if (extras != null) {
            ...
            if (ss != null) {
                ...
                /*UNISOC: Bug 992528 Consider dataRegState if voiceRegState is OOS @{*/
