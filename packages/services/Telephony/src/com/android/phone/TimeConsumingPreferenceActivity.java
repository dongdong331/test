...
interface  TimeConsumingPreferenceListener {
    ...
    public void onUpdateTwinsPref(boolean toggled, int serviceClass,
           int reason, String number, String others);
    /* @} */
...
public class TimeConsumingPreferenceActivity extends PreferenceActivity
    ...
    private static final String PROP_DEFAULT_VAL = "false";
    /* @} */
    ...
    public void onError(Preference preference, int error) {
        ...
        /* UNISOC: add for bug821579 and for bug952191 @{ */
        if (preference instanceof CLIRListPreference) {
            preference.setSummary(R.string.sum_default_caller_id);
            SystemProperties.set(CLIR_PROP, String.valueOf(CommandsInterface.CLIR_DEFAULT));
        }
        if (preference instanceof CallWaitingSwitchPreference) {
            SystemProperties.set(CW_PROP, PROP_DEFAULT_VAL);
        }
        /* @} */
