...
public class AccessibilitySettingsFragment extends PreferenceFragment {
    ...
    private final PhoneStateListener mPhoneStateListener = new PhoneStateListener() {
        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            ...
            if (pref != null) {
                final boolean isVolteTtySupported = (ImsManager.isVolteEnabledByPlatform(mContext) || ImsManager.isWfcEnabledByPlatform(mContext)) //UNISOC: modify for bug1174972
