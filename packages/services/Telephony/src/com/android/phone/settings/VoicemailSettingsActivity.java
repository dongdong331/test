...
public class VoicemailSettingsActivity extends PreferenceActivity
    ...
    private VoicemailProviderListPreference mVoicemailProviders = null;
    ...
    protected void onResume() {
        ...
        /* UNISOC: add for FEATURE bug889118 @{ */
        boolean voicemailSettingEditable
                = getResources().getBoolean(R.bool.config_voicemail_setting_editable);
        mSubMenuVoicemailSettings.setEnabled(voicemailSettingEditable);
        /* @} */
        if (mSubMenuVoicemailSettings != null) {
        ...
        /* Sprd: add for bug930030 @{ */
        if (DBG) log("mPhone.isRadioOn()="+mPhone.isRadioOn());
        if(!mPhone.isRadioOn()){
    ...
    protected void onDestroy() {
        ...
        /* UNISOC: add for Bug 982330 @{ */
        if (mVoicemailProviders != null) {
            mVoicemailProviders.setOnPreferenceChangeListener(null);
        }
        /* @} */
    }
    /* @} */
