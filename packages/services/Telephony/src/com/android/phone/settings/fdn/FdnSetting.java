...
public class FdnSetting extends PreferenceActivity
                            ...
                            if (ar.exception instanceof CommandException) {
                                ...
                                switch (e) {
                                    ...
                                    case PASSWORD_INCORRECT:
                                        ...
                                        break;
                                    case UICC_CARD_APPLICATION_DISPOSED:
                                        //UNISOC:fix for bug 933188
                                        int phoneId = mPhone.getPhoneId();
                                        if(!mTelephonyManagerEx.isSimEnabled(phoneId)){
                                            break;
                                        }
    ...
    */
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mTelephonyManagerEx = TelephonyManagerEx.from(getBaseContext());
