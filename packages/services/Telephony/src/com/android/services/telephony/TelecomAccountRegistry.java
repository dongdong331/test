...
final class TelecomAccountRegistry {
    ...
    final class AccountEntry implements PstnPhoneCapabilitiesNotifier.Listener {
        ...
        private PhoneAccount registerPstnPhoneAccount(boolean isEmergency, boolean isDummyAccount) {
            ...
            ImsManagerEx.notifyVideoCapabilityChange();//SPRD: add for bug730182
    ...
    private void setupAccounts() {
        ...
        synchronized (mAccountsLock) {
            if (phoneAccountsEnabled) {
                for (Phone phone : phones) {
                    ...
                    // UNISOC: Get iccId from subscriptionInfo when getFullIccSerialNumber is null.
                    String iccId = null;
                    iccId = phone.getFullIccSerialNumber();
                    if (iccId == null) {
                        SubscriptionInfo subInfo = SubscriptionController.getInstance()
                                .getActiveSubscriptionInfo(subscriptionId, "com.android.phone");
                        if (subInfo != null) {
                            iccId = subInfo.getIccId();
                        }
                    }
                    if (subscriptionId >= 0 && /*phone.getFullIccSerialNumber()*/iccId != null) {
            ...
            if (mAccounts.isEmpty()) {
                mAccounts.add(new AccountEntry(getPhoneWithPowerOn(), true /* emergency */,
                        false /* isDummy */));
            }
        ...
        if (defaultPhoneAccount != null &&
            ...
            /*UNISOC: NumberFormatException when parseInt. @{ */
            try {
                ...
                Log.w(this, "NumberFormatException when parseInt. " + e);
            }
        }
    }
