...
public class TelephonyConference extends Conference implements Holdable {
    ...
    public void onConnectionAdded(Connection connection) {
        ...
        if (connection != null && connection instanceof TelephonyConnection &&
                ...
                configManager.getConfigForPhoneId(((TelephonyConnection) connection).getPhone()
                .getPhoneId()) != null) {
            showManageConference = configManager.getConfigForPhoneId(
                    ((TelephonyConnection) connection).getPhone().getPhoneId()).getBoolean(
