...
abstract class TelephonyConnection extends Connection implements Holdable {
    ...
    // UNISOC Feature Porting: Volte Local Tone Feature.
    ...
    private int applyConferenceTerminationCapabilities(int capabilities) {
        ...
        if (getPhone() != null && configManager.getConfigForPhoneId(getPhone().getPhoneId()) != null) {
            showManageConference = configManager.getConfigForPhoneId(getPhone().getPhoneId()).getBoolean(
